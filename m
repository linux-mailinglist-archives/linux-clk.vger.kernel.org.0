Return-Path: <linux-clk+bounces-400-lists+linux-clk=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-clk@lfdr.de
Delivered-To: lists+linux-clk@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id A04597F28A1
	for <lists+linux-clk@lfdr.de>; Tue, 21 Nov 2023 10:22:07 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id A3C3C1C20EC5
	for <lists+linux-clk@lfdr.de>; Tue, 21 Nov 2023 09:22:06 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3B8B938F89;
	Tue, 21 Nov 2023 09:22:05 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b="b8Pcp1UJ"
X-Original-To: linux-clk@vger.kernel.org
Received: from mail-qv1-xf33.google.com (mail-qv1-xf33.google.com [IPv6:2607:f8b0:4864:20::f33])
	by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 62C08FA
	for <linux-clk@vger.kernel.org>; Tue, 21 Nov 2023 01:21:49 -0800 (PST)
Received: by mail-qv1-xf33.google.com with SMTP id 6a1803df08f44-6779fe2b7c6so17301096d6.0
        for <linux-clk@vger.kernel.org>; Tue, 21 Nov 2023 01:21:49 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google; t=1700558508; x=1701163308; darn=vger.kernel.org;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:from:to:cc:subject:date
         :message-id:reply-to;
        bh=8HG9xMfAeDc/aWRVnLNUwFCl7IaAiiABlE8IougNaZo=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1700558508; x=1701163308;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=8HG9xMfAeDc/aWRVnLNUwFCl7IaAiiABlE8IougNaZo=;
        b=
X-Gm-Message-State: AOJu0YwRckAZ/YWbUIBzdF18+viqaOGM7flY7zcSLMSw/bDHy+a9jhT9
	lVXUr6e9u94dTPAar2XzsiNmPnK/Qx5DEI/smZw4rg==
X-Google-Smtp-Source: AGHT+IE5u9dIMyZ6KC14T5NKv2oKv/X/sOWwyum1zcLdNDk+bAYB8yZYBMhNSOzimehqFR/2bI2FXiZUbRFFsmvOnrM=
X-Received: by 2002:a05:6214:2a8c:b0:671:43fc:c275 with SMTP id
 jr12-20020a0562142a8c00b0067143fcc275mr11644098qvb.48.1700558508075; Tue, 21
 Nov 2023 01:21:48 -0800 (PST)
Precedence: bulk
...
Date: Tue, 21 Nov 2023 09:21:36 +0000
Message-ID: <CADrjBProZ4DG8hFuM9+uF2o+J=nAzqnR0D_CBavza-f0xJFc8A@mail.gmail.com>
...
I just checked my documentation and you're correct on the above
bitfields. I will update these
in v5 and double check through the other declarations in this file to
ensure they are accurate.

I think this may have been caused by some confusion initially over
what was the correct
documentation to use as there are several similarly named docs.
