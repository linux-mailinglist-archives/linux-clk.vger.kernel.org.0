...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 4BF6B770884
	for <lists+linux-clk@lfdr.de>; Fri,  4 Aug 2023 21:05:48 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230264AbjHDTFq (ORCPT <rfc822;lists+linux-clk@lfdr.de>);
        Fri, 4 Aug 2023 15:05:46 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:41394 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230347AbjHDTFh (ORCPT
        <rfc822;linux-clk@vger.kernel.org>); Fri, 4 Aug 2023 15:05:37 -0400
Received: from out-98.mta0.migadu.com (out-98.mta0.migadu.com [91.218.175.98])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 15D6E527F
        for <linux-clk@vger.kernel.org>; Fri,  4 Aug 2023 12:05:14 -0700 (PDT)
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linux.dev; s=key1;
        ...
        bh=efwmb4CsilYlZxLqcovmiFcHUQ5rbbjS4kd9qp+DIXI=;
        b=aeXEevuc0Ssk7On9vjbYJmjJhCsSJiuHn29SMvval9PiL6yiYeqLmHCO/w4r/qZCMUAc1M
        9Pp/zm4oIofC31EXAuAVHhityGZPIZchJsMQvD49H2mGSFmNKcL4Jsp8TOEUDQZXHHPuBH
        CPSyT0kQYpA/nxqeT0N8f3uv1hjLiYU=
...
Subject: [PATCH net-next v2 4/9] dpll: netlink: Add DPLL framework base functions
Date:   Fri,  4 Aug 2023 20:04:49 +0100
Message-Id: <20230804190454.394062-5-vadim.fedorenko@linux.dev>
...
- move init/exit functions to core part
 ...
 drivers/dpll/dpll_netlink.c | 1235 +++++++++++++++++++++++++++++++++++
 drivers/dpll/dpll_netlink.h |   13 +
 include/linux/dpll.h        |    4 +
 4 files changed, 1262 insertions(+), 1 deletion(-)
...
index 000000000000..1adaabf7ff3d
--- /dev/null
