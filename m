Return-Path: <linux-clk+bounces-18999-lists+linux-clk=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-clk@lfdr.de
Delivered-To: lists+linux-clk@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id E8B4AA50D64
	for <lists+linux-clk@lfdr.de>; Wed,  5 Mar 2025 22:27:19 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id D8FAA172936
	for <lists+linux-clk@lfdr.de>; Wed,  5 Mar 2025 21:27:17 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id AF02B2586CC;
	Wed,  5 Mar 2025 21:26:01 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=collabora.com header.i=nicolas.frattaroli@collabora.com header.b="Ohu9I9cz"
X-Original-To: linux-clk@vger.kernel.org
Received: from sender4-pp-f112.zoho.com (sender4-pp-f112.zoho.com [136.143.188.112])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id ADA4F1C6FE1;
	Wed,  5 Mar 2025 21:25:57 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=pass smtp.client-ip=136.143.188.112
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1741209961; cv=pass; b=fwIL/oMEkL5JLDbXf2FIUFbrpmqnSrTUU41lTwVqWqkQz7/21gci1152Aq8q3sIsPhfmsDnqKyTCidZXc/FINal8pKkY4disPnYvsrge5DFf7ma7Vu0FHxI/pBXuEQrCq6/h9W7FpDffrPDdeI8EvdUt8kOpB/+5o6KfTVJwe3w=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1741209961; c=relaxed/simple;
	bh=eCQp8xBHxEF9vRJ/TwBgnhtb9txSmst/t50TDf80D8A=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=fzDucP2Vd1ymoNuuI71qiN13PS5Zf9i0gjRzpzAmfIKmgEHhE4Q+9ZxJNGS6cqYpfVWpcAF5sOsqnSt7MzRSaWbNGLnRkvRQctUxbmAoJTmsQH+bT41Dps/tNHwrpc76cCVGHvnUQeQP6qdzTJM/HD17RndDnTouDdXzhx5WfKM=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=collabora.com; spf=pass smtp.mailfrom=collabora.com; dkim=pass (1024-bit key) header.d=collabora.com header.i=nicolas.frattaroli@collabora.com header.b=Ohu9I9cz; arc=pass smtp.client-ip=136.143.188.112
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=collabora.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=collabora.com
ARC-Seal: i=1; a=rsa-sha256; t=1741209919; cv=none; 
	d=zohomail.com; s=zohoarc; 
	b=lFA1s9pZrvZsafQvz+arSzrw+AgMq3e25fyFL6MkwVoQ9HBBliWRrI2TIrNd8THCbn6AJ8Ke/QJuOUN2HalevrGvwAqfStXwu4SMYp6G/zdds98c9I+cX5ro83PYDx2MdxIkVyC9RNruhUrGBwwW/Fb8ssjZUOxnkIX7EHNTkmo=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=zohomail.com; s=zohoarc; 
	t=1741209919; h=Content-Type:Content-Transfer-Encoding:Cc:Cc:Date:Date:From:From:In-Reply-To:MIME-Version:Message-ID:References:Subject:Subject:To:To:Message-Id:Reply-To; 
	bh=vG52dUrWHterwTMqxAe8aMFIF6DxuGj5R97DgJmyxRs=; 
	b=jMSuoT3k2ytMgiXYTZ5a3zT7d5ZXc5rPaJot8pxcTiPQjxgolVViQ/tFwWzpEcBEbZdj8i3yymhCWLgq6M3yrzxOeq47NcR/LpdrdciOT8V/OimWNVdiIyv2gAfq9KSDpOx5SXQFw+XJCJ/g6SJgB98YtmbEppSKOC+ic6I1XRU=
ARC-Authentication-Results: i=1; mx.zohomail.com;
	dkim=pass  header.i=collabora.com;
	spf=pass  smtp.mailfrom=nicolas.frattaroli@collabora.com;
	dmarc=pass header.from=<nicolas.frattaroli@collabora.com>
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; t=1741209919;
	s=zohomail; d=collabora.com; i=nicolas.frattaroli@collabora.com;
	h=From:From:Date:Date:Subject:Subject:MIME-Version:Content-Type:Content-Transfer-Encoding:Message-Id:Message-Id:References:In-Reply-To:To:To:Cc:Cc:Reply-To;
	bh=vG52dUrWHterwTMqxAe8aMFIF6DxuGj5R97DgJmyxRs=;
	b=Ohu9I9cz9iul3HDpZWgYUk/q/ae8g4oMO4xNolIdX/X/pzcyoGjJZl+nwUBnZkzf
	gBEzVjxyXJJcKVf4oOluzTUx5f7wTPD1TxAnEP1NoBeyXZkNHk9jHpUbygcMc5b4+FE
	HWZ7dqcj6nDxuplSWT7du4L4nwnquMWIlxYEWezI=
Received: by mx.zohomail.com with SMTPS id 1741209916921335.0703557782225;
	Wed, 5 Mar 2025 13:25:16 -0800 (PST)
From: Nicolas Frattaroli <nicolas.frattaroli@collabora.com>
Date: Wed, 05 Mar 2025 22:24:24 +0100
Subject: [PATCH 4/7] ASoC: rockchip: add Serial Audio Interface (SAI)
 driver
Precedence: bulk
...
Message-Id: <20250305-rk3576-sai-v1-4-64e6cf863e9a@collabora.com>
...
index a68bf5391df6d3785f376c68ae61669d310cfb17..a787ebc0b597022410b9d6fd149d6056ca46fa01 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -20666,6 +20666,7 @@ M:	Nicolas Frattaroli <nicolas.frattaroli@collabora.com>
...
index f98a2fa85edd6bb45d46e915e05bf8e64dc704aa..951e3c926e2aca227ba92ee57cc8e216aa7b7e55 100644
--- a/sound/soc/rockchip/Kconfig
+++ b/sound/soc/rockchip/Kconfig
@@ -37,6 +37,14 @@ config SND_SOC_ROCKCHIP_PDM
...
+	  Interface controller found on Rockchip SoCs such as the RK3576.
+
...
index 0000000000000000000000000000000000000000..52bd4c15b802384211edb49a5c0b6fec75211394
--- /dev/null
...
+	}
+
+	if (!sai->is_tdm && lanes != DIV_ROUND_UP(params_channels(params), 2)) {
...
+	if (ret) {
+		dev_err(&pdev->dev, "Failed to parse device quirks: %d\n", ret);
