Return-Path: <linux-clk+bounces-14520-lists+linux-clk=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-clk@lfdr.de
Delivered-To: lists+linux-clk@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 72E7D9C3580
	for <lists+linux-clk@lfdr.de>; Mon, 11 Nov 2024 01:49:02 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id D11921F221D4
	for <lists+linux-clk@lfdr.de>; Mon, 11 Nov 2024 00:49:01 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8654C14373F;
	Mon, 11 Nov 2024 00:47:50 +0000 (UTC)
X-Original-To: linux-clk@vger.kernel.org
Received: from foss.arm.com (foss.arm.com [217.140.110.172])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E1C7113D897;
	Mon, 11 Nov 2024 00:47:46 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=217.140.110.172
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1731286070; cv=none; b=KD7s7spFZCAUorE2xGe3388T5Rj2MjBXbD2nUvKvkhLZ5pLjhxiktZYsbsM8whLc6Qj/OahNIQWiwXyO8eqK30Xi2+/Rm7nhRojEjIpVHSTseIvgoA2g24uoWlAKi9oL5vuxDRvndrARCOjtyM5n0pNJi3RvfzOGhZetqxiVoTw=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1731286070; c=relaxed/simple;
	bh=9pyVtw7K8VrS9GfEFQqY08Zo5WoquMuI5cLXh8Jvc2k=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=XvajPKWV1czjqr84X8YpCqbMfi9awzaNBenAO0vwfIMqh6/ScXmksXeNjmthB7fL/STvSEcbrtkLl+UyfRKfVuOLvZQPrUjzKdBH9n7f9IbEcV66+mHLcAR+W/GLsCvPlNRMrPRyYWxAxiSx+tk228GwzseuPpTruJRW8LH2CyE=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=arm.com; spf=pass smtp.mailfrom=arm.com; arc=none smtp.client-ip=217.140.110.172
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=arm.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=arm.com
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
	by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 3DFE213D5;
	Sun, 10 Nov 2024 16:48:16 -0800 (PST)
Received: from localhost.localdomain (usa-sjc-mx-foss1.foss.arm.com [172.31.20.19])
	by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id 1E3873F66E;
	Sun, 10 Nov 2024 16:47:44 -0800 (PST)
...
Subject: [PATCH 6/7] clk: sunxi-ng: Add support for the A523/T527 CCU
Date: Mon, 11 Nov 2024 00:47:21 +0000
Message-ID: <20241111004722.10130-7-andre.przywara@arm.com>
...
Add the clocks of the main CCU of the Allwinner A523 and T527 SoCs.
The A523 clocks were modelled after the manual, and double checked by
writing all 1's into the respective register, to spot all implemented
bits. The T527 is a superset of the A523, and there does not seem to be a
separate T527 manual available. Information was gathered from the BSP,
by probing registers, and by looking at other recent SoCs.
...
---
 ...
 5 files changed, 1657 insertions(+), 6 deletions(-)
...
index 0000000000000..d0294327adc3f
--- /dev/null
