Return-Path: <linux-clk+bounces-15639-lists+linux-clk=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-clk@lfdr.de
Delivered-To: lists+linux-clk@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 17CF79E996C
	for <lists+linux-clk@lfdr.de>; Mon,  9 Dec 2024 15:50:52 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 6842E1884165
	for <lists+linux-clk@lfdr.de>; Mon,  9 Dec 2024 14:50:19 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id D7DD11C5CCA;
	Mon,  9 Dec 2024 14:49:03 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=purelymail.com header.i=@purelymail.com header.b="MTWshliZ"
X-Original-To: linux-clk@vger.kernel.org
Received: from sendmail.purelymail.com (sendmail.purelymail.com [34.202.193.197])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 294161B4254
	for <linux-clk@vger.kernel.org>; Mon,  9 Dec 2024 14:49:00 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=34.202.193.197
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1733755743; cv=none; b=uT4lr1Gvp/t+4xHQYtnx4WT59ju8xvyTgTOnFGcxvRdNBIPMDPjoPhoHEsV4Tf2wEG8PzjFzWedyN2c495Dt6QHZp9v6YYZp+0T79lcRcLRPCDEKi520DE2WLF6xT/KnVA4lNJvcX+g42zhL7vyOf1FcNuuT+dHytxGWVDdJT0U=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1733755743; c=relaxed/simple;
	bh=wsBxz3+thbKydI5Yn8F+RZZu3MnFWOkThMXRdXewDmw=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=XUwxEGfjoooWUhRUIOrHfL9CFz3cMehqhFAgd2m8TYAfrSRJDSd+wcmcz5uoy5mPM2MGsV2/tbGiDRXha10wMve1n2bAPapvnTcYFTqYWds3C0KHVS5y5nXtzFCBG6HCwkuzVJ/djfTr5s6GYtpYz7x2pZ/menDcgDUglvdbLfA=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=mentallysanemainliners.org; spf=pass smtp.mailfrom=mentallysanemainliners.org; dkim=pass (2048-bit key) header.d=purelymail.com header.i=@purelymail.com header.b=MTWshliZ; arc=none smtp.client-ip=34.202.193.197
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=mentallysanemainliners.org
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=mentallysanemainliners.org
Authentication-Results: purelymail.com; auth=pass
DKIM-Signature: a=rsa-sha256; b=; s=purelymail2; d=purelymail.com; v=1; bh=wsBxz3+thbKydI5Yn8F+RZZu3MnFWOkThMXRdXewDmw=; h=Feedback-ID:Received:From:Date:Subject:To;
...
Received: by smtp.purelymail.com (Purelymail SMTP) with ESMTPSA id -291099510;
          ...
          Mon, 09 Dec 2024 14:48:43 +0000 (UTC)
From: Igor Belwon <igor.belwon@mentallysanemainliners.org>
Date: Mon, 09 Dec 2024 15:45:23 +0100
Subject: [PATCH v4 3/3] clk: samsung: Introduce Exynos990 clock controller
 driver
Precedence: bulk
...
Message-Id: <20241209-exynos990-cmu-v4-3-57f07080f9e4@mentallysanemainliners.org>
...
X-Mailer: b4 0.14.2
X-Developer-Signature: v=1; a=ed25519-sha256; t=1733755636; l=64251;
 i=igor.belwon@mentallysanemainliners.org; s=20241206;
 h=from:subject:message-id; bh=wsBxz3+thbKydI5Yn8F+RZZu3MnFWOkThMXRdXewDmw=;
 b=HeFC68wrbSXumCVmXQWX+07/kJppG2r6L4eLN2kYpiwfUG3fcPP8Y/rF+hvbyzS4QfVB4A2iN
 PegjQ445bPuBDTN8NAkzGDKIuDk+TM2VP6ETGtq3amYjsQSzH03GjQp
...
index 0000000000000000000000000000000000000000..8e2a2e8eccee36dd7d4bc7099af2672d222f4abe
--- /dev/null
