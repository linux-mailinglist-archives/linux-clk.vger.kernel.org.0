Return-Path: <linux-clk+bounces-31788-lists+linux-clk=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-clk@lfdr.de
Delivered-To: lists+linux-clk@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 8F88FCCC8E5
	for <lists+linux-clk@lfdr.de>; Thu, 18 Dec 2025 16:48:17 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 981D83013EAF
	for <lists+linux-clk@lfdr.de>; Thu, 18 Dec 2025 15:46:18 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B340834D4F6;
	Thu, 18 Dec 2025 15:46:17 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=ew.tq-group.com header.i=@ew.tq-group.com header.b="TGYAx9kV"
...
Received: from mx-relay99-hz1.antispameurope.com (mx-relay99-hz1.antispameurope.com [94.100.132.95])
	...
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A0E1933121A
	for <linux-clk@vger.kernel.org>; Thu, 18 Dec 2025 15:46:07 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=pass smtp.client-ip=94.100.132.95
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1766072775; cv=pass; b=DH5VxdhKPU5L+8a6gs3RoCe3Qu0Pju28QCN8r28iVfgmdca9vpP1GUh5rLwkTrvA6m/zFFkHAKkEIA+ySF6ep93ASSVX9b6Hw5EFirWf5H5MrXKUKpVousuMT8R6EQETuZzyptJSJfAJE6kX9j5Cqz0xwVwJFEpTCRwrEwdpncw=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1766072775; c=relaxed/simple;
	bh=TjirjVRMeNN724W3cnJ8MpH4cln0KMXng+KgG/ZeZ/s=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=u1YWY+0aIkkt8VW4uoLkYPeqsgD1o8UFt1Zz1DyirlE/+ZB9Hn9+HhwJLnxYM1C/U94iRH9klERm/hQWgBs1QG5S1/xsZsUORNzokvgNy/lRxbLVCHOdodgiW+jQ9nb2oOAPQIK/thr0WC2YVVmUYFawQuh26iNgqMx8GCCsKqw=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=ew.tq-group.com; spf=pass smtp.mailfrom=ew.tq-group.com; dkim=pass (2048-bit key) header.d=ew.tq-group.com header.i=@ew.tq-group.com header.b=TGYAx9kV; arc=pass smtp.client-ip=94.100.132.95
...
ARC-Message-Signature: a=rsa-sha256;
 ...
 t=1766072684;
 b=
ARC-Seal: a=rsa-sha256; cv=none; d=hornetsecurity.com; i=1; s=hse1;
 t=1766072684;
 b=
...
DKIM-Signature: a=rsa-sha256;
 ...
 t=1766072683; v=1;
 b=
