Return-Path: <linux-clk+bounces-5819-lists+linux-clk=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-clk@lfdr.de
Delivered-To: lists+linux-clk@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 558DD8A0C58
	for <lists+linux-clk@lfdr.de>; Thu, 11 Apr 2024 11:27:35 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 5D2531C2087F
	for <lists+linux-clk@lfdr.de>; Thu, 11 Apr 2024 09:27:34 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 260F114534A;
	Thu, 11 Apr 2024 09:27:05 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=foss.st.com header.i=@foss.st.com header.b="rlVi7GC0"
X-Original-To: linux-clk@vger.kernel.org
Received: from mx07-00178001.pphosted.com (mx07-00178001.pphosted.com [185.132.182.106])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id BE39A145B10;
	Thu, 11 Apr 2024 09:26:59 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=185.132.182.106
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712827625; cv=none; b=Lum5Px0wcVhzY1xvdVqyYaY3LKgEECU2uSCd9dseOa3CKMX56hSSfxL5JQQFkYaLVw49hWBnen6FbZAxZ/y+HmfdbITFA+G15mkZOWyQNLpw3m4hj/A/oz8jBnPWtRcVSMhMd1tzk5iI+BTTTer1RV6G0/+myaL/tnaGQ9nBuRQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712827625; c=relaxed/simple;
	bh=b3vRiNM9JdkCzo7ggdnIxqTNV/s+c/NpNSiUjNc9brk=;
	h=From:To:CC:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=ZKX+B6tD5RjU288D9ACShCA1QIRqGQvBgFVJcw8P6mW1tXJ+6PuSfV+5JVt130oTtlfj9UWR4dbGnS4QWoRO39YYqIXR42SqtAKWD7iI75MgY5zxtjwJWj34X3zKVzbaPIJf8Ub34VBU1EDsBSS0xoqrv316BXH+RQhpiy5EWRw=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=foss.st.com; spf=pass smtp.mailfrom=foss.st.com; dkim=pass (2048-bit key) header.d=foss.st.com header.i=@foss.st.com header.b=rlVi7GC0; arc=none smtp.client-ip=185.132.182.106
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=foss.st.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=foss.st.com
Received: from pps.filterd (m0241204.ppops.net [127.0.0.1])
	by mx07-00178001.pphosted.com (8.17.1.24/8.17.1.24) with ESMTP id 43B8Mx3n004201;
	Thu, 11 Apr 2024 11:26:00 +0200
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=foss.st.com; h=
	from:to:cc:subject:date:message-id:in-reply-to:references
	:mime-version:content-transfer-encoding:content-type; s=
	selector1; bh=0ncjUobLc5ZkK+bP/HJn5a8QKcob11rCb8setB7VnKk=; b=rl
	
Received: from beta.dmz-ap.st.com (beta.dmz-ap.st.com [138.198.100.35])
	by mx07-00178001.pphosted.com (PPS) with ESMTPS id 3xawqy44sw-1
	(version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
	Thu, 11 Apr 2024 11:25:59 +0200 (MEST)
Received: from euls16034.sgp.st.com (euls16034.sgp.st.com [10.75.44.20])
	by beta.dmz-ap.st.com (STMicroelectronics) with ESMTP id E15D14004F;
	Thu, 11 Apr 2024 11:25:54 +0200 (CEST)
Received: from Webmail-eu.st.com (shfdag1node1.st.com [10.75.129.69])
	by euls16034.sgp.st.com (STMicroelectronics) with ESMTP id 47418212FC6;
	Thu, 11 Apr 2024 11:25:02 +0200 (CEST)
...
Subject: [PATCH v11 3/4] clk: stm32: introduce clocks for STM32MP257 platform
Date: Thu, 11 Apr 2024 11:24:52 +0200
Message-ID: <20240411092453.243633-4-gabriel.fernandez@foss.st.com>
...
Changes in v11:
  - use clk-provider.h instead clk.h include
  - drop include <linux/of_address.h>
