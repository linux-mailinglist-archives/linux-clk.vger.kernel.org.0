Return-Path: <linux-clk+bounces-11092-lists+linux-clk=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-clk@lfdr.de
Delivered-To: lists+linux-clk@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 9D37795C4B3
	for <lists+linux-clk@lfdr.de>; Fri, 23 Aug 2024 07:16:21 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 485AB285A54
	for <lists+linux-clk@lfdr.de>; Fri, 23 Aug 2024 05:16:20 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 355AF4D8A8;
	Fri, 23 Aug 2024 05:16:19 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=manjaro.org header.i=@manjaro.org header.b="QBSj4puC"
X-Original-To: linux-clk@vger.kernel.org
Received: from mail.manjaro.org (mail.manjaro.org [116.203.91.91])
	(using TLSv1.2 with cipher DHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 9CF94748A;
	Fri, 23 Aug 2024 05:16:12 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=116.203.91.91
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1724390179; cv=none; b=rLQiYZg0lDAjClI11I8oDabgA2MVBN+fcwRmpMFc4XEPbAOqrYhBS6TT1EU/RCLURkP7rDwftxOHAKI75umt+NDXdKiBXfH2v4CqNeFjjkvXQsdiR5KRZhLWthR32dp2nL1sW05CQAjBn7jj383zHkH7bmc69naN/IN9Fq5eXVQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1724390179; c=relaxed/simple;
	bh=f8c1AKGnuuna/hkwQjOfmAc73+/d7rSfvKkn4p8P5Qw=;
	h=MIME-Version:Date:From:To:Cc:Subject:In-Reply-To:References:
	 Message-ID:Content-Type; b=NPUT7f5IMTZpX89/PsYeXBKsGOcGFlCDnlNNJDogJH3+K4UxPna2ME5bAiqgwhjLYLqt8rgEXHN6ZSVP4NEIqlSPkU0UPeqjhbnjAkmMk8HPDtASgiXp98Vkr8sQeIXuDveVlrdzqFhtKH3ykA2h1IqlhOwOQF+sSyGRiFnLnLk=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=manjaro.org; spf=pass smtp.mailfrom=manjaro.org; dkim=pass (2048-bit key) header.d=manjaro.org header.i=@manjaro.org header.b=QBSj4puC; arc=none smtp.client-ip=116.203.91.91
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=manjaro.org; s=2021;
	...
	bh=J2JvfCHPCZs1Veu8VVxaUd72xtWbLymYjljyFVcwRl8=;
	b=
Date: Fri, 23 Aug 2024 07:16:10 +0200
...
Cc: linux-kernel@vger.kernel.org, Michael Turquette
 ...
 kernel@collabora.com, Finley Xiao <finley.xiao@rock-chips.com>, YouMin Chen
 <cym@rock-chips.com>, Liang Chen <cl@rock-chips.com>, Sugar Zhang
 <sugar.zhang@rock-chips.com>, Shawn Lin <shawn.lin@rock-chips.com>
Subject: Re: [PATCH v6 3/3] clk: rockchip: Add clock controller for the RK3576
In-Reply-To: <20240822194956.918527-4-detlev.casanova@collabora.com>
References: <20240822194956.918527-1-detlev.casanova@collabora.com>
 <20240822194956.918527-4-detlev.casanova@collabora.com>
Message-ID: <8e94a1fa89a1eff21d6a85ba65005e3b@manjaro.org>
...
> index 000000000000..a002b119cc6b
> --- /dev/null
> +++ b/drivers/clk/rockchip/clk-rk3576.c
> @@ -0,0 +1,1829 @@
...
> +PNAME(gpll_cpll_aupll_spll_lpll_p)	= { "gpll", "cpll", "aupll",
> "spll", "lpll_dummy" };
> +PNAME(gpll_cpll_spll_bpll_p)		= { "gpll", "cpll", "spll", "bpll_dummy" 
> };
> +PNAME(gpll_cpll_lpll_bpll_p)		= { "gpll", "cpll", "lpll_dummy", 
> "bpll_dummy" };
> +PNAME(gpll_spll_cpll_bpll_lpll_p)	= { "gpll", "spll",  "cpll",
> "bpll_dummy", "lpll_dummy" };
> +PNAME(gpll_cpll_vpll_aupll_24m_p)	= { "gpll", "cpll", "vpll",
> "aupll", "xin24m" };
> +PNAME(gpll_cpll_spll_aupll_bpll_p)	= { "gpll", "cpll", "spll",
> "aupll", "bpll_dummy" };
> +PNAME(gpll_cpll_spll_bpll_lpll_p)	= { "gpll", "cpll", "spll",
> "bpll_dummy", "lpll_dummy" };
> +PNAME(gpll_cpll_spll_lpll_bpll_p)	= { "gpll", "cpll", "spll",
> "lpll_dummy", "bpll_dummy" };
> +PNAME(gpll_cpll_vpll_bpll_lpll_p)	= { "gpll", "cpll", "vpll",
> "bpll_dummy", "lpll_dummy" };
> +PNAME(gpll_spll_aupll_bpll_lpll_p)	= { "gpll", "spll", "aupll",
> "bpll_dummy", "lpll_dummy" };
> +PNAME(gpll_spll_isppvtpll_bpll_lpll_p)	= { "gpll", "spll",
> "isp_pvtpll", "bpll_dummy", "lpll_dummy" };
> +PNAME(gpll_cpll_spll_aupll_lpll_24m_p)	= { "gpll", "cpll", "spll",
> "aupll", "lpll_dummy", "xin24m" };
> +PNAME(gpll_cpll_spll_vpll_bpll_lpll_p)	= { "gpll", "cpll", "spll",
> "vpll", "bpll_dummy", "lpll_dummy" };
> +PNAME(cpll_vpll_lpll_bpll_p)		= { "cpll", "vpll", "lpll_dummy", 
> "bpll_dummy" };
> +PNAME(mux_24m_ccipvtpll_gpll_lpll_p)	= { "xin24m", "cci_pvtpll",
> "gpll", "lpll" };
> +PNAME(mux_24m_spll_gpll_cpll_p)		= {"xin24m", "spll", "gpll", "cpll" 
> };
> +PNAME(audio_frac_int_p)			= { "xin24m", "clk_audio_frac_0",
> "clk_audio_frac_1", "clk_audio_frac_2",
> +					    "clk_audio_frac_3", "clk_audio_int_0", "clk_audio_int_1",
> "clk_audio_int_2" };
> +PNAME(audio_frac_p)			= { "clk_audio_frac_0", "clk_audio_frac_1",
> "clk_audio_frac_2", "clk_audio_frac_3" };
> +PNAME(mux_100m_24m_p)			= { "clk_cpll_div10", "xin24m" };
> +PNAME(mux_100m_50m_24m_p)		= { "clk_cpll_div10", "clk_cpll_div20", 
> "xin24m" };
> +PNAME(mux_100m_24m_lclk0_p)		= { "clk_cpll_div10", "xin24m",
> "lclk_asrc_src_0" };
> +PNAME(mux_100m_24m_lclk1_p)		= { "clk_cpll_div10", "xin24m",
> "lclk_asrc_src_1" };
> +PNAME(mux_150m_100m_50m_24m_p)		= { "clk_gpll_div8",
> "clk_cpll_div10", "clk_cpll_div20", "xin24m" };
> +PNAME(mux_200m_100m_50m_24m_p)		= { "clk_gpll_div6",
> "clk_cpll_div10", "clk_cpll_div20", "xin24m" };
> +PNAME(mux_400m_200m_100m_24m_p)		= { "clk_gpll_div3",
> "clk_gpll_div6", "clk_cpll_div10", "xin24m" };
> +PNAME(mux_500m_250m_100m_24m_p)		= { "clk_cpll_div2",
> "clk_cpll_div4", "clk_cpll_div10", "xin24m" };
> +PNAME(mux_600m_400m_300m_24m_p)		= { "clk_gpll_div2",
> "clk_gpll_div3", "clk_gpll_div4", "xin24m" };
> +PNAME(mux_350m_175m_116m_24m_p)		= { "clk_spll_div2",
> "clk_spll_div4", "clk_spll_div6", "xin24m" };
> +PNAME(mux_175m_116m_58m_24m_p)		= { "clk_spll_div4", "clk_spll_div6",
> "clk_spll_div12", "xin24m" };
> +PNAME(mux_116m_58m_24m_p)		= { "clk_spll_div6", "clk_spll_div12", 
> "xin24m" };
> +PNAME(mclk_sai0_8ch_p)			= { "mclk_sai0_8ch_src", "sai0_mclkin",
> "sai1_mclkin" };
> +PNAME(mclk_sai1_8ch_p)			= { "mclk_sai1_8ch_src", "sai1_mclkin" };
> +PNAME(mclk_sai2_2ch_p)			= { "mclk_sai2_2ch_src", "sai2_mclkin",
> "sai1_mclkin" };
> +PNAME(mclk_sai3_2ch_p)			= { "mclk_sai3_2ch_src", "sai3_mclkin",
> "sai1_mclkin" };
> +PNAME(mclk_sai4_2ch_p)			= { "mclk_sai4_2ch_src", "sai4_mclkin",
> "sai1_mclkin" };
...
> +PNAME(clk_uart_p)			= { "gpll", "cpll", "aupll", "xin24m", 
> "clk_uart_frac_0",
> +					    "clk_uart_frac_1", "clk_uart_frac_2"};
> +PNAME(clk_freq_pwm1_p)			= { "sai0_mclkin", "sai1_mclkin", 
> "sai2_mclkin",
...
> +PNAME(sai_sclkin_freq_p)		= { "sai0_sclk_in", "sai1_sclk_in", 
> "sai2_sclk_in",
...
> "clk_ref_mphy_26m"};
> +PNAME(mux_pmu200m_pmu100m_pmu50m_24m_p)	= { "clk_200m_pmu_src",
> "clk_100m_pmu_src",
> +					    "clk_50m_pmu_src", "xin24m" };
> +PNAME(mux_pmu100m_pmu50m_24m_p)		= { "clk_100m_pmu_src",
> "clk_50m_pmu_src", "xin24m" };
> +PNAME(mux_pmu100m_24m_32k_p)		= { "clk_100m_pmu_src", "xin24m",
> "xin_osc0_div" };
...
> gpll_cpll_spll_bpll_lpll_p, CLK_IS_CRITICAL,
> +			RK3576_CLKSEL_CON(6), 5, 3, MFLAGS, 0, 5, DFLAGS,
> +			RK3576_CLKGATE_CON(0), 12, GFLAGS),
> +	COMPOSITE_NODIV(PCLK_TOP_ROOT, "pclk_top_root", mux_100m_50m_24m_p,
> CLK_IS_CRITICAL,
...
> +	COMPOSITE(REFCLKO25M_GMAC0_OUT, "refclko25m_gmac0_out", gpll_cpll_p, 
> 0,
> +			RK3576_CLKSEL_CON(36), 7, 1, MFLAGS, 0, 7, DFLAGS,
> +			RK3576_CLKGATE_CON(5), 10, GFLAGS),
> +	COMPOSITE(REFCLKO25M_GMAC1_OUT, "refclko25m_gmac1_out", gpll_cpll_p, 
> 0,
...
> +	COMPOSITE(MCLK_PDM0_SRC_TOP, "mclk_pdm0_src_top", audio_frac_int_p, 
> 0,
...
> +	COMPOSITE_NODIV(CLK_TIMER0_ROOT, "clk_timer0_root", mux_100m_24m_p, 
> 0,
...
> +	COMPOSITE_NODIV(CLK_TIMER1_ROOT, "clk_timer1_root", mux_100m_24m_p, 
> 0,
...
> mux_24m_ccipvtpll_gpll_lpll_p, CLK_IS_CRITICAL,
...
> +	GATE(ACLK_DDR_SHAREMEM, "aclk_ddr_sharemem", "aclk_center_low_root",
> CLK_IGNORE_UNUSED,
...
> +	COMPOSITE_NODIV(PCLK_USB_ROOT, "pclk_usb_root", mux_100m_50m_24m_p,
> CLK_IS_CRITICAL,
...
> gpll_spll_isppvtpll_bpll_lpll_p, 0,
...
> gpll_cpll_aupll_spll_lpll_p, CLK_IS_CRITICAL,
...
> +	COMPOSITE_NODIV(PCLK_VOP_ROOT, "pclk_vop_root", mux_100m_50m_24m_p, 
> 0,
...
> +	COMPOSITE(DCLK_VP0_SRC, "dclk_vp0_src", gpll_cpll_vpll_bpll_lpll_p,
> CLK_SET_RATE_NO_REPARENT,
> +			RK3576_CLKSEL_CON(145), 8, 3, MFLAGS, 0, 8, DFLAGS,
> +			RK3576_CLKGATE_CON(61), 10, GFLAGS),
> +	COMPOSITE(DCLK_VP1_SRC, "dclk_vp1_src", gpll_cpll_vpll_bpll_lpll_p,
> CLK_SET_RATE_NO_REPARENT,
> +			RK3576_CLKSEL_CON(146), 8, 3, MFLAGS, 0, 8, DFLAGS,
> +			RK3576_CLKGATE_CON(61), 11, GFLAGS),
> +	COMPOSITE(DCLK_VP2_SRC, "dclk_vp2_src", gpll_cpll_vpll_bpll_lpll_p,
> CLK_SET_RATE_NO_REPARENT,
...
> gpll_cpll_spll_vpll_bpll_lpll_p, 0,
...
> +	COMPOSITE(MCLK_SAI5_8CH_SRC, "mclk_sai5_8ch_src", audio_frac_int_p, 
> 0,
...
> +	COMPOSITE(MCLK_SAI6_8CH_SRC, "mclk_sai6_8ch_src", audio_frac_int_p, 
> 0,
...
> +	COMPOSITE(MCLK_SAI8_8CH_SRC, "mclk_sai8_8ch_src", audio_frac_int_p, 
> 0,
...
> +	COMPOSITE(MCLK_SAI7_8CH_SRC, "mclk_sai7_8ch_src", audio_frac_int_p, 
> 0,
...
> +	COMPOSITE(MCLK_SAI9_8CH_SRC, "mclk_sai9_8ch_src", audio_frac_int_p, 
> 0,
...
> gpll_spll_cpll_bpll_lpll_p, CLK_IS_CRITICAL,
...
> +	COMPOSITE(ACLK_JPEG_ROOT, "aclk_jpeg_root", gpll_cpll_aupll_spll_p, 
> 0,
...
> +
> +	/* php */
> +	COMPOSITE_NODIV(PCLK_PHP_ROOT, "pclk_php_root", mux_100m_50m_24m_p, 
> 0,
...
> +	COMPOSITE(MCLK_SAI0_8CH_SRC, "mclk_sai0_8ch_src", audio_frac_int_p, 
> 0,
...
> +	COMPOSITE(MCLK_SAI1_8CH_SRC, "mclk_sai1_8ch_src", audio_frac_int_p, 
> 0,
...
> +	COMPOSITE(MCLK_SAI2_2CH_SRC, "mclk_sai2_2ch_src", audio_frac_int_p, 
> 0,
...
> +	COMPOSITE(MCLK_SAI3_2CH_SRC, "mclk_sai3_2ch_src", audio_frac_int_p, 
> 0,
...
> +	COMPOSITE(MCLK_SAI4_2CH_SRC, "mclk_sai4_2ch_src", audio_frac_int_p, 
> 0,
...
> +	GATE(CLK_GMAC1_PTP_REF, "clk_gmac1_ptp_ref", "clk_gmac1_ptp_ref_src", 
> 0,
> +			RK3576_CLKGATE_CON(42), 13, GFLAGS),
> +	GATE(CLK_GMAC0_PTP_REF, "clk_gmac0_ptp_ref", "clk_gmac0_ptp_ref_src", 
> 0,
...
> +	COMPOSITE_NOMUX(CLK_PCIE_100M_NDUTY_SRC, "clk_pcie_100m_nduty_src", 
> "ppll", 0,
...
> +	FACTOR_GATE(CLK_50M_PMU_SRC, "clk_50m_pmu_src", "clk_100m_pmu_src", 
> 0, 1, 2,
...
> +	MUXGRF(CLK_AUPLL_REF_SRC, "clk_aupll_ref_src", clk_aupll_ref_src_p,  
> 0,
...
> mux_116m_58m_24m_p, CLK_IS_CRITICAL,
...
> index 40fc0e4703c1..f1957e1c1178 100644
...
> RK3576_SECURE_NS_CRU_BASE + 0x300)
> +#define RK3576_SECURE_NS_CLKGATE_CON(x)	((x) * 0x4 +
> RK3576_SECURE_NS_CRU_BASE + 0x800)
> +#define RK3576_SECURE_NS_SOFTRST_CON(x)	((x) * 0x4 +
...
> RK3576_BIGCORE_CRU_BASE + 0x300)
> +#define RK3576_BIGCORE_CLKGATE_CON(x)	((x) * 0x4 +
> RK3576_BIGCORE_CRU_BASE + 0x800)
> +#define RK3576_BIGCORE_SOFTRST_CON(x)	((x) * 0x4 +
> RK3576_BIGCORE_CRU_BASE + 0xa00)
> +#define RK3576_LPLL_CON(x)		((x) * 0x4 + RK3576_CCI_CRU_BASE)
> +#define RK3576_LITCORE_CLKSEL_CON(x)	((x) * 0x4 +
> RK3576_LITCORE_CRU_BASE + 0x300)
> +#define RK3576_LITCORE_CLKGATE_CON(x)	((x) * 0x4 +
> RK3576_LITCORE_CRU_BASE + 0x800)
> +#define RK3576_LITCORE_SOFTRST_CON(x)	((x) * 0x4 +
> RK3576_LITCORE_CRU_BASE + 0xa00)
> +#define RK3576_NON_SECURE_GATING_CON00	0xc48
> +
>  #define RK3588_PHP_CRU_BASE		0x8000
>  #define RK3588_PMU_CRU_BASE		0x30000
>  #define RK3588_BIGCORE0_CRU_BASE	0x50000
> @@ -1026,6 +1078,7 @@ static inline void
> rockchip_register_softrst(struct device_node *np,
...
> new file mode 100644
> index 000000000000..3380d73c86c5
> --- /dev/null
> +++ b/drivers/clk/rockchip/rst-rk3576.c
> @@ -0,0 +1,652 @@
...
> +
> +/* 0x27200000 + 0x0A00 */
> +#define RK3576_CRU_RESET_OFFSET(id, reg, bit) [id] = (0 + reg * 16 + 
> bit)
> +/* 0x27208000 + 0x0A00 */
> +#define RK3576_PHPCRU_RESET_OFFSET(id, reg, bit) [id] = (0x8000*4 +
> reg * 16 + bit)
> +/* 0x27210000 + 0x0A00 */
> +#define RK3576_SECURENSCRU_RESET_OFFSET(id, reg, bit) [id] =
> (0x10000*4 + reg * 16 + bit)
> +/* 0x27220000 + 0x0A00 */
> +#define RK3576_PMU1CRU_RESET_OFFSET(id, reg, bit) [id] = (0x20000*4 +
> reg * 16 + bit)
> +
