Return-Path: <linux-clk+bounces-9115-lists+linux-clk=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-clk@lfdr.de
Delivered-To: lists+linux-clk@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 5F4CA925BA7
	for <lists+linux-clk@lfdr.de>; Wed,  3 Jul 2024 13:10:14 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 08C9D28C1D3
	for <lists+linux-clk@lfdr.de>; Wed,  3 Jul 2024 11:09:58 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 0F174191F97;
	Wed,  3 Jul 2024 10:57:23 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=testtoast.com header.i=@testtoast.com header.b="oRfHQrbs";
	dkim=pass (2048-bit key) header.d=messagingengine.com header.i=@messagingengine.com header.b="cBONq78h"
X-Original-To: linux-clk@vger.kernel.org
Received: from fout6-smtp.messagingengine.com (fout6-smtp.messagingengine.com [103.168.172.149])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 3D2DE191F90;
	Wed,  3 Jul 2024 10:57:20 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=103.168.172.149
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1720004243; cv=none; b=KiAL6tkO57CjjTM5aXLsd6KrAVSZkl3wbMd2xlVZrv0VYutGMUqOmm3Eluvbd+adQkR9x88zkUrlkfoTi3wfLFlYQTeBiKkmAPN87WByFbDNgvtkngF0Fw/tiHVpVHZjlVQXOQXGCERihBSiKc/KvERJdEq9svKzmYGclUdFfEQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1720004243; c=relaxed/simple;
	bh=8jFmLZ868hbX/yrfSa9MjlJy4BmJJNaq6UjY2MFxHWA=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=ddMAzmTahnkLkal/SkVwwDet0XfV7JD4rmrlzShGFE67l7oqLuGviGqJp4y2/jQbMJ+NrMQxe2SFKCrKNkjvuPpd15ySZqmQ/qYbNTDo3NzwFG6MS3i/FJIbXNFuz7Bipj1E7k82d30oQlFBFAMHCI1ElMrVdSuY//L2imcfwIc=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=testtoast.com; spf=pass smtp.mailfrom=testtoast.com; dkim=pass (2048-bit key) header.d=testtoast.com header.i=@testtoast.com header.b=oRfHQrbs; dkim=pass (2048-bit key) header.d=messagingengine.com header.i=@messagingengine.com header.b=cBONq78h; arc=none smtp.client-ip=103.168.172.149
...
Subject: [PATCH v2 20/23] drm: sun4i: de33: mixer: add Display Engine 3.3 (DE33) support
