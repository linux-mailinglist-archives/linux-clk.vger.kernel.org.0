...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 6239C34EF22
	for <lists+linux-clk@lfdr.de>; Tue, 30 Mar 2021 19:14:52 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231808AbhC3ROU (ORCPT <rfc822;lists+linux-clk@lfdr.de>);
        Tue, 30 Mar 2021 13:14:20 -0400
Received: from esa.microchip.iphmx.com ([68.232.154.123]:41829 "EHLO
        esa.microchip.iphmx.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232440AbhC3ROG (ORCPT
        <rfc822;linux-clk@vger.kernel.org>); Tue, 30 Mar 2021 13:14:06 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
  d=microchip.com; i=@microchip.com; q=dns/txt; s=mchp;
  t=1617124445; x=1648660445;
  h=subject:to:cc:references:from:message-id:date:
   mime-version:in-reply-to:content-transfer-encoding;
  bh=loyWZmm0/dCKaQOAzqfF7xvxcxsaexe/irob/wlIKcM=;
  b=elFIrGExfwkxLWjI5obYOOHJRgTrMQAgODL8RqvNAUnsamYOHbOfiV3c
   uoew0DmVVWPnfx9RbhlclS+Y9Hp8L0FrD9J7i1xvR1UvjcMEYwAross5u
   N1H9BjEIhCuPd2hAC+11bf40X0OUqVDY9TSSloW63AJjOlBSW1eJNq+If
   NNMg9nUSTluRqG2k++j3vfpBLLWzLDtG3NZ8xBUCxDEAi+MFU8f1lW+yZ
   8Vo783hhlG1Iwsx9AydADOcjtutC+ksAU+B+RkGn9/2QpNAoOQykKB8y8
   abQ0jABQJs66+SEVOzFTHKD5gXLf5FeUJZ+r+yOXYvtyRPtv7lVBZNgpw
   A==;
IronPort-SDR: 
X-IronPort-AV: E=Sophos;i="5.81,291,1610434800"; 
   d="scan'208";a="109105783"
Received: from smtpout.microchip.com (HELO email.microchip.com) ([198.175.253.82])
  by esa4.microchip.iphmx.com with ESMTP/TLS/AES256-SHA256; 30 Mar 2021 10:14:05 -0700
Received: from chn-vm-ex04.mchp-main.com (10.10.85.152) by
 chn-vm-ex03.mchp-main.com (10.10.85.151) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2176.2; Tue, 30 Mar 2021 10:14:04 -0700
Received: from [10.171.246.97] (10.10.115.15) by chn-vm-ex04.mchp-main.com
 (10.10.85.152) with Microsoft SMTP Server id 15.1.2176.2 via Frontend
 Transport; Tue, 30 Mar 2021 10:14:02 -0700
...
Message-ID: <b89186ea-07da-c3a7-7e88-0bc1ca585769@microchip.com>
Date:   Tue, 30 Mar 2021 19:14:02 +0200
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:78.0) Gecko/20100101
 Thunderbird/78.7.1
MIME-Version: 1.0
In-Reply-To: <20210324094353.1710114-2-claudiu.beznea@microchip.com>
...
update_bits is already a compact version of read/modify/write, I think 
it doesn't need another lever of density.
...
>   
>   /**
> @@ -314,8 +343,6 @@ at91_clk_register_generated(struct regmap *regmap, spinlock_t *lock,
>   	if (ret) {
>   		kfree(gck);
>   		hw = ERR_PTR(ret);
> -	} else {
...
> @@ -284,15 +356,24 @@ static int clk_master_pres_set_rate(struct clk_hw *hw, unsigned long rate,
>   		pres = ffs(pres) - 1;
>   
>   	spin_lock_irqsave(master->lock, flags);
...
> @@ -330,11 +411,66 @@ static u8 clk_master_pres_get_parent(struct clk_hw *hw)
...
> @@ -539,9 +677,9 @@ static int clk_sama7g5_master_set_parent(struct clk_hw *hw, u8 index)
>   	return 0;
>   }
>   
...
>   
> @@ -550,9 +688,10 @@ static int clk_sama7g5_master_enable(struct clk_hw *hw)
...
>   
> @@ -563,6 +702,13 @@ static int clk_sama7g5_master_enable(struct clk_hw *hw)
>   		cpu_relax();
>   
>   	spin_unlock_irqrestore(master->lock, flags);
> +}
...
>   	return 0;
>   }
> @@ -620,6 +766,23 @@ static int clk_sama7g5_master_set_rate(struct clk_hw *hw, unsigned long rate,
>   	return 0;
>   }
>   
...
>   	int chg_pid;
>   };
> @@ -155,9 +156,9 @@ static void clk_sam9x5_peripheral_autodiv(struct clk_sam9x5_peripheral *periph)
>   	periph->div = shift;
>   }
>   
...
> @@ -168,15 +169,22 @@ static int clk_sam9x5_peripheral_enable(struct clk_hw *hw)
...
> @@ -260,6 +261,40 @@ static int clk_pll_set_rate(struct clk_hw *hw, unsigned long rate,
>   	return 0;
>   }
>   
...
>   
>   static struct clk_hw * __init
> @@ -232,10 +252,35 @@ static int clk_utmi_sama7g5_is_prepared(struct clk_hw *hw)
>   	return 0;
>   }
>   
