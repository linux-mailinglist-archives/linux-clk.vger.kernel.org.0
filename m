...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 19A654FF498
	for <lists+linux-clk@lfdr.de>; Wed, 13 Apr 2022 12:18:42 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234851AbiDMKUr (ORCPT <rfc822;lists+linux-clk@lfdr.de>);
        Wed, 13 Apr 2022 06:20:47 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44738 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234733AbiDMKUo (ORCPT
        <rfc822;linux-clk@vger.kernel.org>); Wed, 13 Apr 2022 06:20:44 -0400
Received: from twspam01.aspeedtech.com (twspam01.aspeedtech.com [211.20.114.71])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B6A2E574AB;
        Wed, 13 Apr 2022 03:18:20 -0700 (PDT)
Received: from mail.aspeedtech.com ([192.168.0.24])
        by twspam01.aspeedtech.com with ESMTP id 23DA5u8P006812;
...
Subject: [PATCH v2 3/3] i2c:aspeed:support ast2600 i2c new register mode driver
Date:   Wed, 13 Apr 2022 18:17:35 +0800
Message-ID: <20220413101735.27678-4-ryan_chen@aspeedtech.com>
...
X-ClientProxiedBy: TWMBX02.aspeed.com (192.168.0.24) To TWMBX02.aspeed.com
 (192.168.0.24)
X-DNSRBL: 
X-MAIL: twspam01.aspeedtech.com 23DA5u8P006812
...
index 000000000000..bf79d0e5b53f
--- /dev/null
...
new file mode 100644
index 000000000000..11180813135b
--- /dev/null
...
+
+#define AST2600_LOCKUP_DETECTED			BIT(15)
+#define AST2600_I2C_LOW_TIMEOUT			0x07
+
...
+		if (sts & AST2600_I2CS_SLAVE_MATCH)
+			dev_dbg(i2c_bus->dev,
+				"S: AST2600_I2CS_Wait_TX_DMA | AST2600_I2CS_SLAVE_MATCH | AST2600_I2CS_RX_DONE\n");
+		else
+			dev_dbg(i2c_bus->dev, "S: AST2600_I2CS_Wait_TX_DMA | AST2600_I2CS_RX_DONE\n");
+
+		if (sts & AST2600_I2CS_SLAVE_MATCH)
+			i2c_slave_event(i2c_bus->slave, I2C_SLAVE_WRITE_REQUESTED, &value);
+
...
+		/* First Start read */
+		dev_dbg(i2c_bus->dev, "S: AST2600_I2CS_SLAVE_MATCH | AST2600_I2CS_Wait_TX_DMA\n");
+		cmd = SLAVE_TRIGGER_CMD;
+		if (i2c_bus->mode == DMA_MODE) {
+			cmd |= AST2600_I2CS_TX_DMA_EN;
+			i2c_slave_event(i2c_bus->slave, I2C_SLAVE_READ_REQUESTED,
...
+		dev_dbg(i2c_bus->dev, "S: AST2600_I2CS_Wait_TX_DMA\n");
+		cmd = SLAVE_TRIGGER_CMD;
+		if (i2c_bus->mode == DMA_MODE) {
+			cmd |= AST2600_I2CS_TX_DMA_EN;
...
+		/* it just tx complete */
+		dev_dbg(i2c_bus->dev, "S: AST2600_I2CS_TX_NAK | AST2600_I2CS_STOP\n");
+		cmd = SLAVE_TRIGGER_CMD;
+		i2c_slave_event(i2c_bus->slave, I2C_SLAVE_STOP, &value);
+		if (i2c_bus->mode == DMA_MODE) {
+			cmd |= AST2600_I2CS_RX_DMA_EN;
...
+	u32 sts = readl(i2c_bus->reg_base + AST2600_I2CS_ISR);
+
+	if (!(sts & ier))
+		return 0;
+
+	sts &= ~(AST2600_I2CS_ADDR_INDICATE_MASK | AST2600_I2CS_SLAVE_PENDING);
+
+	if (AST2600_I2CS_ADDR1_NAK & sts)
+		sts &= ~AST2600_I2CS_ADDR1_NAK;
+
+	if (AST2600_I2CS_ADDR2_NAK & sts)
+		sts &= ~AST2600_I2CS_ADDR2_NAK;
+
+	if (AST2600_I2CS_ADDR3_NAK & sts)
+		sts &= ~AST2600_I2CS_ADDR3_NAK;
+
+	if (AST2600_I2CS_ADDR_MASK & sts)
+		sts &= ~AST2600_I2CS_ADDR_MASK;
+
+	if (AST2600_I2CS_PKT_DONE & sts)
+		ast2600_i2c_slave_packet_irq(i2c_bus, sts);
+	else
+		ast2600_i2c_slave_byte_irq(i2c_bus, sts);
+
+	return 1;
+}
+#endif
...
+		goto free_irq;
+
+	dev_info(i2c_bus->dev, "AST2600-I2C: %s [%d]: adapter [%d khz] mode [%d]\n",
