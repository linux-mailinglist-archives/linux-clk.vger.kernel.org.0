Return-Path: <linux-clk+bounces-1134-lists+linux-clk=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-clk@lfdr.de
Delivered-To: lists+linux-clk@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 46B2A80B817
	for <lists+linux-clk@lfdr.de>; Sun, 10 Dec 2023 00:33:06 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id E7E63280F9E
	for <lists+linux-clk@lfdr.de>; Sat,  9 Dec 2023 23:33:04 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C471C2E3E0;
	Sat,  9 Dec 2023 23:32:06 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b="PD0maExj"
X-Original-To: linux-clk@vger.kernel.org
Received: from mail-wm1-x334.google.com (mail-wm1-x334.google.com [IPv6:2a00:1450:4864:20::334])
	by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 58C7C10DF
	for <linux-clk@vger.kernel.org>; Sat,  9 Dec 2023 15:31:34 -0800 (PST)
Received: by mail-wm1-x334.google.com with SMTP id 5b1f17b1804b1-40c19f5f822so18010135e9.1
        for <linux-clk@vger.kernel.org>; Sat, 09 Dec 2023 15:31:34 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google; t=1702164693; x=1702769493; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=BxAV6V1CMucyRBSrdHtV+07Mv7Yw+OSHX6sOOfYF51w=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1702164693; x=1702769493;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=BxAV6V1CMucyRBSrdHtV+07Mv7Yw+OSHX6sOOfYF51w=;
        b=
X-Gm-Message-State: AOJu0Ywhtb09DH1JEFxv2yzx2yZ3OZI3HjekQRGWMeyB+DD58vjYLMho
	RA0dgxdfNgthHjr8q9XsHNsJ/Q==
X-Google-Smtp-Source: AGHT+IHAiU/SScgk7OpaqFuJtj5daofqyL4DOb2bglu4gKFWYOQEj2yeDWISkucIsbmCrmUmmB64NQ==
X-Received: by 2002:a05:600c:2a41:b0:40b:5e56:7b6a with SMTP id x1-20020a05600c2a4100b0040b5e567b6amr985458wme.179.1702164692429;
        Sat, 09 Dec 2023 15:31:32 -0800 (PST)
Received: from gpeter-l.lan (host-92-23-61-173.as13285.net. [92.23.61.173])
        by smtp.gmail.com with ESMTPSA id n9-20020a05600c4f8900b0040c41846923sm1875277wmq.26.2023.12.09.15.31.30
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sat, 09 Dec 2023 15:31:31 -0800 (PST)
...
Subject: [PATCH v6 12/20] clk: samsung: clk-gs101: Add cmu_top, cmu_misc and cmu_apm support
Date: Sat,  9 Dec 2023 23:30:58 +0000
Message-ID: <20231209233106.147416-13-peter.griffin@linaro.org>
...
index 000000000000..7129cfb2fbc7
--- /dev/null
...
+	    0, 1),
+	MUX(CLK_MOUT_CMU_HSI0_USBDPDGB, "mout_cmu_hsi0_usbdpdbg",
