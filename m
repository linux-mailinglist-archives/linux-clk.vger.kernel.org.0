Return-Path: <linux-clk+bounces-12498-lists+linux-clk=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-clk@lfdr.de
Delivered-To: lists+linux-clk@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 0B64298942E
	for <lists+linux-clk@lfdr.de>; Sun, 29 Sep 2024 11:12:38 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 904ACB24BFD
	for <lists+linux-clk@lfdr.de>; Sun, 29 Sep 2024 09:12:35 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id CAC3413F431;
	Sun, 29 Sep 2024 09:12:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=testtoast.com header.i=@testtoast.com header.b="m4pGH+JR";
	dkim=pass (2048-bit key) header.d=messagingengine.com header.i=@messagingengine.com header.b="GZiA+ab4"
X-Original-To: linux-clk@vger.kernel.org
Received: from fhigh-a2-smtp.messagingengine.com (fhigh-a2-smtp.messagingengine.com [103.168.172.153])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 141DFBE4E;
	Sun, 29 Sep 2024 09:12:31 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=103.168.172.153
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1727601152; cv=none; b=SLlTJPFYe2WdsaKgUmkqHmX3M3B5gj7LCCLc+KRNFR5A47i4vYwExOHPCIcZFhGdViiXdt1G3Sg2Lk/5J9xvtJipwvZSfe4HgWzhrirPpTUYtTvLYUG0W1bs/Iv6QqO7oO2oSDyJ6TgAlUoMNbnFgV85XwkpwChS3V28KPdXTUo=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1727601152; c=relaxed/simple;
	bh=vXQzQrnBwqANfagf8s+RymSERfxYs/v9vtQL3CMLmdg=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=rONatgmFYV9G6nFCm5n1Wmug0bxRGF6xActg8uF10dfiF12sG+s8B9Qn9FFZNp02UgsC0MVfAhu3DAVN9IELFnkirCsXfBedVTsdZwqlYBhmNdAiNeVOD7acD4pkajsgIA5M7WsO46ie1kVFynf+gMM+yGoaZQJuvOV7VES/EDo=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=testtoast.com; spf=pass smtp.mailfrom=testtoast.com; dkim=pass (2048-bit key) header.d=testtoast.com header.i=@testtoast.com header.b=m4pGH+JR; dkim=pass (2048-bit key) header.d=messagingengine.com header.i=@messagingengine.com header.b=GZiA+ab4; arc=none smtp.client-ip=103.168.172.153
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=testtoast.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=testtoast.com
Received: from phl-compute-10.internal (phl-compute-10.phl.internal [10.202.2.50])
	by mailfhigh.phl.internal (Postfix) with ESMTP id 71D2511401FB;
	Sun, 29 Sep 2024 05:12:30 -0400 (EDT)
Received: from phl-mailfrontend-01 ([10.202.2.162])
  by phl-compute-10.internal (MEProxy); Sun, 29 Sep 2024 05:12:30 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=testtoast.com;
	 h=cc:cc:content-transfer-encoding:content-type:date:date:from
	:from:in-reply-to:in-reply-to:message-id:mime-version:references
	:reply-to:subject:subject:to:to; s=fm2; t=1727601150; x=
	1727687550; bh=x3OqmAxsNGOVVt9znS4fHvCxa6Knje0sdH9aSFhxmtA=; b=m
	
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=
	messagingengine.com; h=cc:cc:content-transfer-encoding
	:content-type:date:date:feedback-id:feedback-id:from:from
	:in-reply-to:in-reply-to:message-id:mime-version:references
	:reply-to:subject:subject:to:to:x-me-proxy:x-me-proxy
	:x-me-sender:x-me-sender:x-sasl-enc; s=fm2; t=1727601150; x=
	1727687550; bh=x3OqmAxsNGOVVt9znS4fHvCxa6Knje0sdH9aSFhxmtA=; b=G
	
X-ME-Sender: <xms:_hn5Zh9Tmuc_ELnSb981JbrYYwINusF0HEEJvYOCeTEmSLUUzT-jDQ>
    <xme:_hn5Zlta7Q0kAQq2Gthf2JQmrszZ-FMTyCJqCdJRI4zZp9QHHBi0YCWJX5gG9Cb7x
    DUs11XzW0hS4ODOuQ>
X-ME-Received: <xmr:_hn5ZvCSgVpuYFpdtNy1WZculGF1lMEBjYOekm4wExrJvy2CaPcTL2PekA1YKWkdkZqtczAsiWejMtkhzBahX6N0ojD0OpVzca3iCSn7WIZ9WpWV>
...
X-ME-Proxy: <xmx:_hn5ZlecUs1KBBgRTyt0FWJxX9pgJoyKQKcc4LUremBIEVDuZ6gsWw>
    <xmx:_hn5ZmN_GnPAQb0y0I7DizTQUC7H0xP9Cpl1RiGbBj2y4ny6JRx9TQ>
    <xmx:_hn5ZnnL5ZqCEPd5nwZ1ppsbYh4aIsQwBOYyetvCP0x2ebsLNHy8Qg>
    <xmx:_hn5Zgvqz1x2RtcW5FNFFJg_4XCT3c7B57Njy9MUX0v49tB2U_8wJA>
    <xmx:_hn5Zs3RUo9tycl8y8A3On-ryyigsvaBJncwLOL7DJ1D1HoYYhYrtAYe>
Feedback-ID: idc0145fc:Fastmail
Received: by mail.messagingengine.com (Postfix) with ESMTPA; Sun,
 29 Sep 2024 05:12:24 -0400 (EDT)
...
Subject: [PATCH v5 10/26] drm: sun4i: de3: add YUV support to the color space correction module
