...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 70F1D351AD3
	for <lists+linux-clk@lfdr.de>; Thu,  1 Apr 2021 20:07:39 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S237068AbhDASDW (ORCPT <rfc822;lists+linux-clk@lfdr.de>);
        Thu, 1 Apr 2021 14:03:22 -0400
Received: from esa.microchip.iphmx.com ([68.232.154.123]:20061 "EHLO
        esa.microchip.iphmx.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236647AbhDAR6T (ORCPT
        <rfc822;linux-clk@vger.kernel.org>); Thu, 1 Apr 2021 13:58:19 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
  d=microchip.com; i=@microchip.com; q=dns/txt; s=mchp;
  t=1617299900; x=1648835900;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=keKDpLy9oD2pV/+UXVTAN7yFNduwRGbR6OkGRAcWSPQ=;
  b=ctWDXtRIGMfT17st6gmw/t6rp6nR3owwN9TC64wE2vOhKA6CkYaLk4pm
   Y03ZtIudbbGDjq9ebAuo4sRRAsDOJ/NtVGTjX6jY9xq/V3q1WXXcgfh5t
   bNLhJ34VXzwNcW2IykgEI4UWQzvRpPXrwB3rUmsrZ2T3YlyY0CYoyFDSo
   6OctsaYh5Zu3yu4+aNeJ8OsCMHANxiua/X9OqsH9EDqhtJJAEagyhxD1k
   B91DdeisxBSq1okbF5AiYY4fZ/0mk4OUqoKRmNbOG47vEzud1FPm15K9N
   tK3/p7JMaqwWdrxVDYbVmcOuW8+7HETxPlzhao5+AyDeaCOldV5k/uWvo
   g==;
IronPort-SDR: 
X-IronPort-AV: E=Sophos;i="5.81,296,1610434800"; 
   d="scan'208";a="109344803"
Received: from smtpout.microchip.com (HELO email.microchip.com) ([198.175.253.82])
  by esa4.microchip.iphmx.com with ESMTP/TLS/AES256-SHA256; 01 Apr 2021 05:27:33 -0700
Received: from chn-vm-ex04.mchp-main.com (10.10.85.152) by
 chn-vm-ex02.mchp-main.com (10.10.85.144) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2176.2; Thu, 1 Apr 2021 05:27:34 -0700
Received: from rob-dk-mpu01.microchip.com (10.10.115.15) by
 chn-vm-ex04.mchp-main.com (10.10.85.152) with Microsoft SMTP Server id
 15.1.2176.2 via Frontend Transport; Thu, 1 Apr 2021 05:27:31 -0700
...
Subject: [PATCH v2 1/6] clk: at91: re-factor clocks suspend/resume
Date:   Thu, 1 Apr 2021 15:27:21 +0300
Message-ID: <20210401122726.28528-2-claudiu.beznea@microchip.com>
...
+	.restore_context = clk_generated_restore_context,
 ...
 /**
@@ -314,8 +344,6 @@ at91_clk_register_generated(struct regmap *regmap, spinlock_t *lock,
 	if (ret) {
 		kfree(gck);
 		hw = ERR_PTR(ret);
-	} else {
...
index a80427980bf7..21e82111890d 100644
...
@@ -539,20 +677,21 @@ static int clk_sama7g5_master_set_parent(struct clk_hw *hw, u8 index)
 	return 0;
 }
