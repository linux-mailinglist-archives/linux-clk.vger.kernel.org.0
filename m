Return-Path: <linux-clk+bounces-17507-lists+linux-clk=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-clk@lfdr.de
Delivered-To: lists+linux-clk@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 01C54A21826
	for <lists+linux-clk@lfdr.de>; Wed, 29 Jan 2025 08:30:32 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 900D77A2DF5
	for <lists+linux-clk@lfdr.de>; Wed, 29 Jan 2025 07:29:32 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id BDB9A19CC22;
	Wed, 29 Jan 2025 07:30:11 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b="lqWKqu5L"
X-Original-To: linux-clk@vger.kernel.org
Received: from mail-ej1-f52.google.com (mail-ej1-f52.google.com [209.85.218.52])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 97667195381;
	Wed, 29 Jan 2025 07:30:05 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.218.52
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1738135811; cv=none; b=h1yXy5YiV/CRXPiszxhlg/ws5c88lWcP5Qj6lsCWBArUnTBYVNxnQ5a2CFcDy3ibHVPLHzn5qfu1tlZkEp+YlHPzWBeqVgYQZIG7XQix/mlV9iki+ven+zMpYdUh843nAMPQgvWOMonDnuPQhA2Vj/fsaOwzH6dkrPai+hBQYwo=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1738135811; c=relaxed/simple;
	bh=jPe+L/jyqksWEQ1QUYdtqWYPukeP51NOt8IvY9Qas4Q=;
	h=Content-Type:Mime-Version:Subject:From:In-Reply-To:Date:Cc:
	 Message-Id:References:To; b=l2ozwCMCsJ763omW+9y4yenmC73tiYEnxuHUT3MGbtSm5OXVGpVKqWtYHV/w7dcOWWc7PXjOTYgBkn2CYHQNBD71Cz3tVCTiMXYtrbmam5tSzrzk1ki85GOzZdaAF1WRCUbgw/vfqX73v0P4MZz8Z3XXuEyKXsmDMrott150qjQ=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com; spf=pass smtp.mailfrom=gmail.com; dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b=lqWKqu5L; arc=none smtp.client-ip=209.85.218.52
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=gmail.com
Received: by mail-ej1-f52.google.com with SMTP id a640c23a62f3a-aaeef97ff02so1077292266b.1;
        Tue, 28 Jan 2025 23:30:05 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1738135804; x=1738740604; darn=vger.kernel.org;
        h=to:references:message-id:content-transfer-encoding:cc:date
         :in-reply-to:from:subject:mime-version:from:to:cc:subject:date
         :message-id:reply-to;
        bh=EYSIzDAQkSezMwwPxVXqXSbV6AnCbFyvzfHd2xAdwWI=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1738135804; x=1738740604;
        h=to:references:message-id:content-transfer-encoding:cc:date
         :in-reply-to:from:subject:mime-version:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=EYSIzDAQkSezMwwPxVXqXSbV6AnCbFyvzfHd2xAdwWI=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVaH3WkmfNKep+Gdo/78FNysdYYCjUoAYHZN9KwKuIz0E7/f8Q50dYpCXbhVXMBqvahoBVrgR9aP5k=@vger.kernel.org, AJvYcCW44SJsyoCgCREMW3uOf5bUkO5y/97gYlSybDqmEbNPo9FzdKfsXEJdiN/wwf4i1W6dbbbqsQoq0gVznA==@vger.kernel.org, AJvYcCWPuqs/zmo32dz+12vdZDpHFQk1OiftP7H+tIKL37EywkZw4tQ+znlwFLVGEK3atOBO9R8RLcpG4FWsnavk@vger.kernel.org, AJvYcCWSJMgyqEQvRpBYYaYeKF0jiU5EaJ6vnrrDb6c8n6AN4wHZRRKzLYcwN92AOkyXpPyGKgjd1G7cofbb@vger.kernel.org, AJvYcCXmcZiBrSaSYS4rvLXiW/Gmo2BMtw6WQ+nzZa5FH8AZ6537rtbF+H7qa0L+opXGlbLFCwCEQNEpcCJP@vger.kernel.org
X-Gm-Message-State: AOJu0Yy6CQTGTdKpAFoxxT9wPF3xM85aLdgUlXGrVVO8KMtK+lJzP6SL
	RnLFEMUSHJGwUp/CD3Ssq/dRd85bEDiJOReM7GYTDfV9pII4KMLC
X-Gm-Gg: 
X-Google-Smtp-Source: AGHT+IH4paYi2V7hb0R8PZtcUPUq2zDHT/5Xwo2CmeE9Y3+qzwMyM05AfnUOMdl+CYWYkGKdG9+fQg==
X-Received: by 2002:a17:907:2d8f:b0:aaf:117f:1918 with SMTP id a640c23a62f3a-ab6cfcb35a6mr213606566b.5.1738135802876;
        Tue, 28 Jan 2025 23:30:02 -0800 (PST)
Received: from smtpclient.apple (185.174.17.62.zt.hu. [185.174.17.62])
        by smtp.gmail.com with ESMTPSA id a640c23a62f3a-ab6760ab1ccsm926947066b.110.2025.01.28.23.30.01
...
In-Reply-To: <20250128112221.23201f2c@donnerap.manchester.arm.com>
Date: Wed, 29 Jan 2025 08:29:50 +0100
...
Message-Id: <3CEA5A7B-0BB9-45DA-90AA-8DF2C3FDC5ED@gmail.com>
References: <20250110123923.270626-1-szemzo.andras@gmail.com>
 ...
 <20250128112221.23201f2c@donnerap.manchester.arm.com>
To: Andre Przywara <andre.przywara@arm.com>
X-Mailer: Apple Mail (2.3776.700.51)



> On 28 Jan 2025, at 12:22, Andre Przywara <andre.przywara@arm.com> =
wrote:
>=20
...
>> Hi Andre,
>>=20
>>> On 28 Jan 2025, at 01:42, Andre Przywara <andre.przywara@arm.com> =
wrote:
>>>=20
...
>>>=20
>>> First very much for sending this, I know from (recent) experience =
that
...
>>>> @@ -50,6 +52,8 @@ obj-$(CONFIG_SUN9I_A80_CCU) +=3D =
sun9i-a80-de-ccu.o
...
>>>> +/* Copyright(c) 2020 - 2023 Allwinner Technology Co.,Ltd. All =
rights reserved. =20
>>>=20
...
>>> the kernel. You definitely cannot add code with that license, and =
from
>>> my understanding cannot copy GPL-3 code without keeping the license,
>>> which means copying is a no-go.
>>> You would need to ask the original author to change the license. I =
have
>>> seen license changes in github repos mirroring Allwinner's SDK in =
the
>>> last few months (someone must have told them?), so it's worth =
checking
>>> back there to see if the license has changed.
>>>=20
>>> But with that header, and with that source (subject to =
clarification)
>>> this cannot be merged as such.
>>>=20
>>=20
>> In the datasheet what I have, all this R_PRCM block is mentioned only =
at the memory mapping.
>> I did't found any other documentation about this IP.
>=20
> Yeah, that's quite common, the PRCM is rarely documented. It's also =
quite
> stable across the modern SoC, and by chance the A523 manual actually
> documents that, so you can peek in there. The V853 is probably a =
subset of
> what's in the A523.
...
> around other registers, especially those ending in "c", which are =
typically
...
> Then adjust that file according to the information gathered by =
inspecting
> the Allwinner source file you mention below. Since we are talking =
about a
> handful of clocks only, that should be easy enough?
> Then we have a clean sheet license-wise, and you copy from a much =
better
> source anyway (just seeing capital letter hex constants below, for
> instance).
>=20

Thanks for this information, it=E2=80=99s very usefull! I reworked the =
ccu-r code based on D1 driver,
and reading/writing the implemented registers, so this licence issue is =
gone.

>> There is a driver [1] based on the more or less mainline'ish sunxi-ng =
clk=20
>> framework, so I took that and made it work with this v853-ccu driver.=20=

>>=20
>> I don=E2=80=99t know what should/can I do with the Licence or how =
should it done properly,
>> as it=E2=80=99s basically a few registers/bits, but without =
documentation it=E2=80=99s hard to write it from scratch.
>=20
> Absolutely, and normally it's a no-brainer, since even Allwinner Linux
> code must be GPL, but in this special case they became overzealous and =
put
> GPL-3.0 in :-(
>=20
>>=20
...
>>>> +
>>>> +
>>>> +static SUNXI_CCU_GATE(r_twd_clk, "r-twd", "osc24M", 0x012C, =
BIT(0), 0);
>>>> +static SUNXI_CCU_GATE(r_ppu_clk, "r-ppu", "osc24M", 0x01AC, =
BIT(0), 0);
>>>> +static SUNXI_CCU_GATE(r_rtc_clk, "r-rtc", "osc24M", 0x020C, =
BIT(0), 0);
...
>>>=20
>>> Here the license looks right, but the authorship and source are =
still
>>> in question. Looks like the only real code in here is CLK_NUMBER, so =
if
>>> that is your line, drop all those bogus copyrights, and put in your =
own. =20
>>=20
>> Ok, I=E2=80=99ll.
>>=20
...
>>>=20
>>> What's "CLK_R_MAX_NO"? I think we put in the actual last clock name =
in,
>>> traditionally?
>>>=20
>>=20
>> Yes, you are right.
>=20
> Great, now it's your patch anyway, so you can easily claim the =
copyright
> and authorship ;-)
>=20
>>>> +
...
>>>=20
>>=20
>> Starting to write the first ccu driver without prior knowledge is not =
an easy task, so I started from the d1 ccu driver. I don=E2=80=99t know
>> how much from that remains actually, but I don=E2=80=99t wanted to =
remove that comment. I looked around how should it be done
...
> Maxime anyway, you can just copy Samuel's line, without the "All =
rights
> reserved". It's probably redundant anyway.
>=20
>> I=E2=80=99ll remove that.
>=20
...
>>>=20
>>> But bit 30 and 31 are set already by the PLL loop in the probe =
routine
...
>>>=20
>>> This must be CLK_SET_RATE_GATE, as we figured some weeks ago. The =
manual
>>> says that for changing the frequency you must leave the PLL enabled
>>> (bits 31 and 30 =3D 1), but gate the output (bit 27 =3D 0). The =
"GATE" in
>>> that flag name here refers to the .enable mask above.
>>> So CLK_SET_RATE_UNGATE would mean: don't touch the enable bit, but =
keep
>>> it running, which would be correct if the enable bit would be about =
the
>>> real enable bit (bit 31). But since we model this like "enable means =
not
>>> gated", we must gate the output, by setting the enable bit to 0.
>>> CLK_SET_RATE_GATE does exactly that.
>>>=20
>>=20
>> All this BIT (30, 31, 27) and MULT_MIN 12 are comes from the mistake =
that I tried to follow the BSP
>> driver [2] too closely.
>> As the cpu freq. scaling are working [3] with this settings too, I =
missed that.
>=20
...
After changing the enable BITS and setting CLK_SET_RATE_GATE in PLLs the =
cpu freq scaling is still working,
...
>> [2]: =
https://github.com/YuzukiHD/TinyVision/blob/main/kernel/bsp/drivers/clk/su=
nxi-ng/ccu-sun8iw21.c
>>=20
>> [3]: v851s:~# cat =
/sys/devices/system/cpu/cpu0/cpufreq/stats/time_in_state=20
>> 408000 177620
>> 600000 10099
>> 720000 2593
>> 912000 338
...
>>>> +};
>>>> +
>>>> +static SUNXI_CCU_M(pll_periph_2x_clk, "pll-periph-2x", =
"pll-periph-4x",
>>>> +        0x020, 16, 3, 0); =20
>>>=20
>>> So is there a recommendation about how we reference other clocks? =
This
...
>>>=20
>>> I have seen both, sun20i-d1 for instance uses this, and I copied =
from
...
>>>> +        0x020, 20, 3, 0);
>>>> +
>>>> +static SUNXI_CCU_M(pll_periph_480M_clk, "pll-periph-480M", =
"pll-periph-4x",
>>>> +        0x020, 2, 3, 0);
>>>> +
...
>>>=20
>>> That's a bit confusing: the manual says that the default value for =
bit 0
>>> is 0x1, and that it's "only for testing", which would mean we should
>>> leave it like this, always dividing by 2? In the main description =
(bit
>>> 31) it says:
...
>>>=20
>>> Do you have any indication how fast the video PLL really is? If it =
is
>>> divided by 2 (as we force that bit to 1 down in the probe routine), =
then
>>> we would need to model this with that CCU_FEATURE_FIXED_POSTDIV =
flag,
>>> and either leave that bit alone or force it to 1 instead.
>>> Also would be good to see what the BSP does.
>>>=20
>>=20
>> The [2] BSP driver model it as a ccu_nkmp type, so i=E2=80=99ll =
double check it.
>>=20
>>>> + */
...
>>>=20
>>> Ah, here you are using the pointer reference to the base clock, not =
the
...
>>>> + * in the user manual. So it's not modelled and forced to 0. =20
>>>=20
>>> Same situation as for the video PLL: what is the recommended setting =
of
>>> bit 0, really?
>>>=20
>>=20
>> Same as with the PLL_VIDEO. I=E2=80=99ll check it again, and modify =
both.
>>=20
>>>> + */
...
>>>> + { .rate =3D 196608000, .pattern =3D 0xc001eb85, .m =3D 5, .n =3D =
40 }, /* 24.576 */
>>>> + { .rate =3D 67737600, .pattern =3D 0xc001288d, .m =3D 8, .n =3D =
22 }, /* 22.5792 */
>>>> +};
>>>> +
...
>>>> + },
>>>> +};
>>>> +static SUNXI_CCU_M(pll_audio_1x_clk, "pll-audio-1x", =
"pll-audio-div5",
>>>> + 0xe00, 0, 5, CLK_SET_RATE_PARENT);
>>>> +
>>>> +/* pll-audio-div2 and pll-aduio-4x not used, because audio-1x can =
cover 22.5792M and 24.576M */
...
(0x504)
>>>> + * and has a special key field. The clock does not need to be =
ungated anyway. =20
>>>=20
>>> I would believe it should read: "The clock must not be gated anyway =
by
>>> the kernel". (As it would stop execution on the Arm cores, so it's =
only
...
>>>=20
>>> I wonder if it's more efficient to use a pointer to the CPU clock, =
and
>>> not a string?
>>>=20
>>=20
...
>>>> +   0x60c, BIT(0), 0);
>>>> +
>>>> +static SUNXI_CCU_M_HW_WITH_MUX_GATE(g2d_clk, "g2d", =
de_g2d_parents, 0x630,
>>>> +     0, 5, /* M */
>>>> +     24, 1, /* mux */
>>>> +     BIT(31), /* gate */
>>>> +     CLK_SET_RATE_PARENT);
...
>>>> +        0, 4, /* M */ =20
>>>=20
>>> looks like the indentation here is a bit off, can you check this? =
And
...
>>>> +};
>>>> +static SUNXI_CCU_M_HW_WITH_MUX_GATE(ve_clk, "ve", ve_parents, =
0x690,
>>>> +     0, 5, /* M */
>>>> +     24, 3, /* mux */
>>>> +     BIT(31), /* gate */
...
>>>> +   0x71c, BIT(1), 0);
>>>> +
>>>> +static SUNXI_CCU_GATE_HWS(bus_spinlock_clk, "bus-spinlock", =
ahb_hws,
>>>> +   0x72c, BIT(0), 0);
>>>> +
...
>>>> + &pll_periph_800M_clk.common.hw,
>>>> +};
>>>> +static SUNXI_CCU_MP_HW_WITH_MUX_GATE(dram_clk, "dram", =
dram_parents, 0x800,
>>>> +      0, 5, /* M */
>>>> +      8, 2, /* P */
>>>> +      24, 3, /* mux */
...
>>>> +};
>>>> +
>>>> +static SUNXI_CCU_M_HW_WITH_MUX_GATE(i2s0_clk, "i2s0", =
audio_parents, 0xa10,
>>>> +      0, 4, /* M */
>>>> +      24, 1, /* mux */
>>>> +      BIT(31), /* gate */
>>>> +      CLK_SET_RATE_PARENT);
>>>> +
>>>> +static SUNXI_CCU_M_HW_WITH_MUX_GATE(i2s1_clk, "i2s1", =
audio_parents, 0xa14,
>>>> +      0, 4, /* M */
>>>> +      24, 1, /* mux */
>>>> +      BIT(31), /* gate */
...
>> Thanks.
>>=20
>>> For the records: I extracted the bus gates and massaged them with =
some
>>> regexps to bring them into a shape where review is more feasible.
>>> They look alright to me. I didn't look at the respective mod clocks =
in
>>> detail, though.
>>>=20
>>>=20
...
>>>> +   0xa20, BIT(0), 0);
>>>> +
>>>> +static SUNXI_CCU_M_HW_WITH_MUX_GATE(dmic_clk, "dmic", =
audio_parents, 0xa40,
>>>> +      0, 4, /* M */
>>>> +      24, 1, /* mux */
>>>> +      BIT(31), /* gate */
...
"audio-codec-dac", audio_parents, 0xa50, =20
>>>=20
...
"audio-codec-adc", audio_parents, 0xa54,
>>>> +      0, 4, /* M */
>>>> +      24, 1, /* mux */
>>>> +      BIT(31), /* gate */
>>>> +      CLK_SET_RATE_PARENT);
...
BIT(8), 0);
>>>> +
>>>> +static SUNXI_CCU_GATE_HWS(bus_dpss_top_clk, "bus-dpss-top", =
ahb_hws,
>>>> +   0xabc, BIT(0), 0);
>>>> +
>>>> +
...
>>>> +       CLK_SET_RATE_PARENT);
>>>> +
>>>> +static SUNXI_CCU_GATE_HWS(bus_mipi_dsi_clk, "bus-mipi-dsi", =
ahb_hws,
>>>> +   0xb4c, BIT(0), 0);
>>>> +
>>>> +
...
>>>> +      CLK_SET_RATE_PARENT);
>>>> +
>>>> +static SUNXI_CCU_GATE_HWS(bus_tcon_lcd_clk, "bus-tcon-lcd", =
ahb_hws,
>>>> +   0xb7c, BIT(0), 0);
>>>> +
>>>> +
...
>>>> + 0xf30, BIT(0), 0);
>>>> +static SUNXI_CCU_GATE_DATA_WITH_PREDIV(fanout_12M_clk, =
"fanout-12M", osc24M,
>>>> + 0xf30, BIT(1), 2, 0);
>>>> +static SUNXI_CCU_GATE_HWS_WITH_PREDIV(fanout_16M_clk, =
"fanout-16M", pll_periph_160M_hws,
>>>> + 0xf30, BIT(2), 10, 0);
>>>> +static SUNXI_CCU_GATE_HWS_WITH_PREDIV(fanout_25M_clk, =
"fanout-25M", pll_periph_150M_hws,
>>>> + 0xf30, BIT(3), 6, 0);
>>>> +
>>>> +
>>>> +
...
>>=20
>> Yes, I forget to fix that. Modelling this way (because of the =
KEY_FIELD) was faster
