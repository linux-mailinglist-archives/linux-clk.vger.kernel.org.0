...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 637B24EED9A
	for <lists+linux-clk@lfdr.de>; Fri,  1 Apr 2022 14:59:44 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S245173AbiDANBb (ORCPT <rfc822;lists+linux-clk@lfdr.de>);
        Fri, 1 Apr 2022 09:01:31 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58936 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233932AbiDANBb (ORCPT
        <rfc822;linux-clk@vger.kernel.org>); Fri, 1 Apr 2022 09:01:31 -0400
Received: from mx1.tq-group.com (mx1.tq-group.com [93.104.207.81])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id CC6991D4195;
        Fri,  1 Apr 2022 05:59:39 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
  d=tq-group.com; i=@tq-group.com; q=dns/txt; s=key1;
  t=1648817980; x=1680353980;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=Ia6aC9/jjqejP1aX1HFasx0T5x0U2ovJ2UhRQfGnx8g=;
  b=TFEY9dV1eqKEpjFa1hxnQgjFMFM0/m7psd5jZg9i1XDCQudCjlTBQusA
   irg8LFhUrTuUcsYVs/sku5F2SUerNjKFrbV+P2In1dfi677CI6JKMbW1W
   ChvobqSaR0LYlezEWfympaAl8jPbvvqZUfdsO4LEoMWIz1LW1vjMsbUBh
   uArIDzvuA1DZr3z8NjqOE7+bU+bhkbPcsN6xA6dz2/wLesEf0D57l7Bxb
   BiwEl34MCbiwbP/WXXFhLttFvYMdueQ6d4MUy0u1o9OKJsgnqHhINxIEW
   5lIN4c6x5Dhi3f10m2IhrQbOV5WFJq6kL0V51rSiPnJAtLnN1xiHF8J/y
   A==;
X-IronPort-AV: E=Sophos;i="5.90,227,1643670000"; 
   d="scan'208";a="23044209"
Received: from unknown (HELO tq-pgp-pr1.tq-net.de) ([192.168.6.15])
  by mx1-pgp.tq-group.com with ESMTP; 01 Apr 2022 14:59:38 +0200
Received: from mx1.tq-group.com ([192.168.6.7])
  by tq-pgp-pr1.tq-net.de (PGP Universal service);
  Fri, 01 Apr 2022 14:59:38 +0200
X-PGP-Universal: processed;
        by tq-pgp-pr1.tq-net.de on Fri, 01 Apr 2022 14:59:38 +0200
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
  d=tq-group.com; i=@tq-group.com; q=dns/txt; s=key1;
  t=1648817978; x=1680353978;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=Ia6aC9/jjqejP1aX1HFasx0T5x0U2ovJ2UhRQfGnx8g=;
  b=hwLf0xNGUn+SyHRk042XxZmveZ2jnghz4J35dE+zJl6Tlvw4puX+wlXp
   U8JAzt4RkN5sHb/BtF/jJkVMn0ZUjmEA+9WL/WvE/va1C4XfK94SjEEzK
   NHHbBZGDMluhvW6KHVJd5sG6dlVsTMyhpW9RGZ869Q5LXkhbDpPAesFAQ
   BcowN894TLdjKPsoMAvYfnFwlHgQZP2+yAwpgN8+lSDKLBWUQfDXV7Chd
   qNZQsZmBFSXM8pgH1R4il40q5AC5883I3tnaVB8o6xyn7SmWDSS7si66q
   WBBDgquQnFN4N3B4ax3n5u7+IIY2iUm6xOM3BuMVA201Tp0Gl4havF1Iv
   w==;
X-IronPort-AV: E=Sophos;i="5.90,227,1643670000"; 
   d="scan'208";a="23044208"
Received: from vtuxmail01.tq-net.de ([10.115.0.20])
  by mx1.tq-group.com with ESMTP; 01 Apr 2022 14:59:37 +0200
Received: from steina-w.localnet (unknown [10.123.49.12])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits))
        (No client certificate requested)
        by vtuxmail01.tq-net.de (Postfix) with ESMTPSA id A39D6280065;
        Fri,  1 Apr 2022 14:59:37 +0200 (CEST)
...
Subject: Re: (EXT) Re: (EXT) Re: [PATCH v2 3/3] clk: Drop the rate range on clk_put
Date:   Fri, 01 Apr 2022 14:59:37 +0200
Message-ID: <2099976.irdbgypaU6@steina-w>
Organization: TQ-Systems GmbH
In-Reply-To: <20220401122736.5yvanksa4pla7uql@houat>
References: <20220325161144.1901695-1-maxime@cerno.tech> <2236051.ElGaqSPkdT@steina-w> <20220401122736.5yvanksa4pla7uql@houat>
MIME-Version: 1.0
...
xL
> > (DT) [    0.789985] pstate: 60000005 (nZCv daif -PAN -UAO -TCO -DIT -SS=
BS
> > BTYPE=3D--) [    0.796985] pc : clk_mux_determine_rate_flags+0x280/0x2cc
...
> --- a/drivers/clk/clk.c
> +++ b/drivers/clk/clk.c
> @@ -2599,6 +2599,8 @@ static int clk_core_set_parent_nolock(struct clk_co=
re
> *core, } else {
...
Thanks for the patch. Unfortunately it does not help in my case. Here is th=
e=20
...
[    0.769690] CPU: 2 PID: 1 Comm: swapper/0 Not tainted 5.17.0-next-202203=
31+=20
