Return-Path: <linux-clk+bounces-16521-lists+linux-clk=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-clk@lfdr.de
Delivered-To: lists+linux-clk@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 396A89FF1B0
	for <lists+linux-clk@lfdr.de>; Tue, 31 Dec 2024 21:18:03 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id B5A191881FB8
	for <lists+linux-clk@lfdr.de>; Tue, 31 Dec 2024 20:18:04 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B64CB1B0427;
	Tue, 31 Dec 2024 20:18:00 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=cirrus.com header.i=@cirrus.com header.b="UiTdP3l8"
X-Original-To: linux-clk@vger.kernel.org
Received: from mx0b-001ae601.pphosted.com (mx0b-001ae601.pphosted.com [67.231.152.168])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A9BDB196D90;
	Tue, 31 Dec 2024 20:17:57 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=67.231.152.168
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1735676280; cv=none; b=F8reiG7rSkEzX4psbaAYrePkjb+3j0+MJ3okJIKXDzUCypRrqeTT1QJnbRE39rGzEX4pepGY6IM9I2iWch+qw+6nbilkiAO83CqtVyw0qeU4JsmsWhb+AmCm3dY55tV58PWx8VPx5mQe7Kg0gRr7+C7aX5Lx6kKXRcM5aL/D5VE=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1735676280; c=relaxed/simple;
	bh=WmRq3zVBhZFJA/IRR67s1CFYuKs68S1ak8vnDzYI9sU=;
	h=From:To:CC:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=q8KI0gCf0RmDsePm4fSmZ60YRclXOM9vosLrR6e9j8SjvH/+maGzlKWyfFezm6bui2i+/e4T3+/LOISgPK3BtUag5+vxbAzHq25UnPfOfWliPo6wNplozqPuBehZ26PcyED754ro33fROO24ndlQsXsEvlZqmdZ+0JrOI5WNu5A=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=opensource.cirrus.com; spf=pass smtp.mailfrom=opensource.cirrus.com; dkim=pass (2048-bit key) header.d=cirrus.com header.i=@cirrus.com header.b=UiTdP3l8; arc=none smtp.client-ip=67.231.152.168
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=opensource.cirrus.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=opensource.cirrus.com
Received: from pps.filterd (m0077474.ppops.net [127.0.0.1])
	by mx0b-001ae601.pphosted.com (8.18.1.2/8.18.1.2) with ESMTP id 4BVJAJtV014562;
	Tue, 31 Dec 2024 14:17:51 -0600
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=cirrus.com; h=cc
	:content-transfer-encoding:content-type:date:from:in-reply-to
	:message-id:mime-version:references:subject:to; s=
	PODMain02222019; bh=AvYB+cb3W6YLjr+93TK42zLKwEEwGlEN5kUblqXpUus=; b=
	
Received: from ediex02.ad.cirrus.com ([84.19.233.68])
	by mx0b-001ae601.pphosted.com (PPS) with ESMTPS id 43temk351q-1
	(version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
	Tue, 31 Dec 2024 14:17:51 -0600 (CST)
...
Received: from ediswmail9.ad.cirrus.com (198.61.86.93) by
 ...
 15.2.1544.13 via Frontend Transport; Tue, 31 Dec 2024 20:17:49 +0000
Received: from paulha.crystal.cirrus.com (paulha.ad.cirrus.com [141.131.145.123])
	by ediswmail9.ad.cirrus.com (Postfix) with ESMTP id 23BF782024A;
	Tue, 31 Dec 2024 20:17:48 +0000 (UTC)
...
Subject: [PATCH v5 2/2] clk: cs2600: Add Fractional-N clock driver
Date: Tue, 31 Dec 2024 14:17:42 -0600
Message-ID: <20241231201742.3955733-3-paulha@opensource.cirrus.com>
...
X-Proofpoint-GUID: TcHivfQVswP_LYxIWB4slvN7K6FaoHTC
X-Proofpoint-ORIG-GUID: TcHivfQVswP_LYxIWB4slvN7K6FaoHTC
...
index bf4bd45adc3a..826917045ed3 100644
--- a/drivers/clk/Makefile
+++ b/drivers/clk/Makefile
@@ -53,7 +53,7 @@ obj-$(CONFIG_COMMON_CLK_CDCE706)	+= clk-cdce706.o
