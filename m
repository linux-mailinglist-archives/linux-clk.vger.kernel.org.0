...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 432DF396CD7
	for <lists+linux-clk@lfdr.de>; Tue,  1 Jun 2021 07:31:09 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232744AbhFAFcs (ORCPT <rfc822;lists+linux-clk@lfdr.de>);
        Tue, 1 Jun 2021 01:32:48 -0400
Received: from mo-csw1115.securemx.jp ([210.130.202.157]:37664 "EHLO
        mo-csw.securemx.jp" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231139AbhFAFcs (ORCPT
        <rfc822;linux-clk@vger.kernel.org>); Tue, 1 Jun 2021 01:32:48 -0400
Received: by mo-csw.securemx.jp (mx-mo-csw1115) id 1515UoFt003151; Tue, 1 Jun 2021 14:30:50 +0900
X-Iguazu-Qid: 2wGqsZ5qwpsi9PP09j
X-Iguazu-QSIG: v=2; s=0; t=1622525449; q=2wGqsZ5qwpsi9PP09j; m=5n4cdIX9hqdk9wdye1Qw6XmYRqgmfGDapxSwSl6cbXQ=
Received: from imx12-a.toshiba.co.jp (imx12-a.toshiba.co.jp [61.202.160.135])
        by relay.securemx.jp (mx-mr1110) id 1515UlXE031916
        (version=TLSv1.2 cipher=AES128-GCM-SHA256 bits=128 verify=NOT);
        Tue, 1 Jun 2021 14:30:49 +0900
Received: from enc02.toshiba.co.jp (enc02.toshiba.co.jp [61.202.160.51])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by imx12-a.toshiba.co.jp (Postfix) with ESMTPS id AE2F01000D9;
        Tue,  1 Jun 2021 14:30:47 +0900 (JST)
Received: from hop101.toshiba.co.jp ([133.199.85.107])
        by enc02.toshiba.co.jp  with ESMTP id 1515UkIj027714;
...
Subject: [PATCH v2 1/4] clk: visconti: Add support common clock driver and reset driver
Date:   Tue,  1 Jun 2021 14:30:34 +0900
X-TSB-HOP: ON
Message-Id: <20210601053037.233573-2-nobuhiro1.iwamatsu@toshiba.co.jp>
...
new file mode 100644
index 000000000000..04716bc61a66
--- /dev/null
...
+						 &tmpv7708_rst_lock);
+	if (ret) {
+		pr_err("%s: Failed to register reset controller: %d\n",
+		       __func__, ret);
+		return;
+	}
+
...
+	if (IS_ERR(clk)) {
+		pr_err("%s: Failed to register OSC3 clock: %d\n", __func__, ret);
+		return;
+	}
+
...
+				    &tmpv7708_clk_lock);
+	if (ret) {
+		pr_err("%s: Failed to register main clock gate: %d\n",
+		       __func__, ret);
+		return;
+	}
+
...
+	if (ret) {
+		pr_err("%s: Failed to register pietherpll clock gate: %d\n",
+		       __func__, ret);
+		return;
+	}
+
...
new file mode 100644
index 000000000000..202e56a2d217
--- /dev/null
...
new file mode 100644
index 000000000000..684945c45a6f
--- /dev/null
...
new file mode 100644
index 000000000000..f5431986e367
--- /dev/null
...
new file mode 100644
index 000000000000..043a7b5414d1
--- /dev/null
