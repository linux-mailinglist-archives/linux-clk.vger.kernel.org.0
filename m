Return-Path: <linux-clk+bounces-32042-lists+linux-clk=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-clk@lfdr.de
Delivered-To: lists+linux-clk@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id 967B5CE66D4
	for <lists+linux-clk@lfdr.de>; Mon, 29 Dec 2025 12:00:54 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 0B08C300DA49
	for <lists+linux-clk@lfdr.de>; Mon, 29 Dec 2025 11:00:17 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1171F28934F;
	Mon, 29 Dec 2025 11:00:16 +0000 (UTC)
X-Original-To: linux-clk@vger.kernel.org
Received: from zg8tmja2lje4os4yms4ymjma.icoremail.net (zg8tmja2lje4os4yms4ymjma.icoremail.net [206.189.21.223])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B52E5128816;
	Mon, 29 Dec 2025 11:00:10 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=206.189.21.223
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1767006016; cv=none; b=azE3mSBp3CXTS7bx86c9KinIxyq+YliXitSDpNUWleeik1tsmHhk7IjskTczc39Y4x5KnNiVVg9hpPmPY/OoEGTHPWTnsjMmI5uLZs6WMlaVY+WpiLuauy5SSG7ABQSnOim1iyETfxKS6WpNN5Qa4ZpG0szKUlkET4sglYIigbA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1767006016; c=relaxed/simple;
	bh=IkM39tKZWYR3wJnlIkwYDKxfP6rHgDlqD1oVGLTTZN0=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=QP3yOATagxzWYZM1ZUpGwXQI/4qWQKte+8D1pQ3eUE+E/BD5a1shSKTLFTa2FDo1n31WaDKxcGUnlpZyQkTgQ7BviGD6Bncfq+uQphotkPUmHjvYfQRmrYwKkwcxqdl1lBjuCKnBL0t+uW4V/846E9yC9J5pPXN7EfiET8q8ki4=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=eswincomputing.com; spf=pass smtp.mailfrom=eswincomputing.com; arc=none smtp.client-ip=206.189.21.223
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=eswincomputing.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=eswincomputing.com
Received: from E0005152DT.eswin.cn (unknown [10.12.96.41])
	by app2 (Coremail) with SMTP id TQJkCgA3e64nX1Jp6qOLAA--.16880S2;
	Mon, 29 Dec 2025 18:59:52 +0800 (CST)
...
Subject: [PATCH v9 2/3] clock: eswin: Add eic7700 clock driver
Date: Mon, 29 Dec 2025 18:59:49 +0800
Message-Id: <20251229105949.1202-1-dongxuyang@eswincomputing.com>
...
X-CM-TRANSID:TQJkCgA3e64nX1Jp6qOLAA--.16880S2
X-Coremail-Antispam: 1UD129KBjvAXoWkJFWxKFyUCr4rAF13AF13Jwb_yoWfJr1Duo
...
+
+	ret = eswin_clk_register_fixed_rate(eic7700_fixed_rate_clks,
+					    ARRAY_SIZE(eic7700_fixed_rate_clks),
+					    clk_data, dev);
+	if (ret)
+		return ret;
+
+	ret = eswin_clk_register_pll(eic7700_pll_clks,
+				     ARRAY_SIZE(eic7700_pll_clks),
+				     clk_data, dev);
+	if (ret)
+		return ret;
+
+	pll_clk = devm_clk_hw_get_clk
...
+		return ret;
+
+	ret = eswin_clk_register_mux(eic7700_mux_clks,
+				     ARRAY_SIZE(eic7700_mux_clks), clk_data,
+				     dev);
+	if (ret)
+		return ret;
+
+	ret = eswin_clk_register_divider(eic7700_div_clks,
+					 ARRAY_SIZE(eic7700_div_clks),
+					 clk_data, dev);
+	if (ret)
+		return ret;
+
+	ret = eswin_clk_register_gate(eic7700_gate_clks,
