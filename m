Return-Path: <linux-clk+bounces-15724-lists+linux-clk=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-clk@lfdr.de
Delivered-To: lists+linux-clk@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id BBA749EC0CE
	for <lists+linux-clk@lfdr.de>; Wed, 11 Dec 2024 01:33:00 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 715F0282A3D
	for <lists+linux-clk@lfdr.de>; Wed, 11 Dec 2024 00:32:59 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8DF261799B;
	Wed, 11 Dec 2024 00:32:55 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=cirrus.com header.i=@cirrus.com header.b="ngjDmvS+"
X-Original-To: linux-clk@vger.kernel.org
Received: from mx0b-001ae601.pphosted.com (mx0b-001ae601.pphosted.com [67.231.152.168])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id C5EFEB65C;
	Wed, 11 Dec 2024 00:32:51 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=67.231.152.168
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1733877175; cv=none; b=MTOmH9J3eDwmc7U5VRRotgWZzwO3UMrVkj+NZkxeXbX94Yq3ZYQv558JbvXho01QFYdjMv+gYAcLgDhVs1PfiB8KHH6qumROKjnpKh29x6+VBVEoUGu8FPTQ6uN8S7dzkWJEIAUL0X39Nfw4QHQ8PdGa3REacSYUjCN6Fd13kGk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1733877175; c=relaxed/simple;
	bh=9OCW/kOc0wy7RX26VSgTeqxndoyKBEVNc/dz8XiGops=;
	h=From:To:CC:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=LkxXmJThTMe190u/v7yPcnwfeLLtoxwdgn9Ob7bY558fAfHi4/gVLfvcp7XJR4evyULXhUtKAMglr6ZMXgsqhui1fvluT5OoVA2sGa2InPsmKFb/+hCPS3kKMcysmaWWG47VdpbRSs36RyHI9Vp5W1IST81qdwRE137u/00xoSU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=opensource.cirrus.com; spf=pass smtp.mailfrom=opensource.cirrus.com; dkim=pass (2048-bit key) header.d=cirrus.com header.i=@cirrus.com header.b=ngjDmvS+; arc=none smtp.client-ip=67.231.152.168
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=reject dis=none) header.from=opensource.cirrus.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=opensource.cirrus.com
Received: from pps.filterd (m0077474.ppops.net [127.0.0.1])
	by mx0b-001ae601.pphosted.com (8.18.1.2/8.18.1.2) with ESMTP id 4BABrx2f029906;
	Tue, 10 Dec 2024 18:32:45 -0600
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=cirrus.com; h=cc
	:content-transfer-encoding:content-type:date:from:in-reply-to
	:message-id:mime-version:references:subject:to; s=
	PODMain02222019; bh=K7gRuqmepCq7W5xWn8yDkxndLWbu4Ij0SLY5ykY7X4g=; b=
	
Received: from ediex01.ad.cirrus.com ([84.19.233.68])
	by mx0b-001ae601.pphosted.com (PPS) with ESMTPS id 43cknkcc7m-1
	(version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
	Tue, 10 Dec 2024 18:32:45 -0600 (CST)
...
Received: from ediswmail9.ad.cirrus.com (198.61.86.93) by
 ...
 15.2.1544.13 via Frontend Transport; Wed, 11 Dec 2024 00:32:43 +0000
Received: from paulha.crystal.cirrus.com (paulha.ad.cirrus.com [141.131.145.123])
	by ediswmail9.ad.cirrus.com (Postfix) with ESMTP id 24003822542;
...
Subject: [PATCH 2/2] clk: cs2600: Add Fractional-N clock driver
Date: Tue, 10 Dec 2024 18:32:36 -0600
Message-ID: <20241211003236.2523604-3-paulha@opensource.cirrus.com>
...
X-Proofpoint-ORIG-GUID: 7MM6NZRZuPl3iSrUpQkC4sIwJS5EkSTx
X-Proofpoint-GUID: 7MM6NZRZuPl3iSrUpQkC4sIwJS5EkSTx
...
+	}
+
+	*ratio = (out_rate << CS2600_12_20_SHIFT) / pll_rate;
+
+	return 0;
+}
+
...
+		*ratio = (product << CS2600_20_12_SHIFT) / parent_rate;
+
+	} else {
+		regmap_set_bits(regmap, CS2600_PLL_CFG3, CS2600_RATIO_CFG);
+		*ratio = (product << CS2600_12_20_SHIFT) / parent_rate;
+	}
+
+	return 0;
+}
...
+
+	ref_clk = devm_clk_get_optional(cs2600->dev, "ref_clk");
+	if (IS_ERR(ref_clk))
...
+
+	switch (aux_out) {
+	case CS2600_AUX_OUT_FREQ_UNLOCK:
+		val = CS2600_AUX_OUT_FREQ_UNLOCK_VAL;
+		break;
+	case CS2600_AUX_OUT_PHASE_UNLOCK:
+		val = CS2600_AUX_OUT_PHASE_UNLOCK_VAL;
+		break;
+	case CS2600_AUX_OUT_NO_CLKIN:
...
new file mode 100644
index 000000000000..fb246a26d981
--- /dev/null
