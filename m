...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id C2F197936BE
	for <lists+linux-clk@lfdr.de>; Wed,  6 Sep 2023 10:02:34 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229972AbjIFICh (ORCPT <rfc822;lists+linux-clk@lfdr.de>);
        Wed, 6 Sep 2023 04:02:37 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59796 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229969AbjIFICg (ORCPT
        <rfc822;linux-clk@vger.kernel.org>); Wed, 6 Sep 2023 04:02:36 -0400
Received: from mgamail.intel.com (mgamail.intel.com [192.55.52.93])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 0AA3ECFF;
        Wed,  6 Sep 2023 01:02:24 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  b=bZYW1QmEKwqAlvm6uhvp3Ck1/p5zd9/GbW2SCBFl52nJ+53Oln2Eyk7+
   ...
   Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10824"; a="374394854"
X-IronPort-AV: E=Sophos;i="6.02,231,1688454000"; 
   d="scan'208";a="374394854"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
  by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 06 Sep 2023 01:02:23 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6600,9927,10824"; a="718178697"
X-IronPort-AV: E=Sophos;i="6.02,231,1688454000"; 
   d="scan'208";a="718178697"
Received: from fmsmsx603.amr.corp.intel.com ([10.18.126.83])
  by orsmga006.jf.intel.com with ESMTP/TLS/AES256-GCM-SHA384; 06 Sep 2023 01:02:22 -0700
...
x-forefront-antispam-report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:MW4PR11MB5776.namprd11.prod.outlook.com;PTR:;CAT:NONE;SFS:(13230031)(396003)(366004)(136003)(376002)(346002)(39860400002)(1800799009)(186009)(451199024)(55016003)(8676002)(8936002)(4326008)(41300700001)(26005)(52536014)(5660300002)(83380400001)(7416002)(2906002)(71200400001)(478600001)(966005)(316002)(9686003)(6506007)(110136005)(54906003)(64756008)(66446008)(66476007)(66556008)(66946007)(76116006)(53546011)(7696005)(33656002)(86362001)(82960400001)(38070700005)(38100700002)(122000001);DIR:OUT;SFP:1102;
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 06 Sep 2023 08:02:19.5118
 (UTC)
...
> Subject: [Intel-wired-lan] [PATCH net-next 3/4] dpll: netlink/core: add s=
upport
...
>=20
> +static int
> +dpll_pin_phase_adj_set(struct dpll_pin *pin, struct nlattr *phase_adj_at=
tr,
> +		       struct netlink_ext_ack *extack)
> +{
> +	struct dpll_pin_ref *ref;
...
> +
>  static int
>  dpll_pin_parent_device_set(struct dpll_pin *pin, struct nlattr *parent_n=
est,
>  			   struct netlink_ext_ack *extack)
> @@ -793,6 +885,11 @@ dpll_pin_set_from_nlattr(struct dpll_pin *pin, struc=
t
> genl_info *info)
>  			if (ret)
>  				return ret;
