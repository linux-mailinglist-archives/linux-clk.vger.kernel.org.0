Return-Path: <linux-clk+bounces-31536-lists+linux-clk=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-clk@lfdr.de
Delivered-To: lists+linux-clk@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 40D4ECB46B4
	for <lists+linux-clk@lfdr.de>; Thu, 11 Dec 2025 02:27:54 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id ECC90304A108
	for <lists+linux-clk@lfdr.de>; Thu, 11 Dec 2025 01:23:21 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 2A08128F948;
	Thu, 11 Dec 2025 01:21:06 +0000 (UTC)
X-Original-To: linux-clk@vger.kernel.org
Received: from smtp.gentoo.org (woodpecker.gentoo.org [140.211.166.183])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E62C426D4F9;
	Thu, 11 Dec 2025 01:20:57 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=140.211.166.183
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1765416066; cv=none; b=JONnPdaSrcXoZww3tv0HKoUUcDUfKYtW06UL9QFNaF3Kj7fVvkB6z1DLb9flqJDiXKHcndP6jhFto+jsfb5/nCZgqIG7ZMaRY2V8N9zaGy1voOkz7prokxB6NUJsdCvCllCvG3AR+QoWMrmfugRztUt/Xlm7w1PoHBD/2nFTnro=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1765416066; c=relaxed/simple;
	bh=w4Cl85pajDu4fEzFy8PeC/kq5k5g5vzkpBBf3fmtdZ4=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=IwnRE0nbaMkAMZbWae3V//yxLkObYxtrw9Wm2beCHjwyg4d7aOec185F4c9SlzuXYf8eCPG/kHnZIcoGz7pNU6orvlZw5Mq1cxnHGZtCi0SuQH9mUcJqAgoqP2MqOFOUg2JIAHaKX0gTmgcAAUpp4fowajxN/hI+4fUuwu0joqg=
...
Received: from [127.0.0.1] (unknown [116.232.18.222])
	...
	by smtp.gentoo.org (Postfix) with ESMTPSA id C43F3340C39;
	Thu, 11 Dec 2025 01:20:51 +0000 (UTC)
From: Yixun Lan <dlan@gentoo.org>
Date: Thu, 11 Dec 2025 09:19:44 +0800
Subject: [PATCH RFC 4/4] clk: spacemit: k3: add the clock tree
Precedence: bulk
...
Message-Id: <20251211-k3-clk-v1-4-8ee47c70c5bc@gentoo.org>
...
X-Mailer: b4 0.14.3
X-Developer-Signature: v=1; a=openpgp-sha256; l=87116; i=dlan@gentoo.org;
 h=from:subject:message-id; bh=w4Cl85pajDu4fEzFy8PeC/kq5k5g5vzkpBBf3fmtdZ4=;
 b=
...
index 3854f6ae6d0e..9d0b89f41ee4 100644
--- a/drivers/clk/spacemit/Kconfig
+++ b/drivers/clk/spacemit/Kconfig
@@ -16,4 +16,10 @@ config SPACEMIT_K1_CCU
 	help
...
index 5ec6da61db98..6e1724c0447d 100644
...
+spacemit-ccu-objs		:= ccu_pll.o ccu_mix.o ccu_ddn.o
+
+obj-$(CONFIG_SPACEMIT_K1_CCU)	+= spacemit-ccu-k1.o
+spacemit-ccu-k1-y		:= ccu-k1.o
+
...
new file mode 100644
index 000000000000..30f4281597d9
--- /dev/null
