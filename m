Return-Path: <linux-clk+bounces-980-lists+linux-clk=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-clk@lfdr.de
Delivered-To: lists+linux-clk@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 80C7D806F14
	for <lists+linux-clk@lfdr.de>; Wed,  6 Dec 2023 12:52:09 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id A39291C20856
	for <lists+linux-clk@lfdr.de>; Wed,  6 Dec 2023 11:52:08 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8B1CC347BD;
	Wed,  6 Dec 2023 11:52:03 +0000 (UTC)
...
diff --git a/drivers/clk/starfive/jh8100/clk-sys-ne.c b/drivers/clk/starf=
ive/jh8100/clk-sys-ne.c
...
+
+static const struct starfive_clk_data jh8100_syscrg_ne_clk_data[] =3D {
+	/* flexnoc */
...
+		      SYSCRG_NE_CLK_OSC),
+	/* usb3 */
+	STARFIVE_GATE(SYSCRG_NE_CLK_USB3_CMN_SCAN_PLL, "sys_ne_clk_usb3_scan_pl=
l",
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_USB_WRAP_625),
+	STARFIVE_GATE(SYSCRG_NE_CLK_USB3_CMN_SCAN_SER, "sys_ne_clk_usb3_scan_se=
r",
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_USB_WRAP_625),
+	STARFIVE_GATE(SYSCRG_NE_CLK_USB3_PIPE_IN_SCAN, "sys_ne_clk_usb3_pipe_in=
_scan",
...
+	STARFIVE_GATE(SYSCRG_NE_CLK_USB3_XCVR_SCAN_PLL, "sys_ne_clk_usb3_xcvr_s=
can_pll",
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_USB_WRAP_625),
+	STARFIVE_GATE(SYSCRG_NE_CLK_USB3_XCVR_SCAN_SER, "sys_ne_clk_usb3_xcvr_s=
can_ser",
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_USB_WRAP_625),
+	STARFIVE__MUX(SYSCRG_NE_CLK_USB3_TAP_TCK, "sys_ne_clk_usb3_tap_tck", 2,
+		      SYSCRG_NE_CLK_USB3_TAP_TCK_EXT, SYSCRG_NE_CLK_GLB_EXT),
+	/* usb1 */
+	STARFIVE_GATE(SYSCRG_NE_CLK_USB1_CMN_SCAN_PLL, "sys_ne_clk_usb1_scan_pl=
l",
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_USB_WRAP_625),
+	STARFIVE_GATE(SYSCRG_NE_CLK_USB1_CMN_SCAN_SER, "sys_ne_clk_usb1_scan_se=
r",
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_USB_WRAP_625),
+	STARFIVE_GATE(SYSCRG_NE_CLK_USB1_PIPE_IN_SCAN, "sys_ne_clk_usb1_pipe_in=
_scan",
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_USB_125M),
...
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_USB_WRAP_60),
+	STARFIVE_GATE(SYSCRG_NE_CLK_USB1_XCVR_SCAN_PLL, "sys_ne_clk_usb1_xcvr_s=
can_pll",
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_USB_WRAP_625),
+	STARFIVE_GATE(SYSCRG_NE_CLK_USB1_XCVR_SCAN_SER, "sys_ne_clk_usb1_xcvr_s=
can_ser",
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_USB_WRAP_625),
+	STARFIVE__MUX(SYSCRG_NE_CLK_USB1_TAP_TCK, "sys_ne_clk_usb1_tap_tck", 2,
+		      SYSCRG_NE_CLK_USB1_TAP_TCK_EXT, SYSCRG_NE_CLK_GLB_EXT),
+	/* usb2 */
+	STARFIVE_GATE(SYSCRG_NE_CLK_USB2_CMN_SCAN_PLL, "sys_ne_clk_usb2_scan_pl=
l",
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_USB_WRAP_625),
+	STARFIVE_GATE(SYSCRG_NE_CLK_USB2_CMN_SCAN_SER, "sys_ne_clk_usb2_scan_se=
r",
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_USB_WRAP_625),
+	STARFIVE_GATE(SYSCRG_NE_CLK_USB2_PIPE_IN_SCAN, "sys_ne_clk_usb2_pipe_in=
_scan",
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_USB_125M),
...
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_USB_WRAP_60),
+	STARFIVE_GATE(SYSCRG_NE_CLK_USB2_XCVR_SCAN_PLL, "sys_ne_clk_usb2_xcvr_s=
can_pll",
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_USB_WRAP_625),
+	STARFIVE_GATE(SYSCRG_NE_CLK_USB2_XCVR_SCAN_SER, "sys_ne_clk_usb2_xcvr_s=
can_ser",
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_USB_WRAP_625),
+	STARFIVE__MUX(SYSCRG_NE_CLK_USB2_TAP_TCK, "sys_ne_clk_usb2_tap_tck", 2,
+		      SYSCRG_NE_CLK_USB2_TAP_TCK_EXT, SYSCRG_NE_CLK_GLB_EXT),
+	/* usb typec */
+	STARFIVE_GATE(SYSCRG_NE_CLK_TYPEC_PIPE_DIV_SCAN, "sys_ne_clk_typec_pipe=
_div_scan",
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_USB_WRAP_156P25),
+	STARFIVE_GATE(SYSCRG_NE_CLK_TYPEC_CMN_SCAN_PLL, "sys_ne_clk_typec_scan_=
pll",
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_USB_WRAP_625),
+	STARFIVE_GATE(SYSCRG_NE_CLK_TYPEC_CMN_SCAN_SER, "sys_ne_clk_typec_scan_=
ser",
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_USB_WRAP_625),
+	STARFIVE_GATE(SYSCRG_NE_CLK_TYPEC_SCAN_PIPE, "sys_ne_clk_typec_scan_pip=
e",
...
,
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_OSC),
+	STARFIVE_GATE(SYSCRG_NE_CLK_TYPEC_USB2_SCAN, "sys_ne_clk_typec_usb2_sca=
n",
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_APB_BUS_PER5),
+	STARFIVE_GATE(SYSCRG_NE_CLK_TYPEC_HSCLK, "sys_ne_clk_typec_hsclk", CLK_=
IGNORE_UNUSED,
...
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_USB_WRAP_60),
+	STARFIVE_GMUX(SYSCRG_NE_CLK_TYPEC_VID0, "sys_ne_clk_typec_vid0", CLK_IG=
NORE_UNUSED,
+		      2, SYSCRG_NE_CLK_VOUT_ROOT0, SYSCRG_NE_CLK_VOUT_ROOT1),
+	STARFIVE_GMUX(SYSCRG_NE_CLK_TYPEC_VID1, "sys_ne_clk_typec_vid1", CLK_IG=
NORE_UNUSED,
+		      2, SYSCRG_NE_CLK_VOUT_ROOT0, SYSCRG_NE_CLK_VOUT_ROOT1),
+	STARFIVE_GATE(SYSCRG_NE_CLK_TYPEC_XCVR_SCAN_PLL0, "sys_ne_clk_typec_xcv=
r_scan_pll0",
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_USB_WRAP_625),
+	STARFIVE_GATE(SYSCRG_NE_CLK_TYPEC_XCVR_SCAN_PLL1, "sys_ne_clk_typec_xcv=
r_scan_pll1",
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_USB_WRAP_625),
+	STARFIVE_GATE(SYSCRG_NE_CLK_TYPEC_XCVR_SCAN_PLL2, "sys_ne_clk_typec_xcv=
r_scan_pll2",
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_USB_WRAP_625),
+	STARFIVE_GATE(SYSCRG_NE_CLK_TYPEC_XCVR_SCAN_PLL3, "sys_ne_clk_typec_xcv=
r_scan_pll3",
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_USB_WRAP_625),
+	STARFIVE_GATE(SYSCRG_NE_CLK_TYPEC_XCVR_SCAN_SER0, "sys_ne_clk_typec_xcv=
r_scan_ser0",
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_USB_WRAP_625),
+	STARFIVE_GATE(SYSCRG_NE_CLK_TYPEC_XCVR_SCAN_SER1, "sys_ne_clk_typec_xcv=
r_scan_ser1",
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_USB_WRAP_625),
+	STARFIVE_GATE(SYSCRG_NE_CLK_TYPEC_XCVR_SCAN_SER2, "sys_ne_clk_typec_xcv=
r_scan_ser2",
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_USB_WRAP_625),
+	STARFIVE_GATE(SYSCRG_NE_CLK_TYPEC_XCVR_SCAN_SER3, "sys_ne_clk_typec_xcv=
r_scan_ser3",
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_USB_WRAP_625),
+	STARFIVE__MUX(SYSCRG_NE_CLK_TYPEC_TAP_TCK, "sys_ne_clk_typec_tap_tck", =
2,
...
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_APB_BUS_PER5),
+	STARFIVE_GDIV(SYSCRG_NE_CLK_VC9000LE_CORECLK, "sys_ne_clk_vc9000le_core=
clk",
...
+		      SYSCRG_NE_CLK_APB_BUS_PER2),
+	/* wdt */
+	STARFIVE_GATE(SYSCRG_NE_CLK_WDT_APB, "sys_ne_clk_wdt_apb", CLK_IGNORE_U=
NUSED,
+		      SYSCRG_NE_CLK_APB_BUS_PER2),
...
+		      SYSCRG_NE_CLK_OSC),
+	STARFIVE__DIV(SYSCRG_NE_CLK_UART1_CORE_PREOSC, "sys_ne_clk_uart1_core_p=
reosc",
...
+	STARFIVE__DIV(SYSCRG_NE_CLK_UART2_CORE_PREOSC, "sys_ne_clk_uart2_core_p=
reosc",
+		      131071, SYSCRG_NE_CLK_PERH_ROOT_PREOSC),
...
+	STARFIVE__DIV(SYSCRG_NE_CLK_UART3_CORE_PREOSC, "sys_ne_clk_uart3_core_p=
reosc",
+		      131071, SYSCRG_NE_CLK_PERH_ROOT_PREOSC),
...
+	STARFIVE__DIV(SYSCRG_NE_CLK_UART4_CORE_PREOSC, "sys_ne_clk_uart4_core_p=
reosc",
+		      131071, SYSCRG_NE_CLK_PERH_ROOT_PREOSC),
...
+	STARFIVE_GATE(SYSCRG_NE_CLK_I2S0_APB, "sys_ne_clk_i2s0_apb", CLK_IGNORE=
_UNUSED,
+		      SYSCRG_NE_CLK_APB_BUS_PER2),
...
+	STARFIVE_GATE(SYSCRG_NE_CLK_I2S1_APB, "sys_ne_clk_i2s1_apb", CLK_IGNORE=
_UNUSED,
+		      SYSCRG_NE_CLK_APB_BUS_PER2),
...
+	STARFIVE_GATE(SYSCRG_NE_CLK_I2S2_APB, "sys_ne_clk_i2s2_apb", CLK_IGNORE=
_UNUSED,
+		      SYSCRG_NE_CLK_APB_BUS_PER2),
...
+	STARFIVE_GATE(SYSCRG_NE_CLK_I2S0_STEREO_APB, "sys_ne_clk_i2s0_stereo_ap=
b",
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_APB_BUS_PER2),
+	STARFIVE_GATE(SYSCRG_NE_CLK_I2S0_STEREO, "sys_ne_clk_i2s0_stereo", CLK_=
IGNORE_UNUSED,
+		      SYSCRG_NE_CLK_MCLK),
+	STARFIVE_GINV(SYSCRG_NE_CLK_I2S0_STEREO_N, "sys_ne_clk_i2s0_stereo_n",
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_MCLK),
+	STARFIVE__MUX(SYSCRG_NE_CLK_I2S0_STEREO_BCLK_TX, "sys_ne_clk_i2s0_stere=
o_bclk_tx", 2,
+		      SYSCRG_NE_CLK_I2S3_BCLK, SYSCRG_NE_CLK_I2STX_BCLK_EXT),
+	STARFIVE__MUX(SYSCRG_NE_CLK_I2S0_STEREO_LRCK_TX, "sys_ne_clk_i2s0_stere=
o_lrck_tx", 2,
+		      SYSCRG_NE_CLK_I2S3_LRCK, SYSCRG_NE_CLK_I2STX_LRCK_EXT),
+	STARFIVE__MUX(SYSCRG_NE_CLK_I2S0_STEREO_BCLK_RX_ICG, "sys_ne_clk_i2s0_s=
tereo_bclk_rx_icg",
+		      2, SYSCRG_NE_CLK_I2S3_BCLK, SYSCRG_NE_CLK_I2STX_BCLK_EXT),
+	STARFIVE__MUX(SYSCRG_NE_CLK_I2S0_STEREO_LRCK_RX, "sys_ne_clk_i2s0_stere=
o_lrck_rx", 2,
+		      SYSCRG_NE_CLK_I2S3_LRCK, SYSCRG_NE_CLK_I2STX_LRCK_EXT),
...
+		      SYSCRG_NE_CLK_APB_BUS_PER2),
+	STARFIVE_GATE(SYSCRG_NE_CLK_PDM_4MIC_SCAN, "sys_ne_clk_pdm_4mic_scan", =
0,
+		      SYSCRG_NE_CLK_I2S3_BCLK),
+	STARFIVE_GATE(SYSCRG_NE_CLK_CAN0_CTRL_PCLK, "sys_ne_clk_can0_ctrl_pclk"=
,
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_APB_BUS_PER2),
+	STARFIVE_GDIV(SYSCRG_NE_CLK_CAN0_CTRL, "sys_ne_clk_can0_ctrl", CLK_IGNO=
RE_UNUSED, 50,
+		      SYSCRG_NE_CLK_AXI_400),
+	STARFIVE_GATE(SYSCRG_NE_CLK_CAN0_CTRL_TIMER, "sys_ne_clk_can0_ctrl_time=
r",
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_OSC),
+	STARFIVE_GATE(SYSCRG_NE_CLK_CAN1_CTRL_PCLK, "sys_ne_clk_can1_ctrl_pclk"=
,
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_APB_BUS_PER2),
+	STARFIVE_GDIV(SYSCRG_NE_CLK_CAN1_CTRL, "sys_ne_clk_can1_ctrl", CLK_IGNO=
RE_UNUSED, 50,
+		      SYSCRG_NE_CLK_AXI_400),
+	STARFIVE_GATE(SYSCRG_NE_CLK_CAN1_CTRL_TIMER, "sys_ne_clk_can1_ctrl_time=
r",
+		      CLK_IGNORE_UNUSED, SYSCRG_NE_CLK_OSC),
+	/* smbus */
+	STARFIVE_GATE(SYSCRG_NE_CLK_SMBUS0_APB, "sys_ne_clk_smbus0_apb", 0,
+		      SYSCRG_NE_CLK_APB_BUS_PER2),
+	STARFIVE_GDIV(SYSCRG_NE_CLK_SMBUS0_CORE, "sys_ne_clk_smbus0_core", 0, 1=
20,
+		      SYSCRG_NE_CLK_PERH_ROOT_PREOSC),
+	/* iomux */
+	STARFIVE_GATE(SYSCRG_NE_CLK_IOMUX_EAST_PCLK, "sys_ne_clk_iomux_east_pcl=
k", 0,
+		      SYSCRG_NE_CLK_APB_BUS_PER2),
+	/* icg_en */
...
+		      SYSCRG_NE_CLK_MCLK),
+	STARFIVE_GATE(SYSCRG_NE_CLK_I2S_STEREO_ICG_EN, "sys_ne_clk_i2s_stereo_e=
n", 0,
+		      SYSCRG_NE_CLK_MCLK),
+	STARFIVE_GATE(SYSCRG_NE_CLK_PDM_4MIC_ICG_EN, "sys_ne_clk_pdm_4mic_en", =
0,
+		      SYSCRG_NE_CLK_MCLK),
...
+};
+
+static struct clk_hw *jh8100_syscrg_ne_clk_get(struct of_phandle_args *c=
lkspec, void *data)
+{
...
+
+	for (idx =3D 0; idx < SYSCRG_NE_CLK_END; idx++) {
+		u32 max =3D jh8100_syscrg_ne_clk_data[idx].max;
+		struct clk_parent_data parents[4] =3D {};
+		struct clk_init_data init =3D {
+			.name =3D jh8100_syscrg_ne_clk_data[idx].name,
+			.ops =3D starfive_clk_ops(max),
+			.parent_data =3D parents,
+			.num_parents =3D
+				((max & STARFIVE_CLK_MUX_MASK) >> STARFIVE_CLK_MUX_SHIFT) + 1,
+			.flags =3D jh8100_syscrg_ne_clk_data[idx].flags,
+		};
+		struct starfive_clk *clk =3D &priv->reg[idx];
+		unsigned int i;
+
+		for (i =3D 0; i < init.num_parents; i++) {
+			unsigned int pidx =3D jh8100_syscrg_ne_clk_data[idx].parents[i];
+
+			if (pidx < SYSCRG_NE_CLK_END)
+				parents[i].hw =3D &priv->reg[pidx].hw;
+			else if (pidx =3D=3D SYSCRG_NE_CLK_OSC)
+				parents[i].fw_name =3D "clk_osc";
+			else if (pidx =3D=3D SYSCRG_NE_CLK_AXI_400)
+				parents[i].fw_name =3D "sys_clk_axi_400";
+			else if (pidx =3D=3D SYSCRG_NE_CLK_VOUT_ROOT0)
+				parents[i].fw_name =3D "sys_clk_vout_root0";
+			else if (pidx =3D=3D SYSCRG_NE_CLK_VOUT_ROOT1)
+				parents[i].fw_name =3D "sys_clk_vout_root1";
+			else if (pidx =3D=3D SYSCRG_NE_CLK_USB_WRAP_480)
+				parents[i].fw_name =3D "sys_clk_usb_wrap_480";
+			else if (pidx =3D=3D SYSCRG_NE_CLK_USB_WRAP_625)
+				parents[i].fw_name =3D "sys_clk_usb_wrap_625";
+			else if (pidx =3D=3D SYSCRG_NE_CLK_USB_WRAP_240)
+				parents[i].fw_name =3D "sys_clk_usb_wrap_240";
+			else if (pidx =3D=3D SYSCRG_NE_CLK_USB_WRAP_60)
+				parents[i].fw_name =3D "sys_clk_usb_wrap_60";
+			else if (pidx =3D=3D SYSCRG_NE_CLK_USB_WRAP_156P25)
+				parents[i].fw_name =3D "sys_clk_usb_wrap_156p25";
+			else if (pidx =3D=3D SYSCRG_NE_CLK_USB_WRAP_312P5)
+				parents[i].fw_name =3D "sys_clk_usb_wrap_312p5";
+			else if (pidx =3D=3D SYSCRG_NE_CLK_USB_125M)
+				parents[i].fw_name =3D "sys_clk_usb_125m";
+			else if (pidx =3D=3D SYSCRG_NE_CLK_GPIO_100)
+				parents[i].fw_name =3D "sys_nw_clk_gpio_100";
+			else if (pidx =3D=3D SYSCRG_NE_CLK_PERH_ROOT)
+				parents[i].fw_name =3D "sys_clk_perh_root";
+			else if (pidx =3D=3D SYSCRG_NE_CLK_MCLK)
+				parents[i].fw_name =3D "sys_clk_mclk";
+			else if (pidx =3D=3D SYSCRG_NE_CLK_USB3_TAP_TCK_EXT)
+				parents[i].fw_name =3D "clk_usb3_tap_tck_ext";
+			else if (pidx =3D=3D SYSCRG_NE_CLK_GLB_EXT)
+				parents[i].fw_name =3D "clk_glb_ext_clk";
+			else if (pidx =3D=3D SYSCRG_NE_CLK_USB1_TAP_TCK_EXT)
+				parents[i].fw_name =3D "clk_usb1_tap_tck_ext";
+			else if (pidx =3D=3D SYSCRG_NE_CLK_USB2_TAP_TCK_EXT)
+				parents[i].fw_name =3D "clk_usb2_tap_tck_ext";
+			else if (pidx =3D=3D SYSCRG_NE_CLK_TYPEC_TAP_TCK_EXT)
+				parents[i].fw_name =3D "clk_typec_tap_tck_ext";
+			else if (pidx =3D=3D SYSCRG_NE_CLK_SPI_IN0_EXT)
+				parents[i].fw_name =3D "clk_spi_in0_ext";
+			else if (pidx =3D=3D SYSCRG_NE_CLK_SPI_IN1_EXT)
+				parents[i].fw_name =3D "clk_spi_in1_ext";
+			else if (pidx =3D=3D SYSCRG_NE_CLK_I2STX_BCLK_EXT)
+				parents[i].fw_name =3D "clk_i2stx_bclk_ext";
+			else if (pidx =3D=3D SYSCRG_NE_CLK_I2STX_LRCK_EXT)
+				parents[i].fw_name =3D "clk_i2stx_lrck_ext";
+			else if (pidx =3D=3D SYSCRG_NE_CLK_PERH_ROOT_PREOSC)
+				parents[i].fw_name =3D "sys_clk_perh_root_preosc";
+			else if (pidx =3D=3D SYSCRG_NE_CLK_AHB_DMA)
+				parents[i].fw_name =3D "sys_clk_ahb0";
+			else if (pidx =3D=3D SYSCRG_NE_CLK_APB_BUS_PER1)
+				parents[i].fw_name =3D "sys_clk_apb_bus_per1";
+			else if (pidx =3D=3D SYSCRG_NE_CLK_APB_BUS_PER2)
+				parents[i].fw_name =3D "sys_clk_apb_bus_per2";
+			else if (pidx =3D=3D SYSCRG_NE_CLK_APB_BUS_PER3)
+				parents[i].fw_name =3D "sys_clk_apb_bus_per3";
+			else if (pidx =3D=3D SYSCRG_NE_CLK_APB_BUS_PER5)
+				parents[i].fw_name =3D "sys_clk_apb_bus_per5";
+			else if (pidx =3D=3D SYSCRG_NE_CLK_VENC_ROOT)
+				parents[i].fw_name =3D "sys_clk_venc_root";
+			else if (pidx =3D=3D SYSCRG_NE_CLK_SPI_CORE_100)
...
+	}
+
+	ret =3D devm_of_clk_add_hw_provider(&pdev->dev, jh8100_syscrg_ne_clk_ge=
t, priv);
+	if (ret)
+		return ret;
+
...
+}
+
+static const struct of_device_id jh8100_syscrg_ne_match[] =3D {
+	{ .compatible =3D "starfive,jh8100-syscrg-ne" },
+	{ /* sentinel */ }
+};
+
+static struct platform_driver jh8100_syscrg_ne_driver =3D {
+	.driver =3D {
+		.name =3D "clk-starfive-jh8100-sys-ne",
+		.of_match_table =3D jh8100_syscrg_ne_match,
+		.suppress_bind_attrs =3D true,
+	},
+};
+builtin_platform_driver_probe(jh8100_syscrg_ne_driver, jh8100_syscrg_ne_=
probe);
--=20
2.34.1
