...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 70F6B79F330
	for <lists+linux-clk@lfdr.de>; Wed, 13 Sep 2023 22:50:34 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232480AbjIMUuh (ORCPT <rfc822;lists+linux-clk@lfdr.de>);
        Wed, 13 Sep 2023 16:50:37 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47810 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232557AbjIMUuh (ORCPT
        <rfc822;linux-clk@vger.kernel.org>); Wed, 13 Sep 2023 16:50:37 -0400
Received: from out-212.mta0.migadu.com (out-212.mta0.migadu.com [IPv6:2001:41d0:1004:224b::d4])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id AD8D31BCB
        for <linux-clk@vger.kernel.org>; Wed, 13 Sep 2023 13:50:32 -0700 (PDT)
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linux.dev; s=key1;
        ...
        bh=vTpDoWZExb2R28AzVi58nkepz4kj51X5FeXoGnWSCyM=;
        b=XIxUQ3rW2vqejg25kDtN3Ayia79e67w7A6LuBofaa67vjOGQiNrW5yu5tn2L86Bb0ADmbG
        0HOFoXAH8mc5P9f+H9x2NkZJbcAkrkviwtTkHgPkLeenge7Y4JCps5yai59DK/xbz+PQco
        pJYvktAgFQYrtBFCs3bV3RXGgE+qNAw=
...
Subject: [PATCH net-next v8 3/9] dpll: core: Add DPLL framework base functions
Date:   Wed, 13 Sep 2023 21:49:37 +0100
Message-Id: <20230913204943.1051233-4-vadim.fedorenko@linux.dev>
...
index be36ec2687b8..f0a653bdbf6d 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -6334,6 +6334,17 @@ F:	Documentation/networking/device_drivers/ethernet/freescale/dpaa2/switch-drive
...
index 496ca02ee18f..d1157810cedf 100644
--- a/drivers/Kconfig
+++ b/drivers/Kconfig
@@ -241,4 +241,6 @@ source "drivers/hte/Kconfig"
...
index 0957f63ecb42..32cedfe0e5a5 100644
--- a/drivers/Makefile
+++ b/drivers/Makefile
@@ -196,5 +196,6 @@ obj-$(CONFIG_PECI)		+= peci/
 obj-$(CONFIG_HTE)		+= hte/
