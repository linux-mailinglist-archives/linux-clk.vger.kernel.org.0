Return-Path: <linux-clk+bounces-7227-lists+linux-clk=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-clk@lfdr.de
Delivered-To: lists+linux-clk@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id E4A8E8CBD07
	for <lists+linux-clk@lfdr.de>; Wed, 22 May 2024 10:30:14 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 3921F1F23173
	for <lists+linux-clk@lfdr.de>; Wed, 22 May 2024 08:30:14 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C416D7FBB6;
	Wed, 22 May 2024 08:29:55 +0000 (UTC)
X-Original-To: linux-clk@vger.kernel.org
Received: from mail-sh.amlogic.com (unknown [58.32.228.46])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id DB584182DB;
	Wed, 22 May 2024 08:29:51 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=58.32.228.46
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1716366595; cv=none; b=MTktyL4p4tRE1dfxJPiZhVb1h4DBbqBBMXrleufTDNV+2ohEB9YXRNI0R5867GbBy7OJg/3npVojh4R9ZQ5orntFmWW3C3Vfhs4JC3sPT2gsLfqnvK+xdMz70Ay326VMcej1v8cnSJx+cR36i5rUS1/Z2WYG+MfR6GDlg7Rq184=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1716366595; c=relaxed/simple;
	bh=+JNy3v45AR+oxVqlYUawI4WJWeCNxzn+waAKEHzg0r0=;
	h=From:To:CC:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=oMEww2AMs+EfmQd3IE7+RET6KYCY58dJxRel7ixsirRPrJ0apYQIsxPPrxkF7m30Hs//i9NKfv0AZbWoYim6lrqF3TX2BLikWry87yGXQmZW3dk+2TsAbdQMC8TKz4NbQ32JyZTLhJvhjb3lIn7nIA6GNUexHbxOO/bduTlqZGU=
...
Subject: [PATCH v9 5/5] clk: meson: c3: add c3 clock peripherals controller driver
Date: Wed, 22 May 2024 16:27:27 +0800
Message-ID: <20240522082727.3029656-6-xianwei.zhao@amlogic.com>
...
index 31225695b7a3..c48ff6080381 100644
--- a/drivers/clk/meson/Kconfig
+++ b/drivers/clk/meson/Kconfig
@@ -141,6 +141,20 @@ config COMMON_CLK_C3_PLL
