...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id F183F770889
	for <lists+linux-clk@lfdr.de>; Fri,  4 Aug 2023 21:06:01 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230231AbjHDTF4 (ORCPT <rfc822;lists+linux-clk@lfdr.de>);
        Fri, 4 Aug 2023 15:05:56 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:41764 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229932AbjHDTFx (ORCPT
        <rfc822;linux-clk@vger.kernel.org>); Fri, 4 Aug 2023 15:05:53 -0400
Received: from out-82.mta0.migadu.com (out-82.mta0.migadu.com [91.218.175.82])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 75836559D
        for <linux-clk@vger.kernel.org>; Fri,  4 Aug 2023 12:05:21 -0700 (PDT)
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linux.dev; s=key1;
        ...
        bh=0GEgkyCTkZ1YLMxl7PL5ni/eVwsu9ofYa7wbT4w4qbg=;
        b=D/h2QkHqkSoeRY8LdFuyBDQP8O47SbkGSj0be79tDwPYfxsQInffoN457lTCLX37z/8+15
        6T9andg7KN5dGH/di/alyW79d+JFFftUBQghDzU7rYGnLDX7k6AIVrmBjL3/zSLZ6Ua2VG
        ih95WdtYshLeEsC87yLr13UZsXP1/8o=
...
Subject: [PATCH net-next v2 8/9] ptp_ocp: implement DPLL ops
Date:   Fri,  4 Aug 2023 20:04:53 +0100
Message-Id: <20230804190454.394062-9-vadim.fedorenko@linux.dev>
...
index 20a974ced8d6..b4b61834f75a 100644
...
+	dpll_device_put(bp->dpll);
 out:
 	ptp_ocp_detach(bp);
 out_disable:
@@ -4249,7 +4485,17 @@ ptp_ocp_remove(struct pci_dev *pdev)
 {
