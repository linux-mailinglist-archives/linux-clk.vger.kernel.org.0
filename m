Return-Path: <linux-clk+bounces-10447-lists+linux-clk=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-clk@lfdr.de
Delivered-To: lists+linux-clk@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 059869492C6
	for <lists+linux-clk@lfdr.de>; Tue,  6 Aug 2024 16:15:43 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id A2B5E286405
	for <lists+linux-clk@lfdr.de>; Tue,  6 Aug 2024 14:15:41 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 922C418D642;
	Tue,  6 Aug 2024 14:15:26 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=collabora.com header.i=detlev.casanova@collabora.com header.b="BnqaG5RR"
X-Original-To: linux-clk@vger.kernel.org
Received: from sender4-op-o12.zoho.com (sender4-op-o12.zoho.com [136.143.188.12])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 920B718D638;
	Tue,  6 Aug 2024 14:15:20 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=pass smtp.client-ip=136.143.188.12
ARC-Seal:i=2; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1722953726; cv=pass; b=IMVhWdR51p1Xj6Yyg1Xeon5oErPkKN2UzJccErFNnn3IbN2IUOmg4ThibAb31BDh6/OBt6YnpqKL5LCJuWLXKs88NRTLBUtSUPfE8z8dKf5ltnmMKaKeFxrURSW3EgeABWBaWqDyRTVVm0ECIfBj1QmJ9H6HvlQ+TTw0jRXxEas=
ARC-Message-Signature:i=2; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1722953726; c=relaxed/simple;
	bh=kXyWVcT84PoDCc7lKkHRpHl2EG0AprFzhH6OnmmSffA=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=W64Pg6JjU8Qxp15BHDY/EmOAeRX7IhpBgjRenC7ZdohU6dP9y2U0EAtPHWLCgSvGqErXvsbIQWjTzl/ONp1lMD2BRD9fZmVC3ShUY61Rm2Of4PAHrUhoaqJEqF7bwBeP8ZVg/vpq1YaPuIWcn0AUWJOXeZ0kKJTGAgjs2Ocex3Q=
ARC-Authentication-Results:i=2; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=collabora.com; spf=pass smtp.mailfrom=collabora.com; dkim=pass (1024-bit key) header.d=collabora.com header.i=detlev.casanova@collabora.com header.b=BnqaG5RR; arc=pass smtp.client-ip=136.143.188.12
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=collabora.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=collabora.com
Delivered-To: kernel@collabora.com
ARC-Seal: i=1; a=rsa-sha256; t=1722953673; cv=none; 
	d=zohomail.com; s=zohoarc; 
	b=BaBUO2h1FeoFkkQWjNp5aFTqpV7ilI8DuHVLzh0lBapRShTmi75+YX/ocbKEbEKpXin03qyE0ydMbbqBpUxxX+pKMHrqncjVkGF+SmRttPKefTX05Qrkj2EuxrpFVFw31Y/gnhwShswSDh8xzNrZiRvk0A1Rh3k2zIjgxkk0xuU=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=zohomail.com; s=zohoarc; 
	t=1722953673; h=Content-Type:Content-Transfer-Encoding:Cc:Cc:Date:Date:From:From:In-Reply-To:MIME-Version:Message-ID:References:Subject:Subject:To:To:Message-Id:Reply-To; 
	bh=WaYjplfsoPjcJp9DqHQx104N5x9oRo8yZ6mWOiIx6wg=; 
	b=hLt87vR1JN6nQjp1kjGeOegXz95jfU2REM4RmLdHw3T3VjQjMjVP693JckintKywmAvsRLNfjBL9c+f/ji4ORyOTPlZ1LBoJs5a3M0lV6g2Pf0luYKVLmiC35hm6RadLlGt1Yz4CntrVSLF2aPAqG8vfAemUOP8WnP6Y1ihZBWM=
ARC-Authentication-Results: i=1; mx.zohomail.com;
	dkim=pass  header.i=collabora.com;
	spf=pass  smtp.mailfrom=detlev.casanova@collabora.com;
	dmarc=pass header.from=<detlev.casanova@collabora.com>
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; t=1722953673;
	s=zohomail; d=collabora.com; i=detlev.casanova@collabora.com;
	h=From:From:To:To:Cc:Cc:Subject:Subject:Date:Date:Message-ID:In-Reply-To:References:MIME-Version:Content-Transfer-Encoding:Content-Type:Message-Id:Reply-To;
	bh=WaYjplfsoPjcJp9DqHQx104N5x9oRo8yZ6mWOiIx6wg=;
	b=BnqaG5RRI3gUydMMwKrsi+3bVoOgfu+zJFdWs24lJnJE2BKpYjJu/ZkLvqWpAcRg
	8KXfKsjej2mBr6dimS/jesD/R8FarVncKOpEAr8iGw8ObgbaO/hzVeKvsuUDZwb6dFT
	ofJi8l2Iv3zg+Gi8wqKaaIaeUTwcn1ICWjwTBAPs=
Received: by mx.zohomail.com with SMTPS id 1722953670702253.24708291353772;
	Tue, 6 Aug 2024 07:14:30 -0700 (PDT)
...
Cc: Michael Turquette <mturquette@baylibre.com>,
 ...
 kernel@collabora.com, Finley Xiao <finley.xiao@rock-chips.com>,
...
Date: Tue, 06 Aug 2024 10:15:41 -0400
Message-ID: <2335430.ElGaqSPkdT@trenzalore>
In-Reply-To: <a9a9219d-325c-4afa-b40c-b261ff95263c@rock-chips.com>
References:
 <20240802214053.433493-1-detlev.casanova@collabora.com>
 <20240802214053.433493-4-detlev.casanova@collabora.com>
...
The suggestion from Heiko was that those reset should be managed by the=20
subsystems that use them, because they are on a different offset and theref=
ore=20
seem to be on a different core.

But I think I will include them here like you suggested because:
 - That's actually how it is done for rk3588 (which is quite close th rk357=
6),
 - According to you and the TRM, those resets are on the same core, just wi=
th=20
big offsets.
...
> partially missing.
>=20
> =E5=9C=A8 2024/8/3 5:35, Detlev Casanova =E5=86=99=E9=81=93:
...
> >   	depends on ARM64 || COMPILE_TEST
> >=20
> > diff --git a/drivers/clk/rockchip/Makefile b/drivers/clk/rockchip/Makef=
ile
> > index 36894f6a7022d..af2ade54a7efa 100644
> > --- a/drivers/clk/rockchip/Makefile
> > +++ b/drivers/clk/rockchip/Makefile
> > @@ -28,4 +28,5 @@ obj-$(CONFIG_CLK_RK3328)        +=3D clk-rk3328.o
> >=20
> >   obj-$(CONFIG_CLK_RK3368)        +=3D clk-rk3368.o
> >   obj-$(CONFIG_CLK_RK3399)        +=3D clk-rk3399.o
> >   obj-$(CONFIG_CLK_RK3568)	+=3D clk-rk3568.o
> >=20
> > +obj-$(CONFIG_CLK_RK3576)	+=3D clk-rk3576.o rst-rk3576.o
> >=20
> >   obj-$(CONFIG_CLK_RK3588)	+=3D clk-rk3588.o rst-rk3588.o
> >=20
...
> > +};
> > +
> > +static struct rockchip_pll_rate_table rk3576_pll_rates[] =3D {
> > +	/* _mhz, _p, _m, _s, _k */
...
> > +};
> > +
> > +static struct rockchip_pll_rate_table rk3576_ppll_rates[] =3D {
> > +	/* _mhz, _p, _m, _s, _k */
...
> > +
> > +#define RK3576_BIGCORE_CLKSEL2(_amcore)				=09
	\
> > +{							=09
		\
> > +	.reg =3D RK3576_BIGCORE_CLKSEL_CON(2),		=09
		\
> > +	.val =3D HIWORD_UPDATE(_amcore - 1, RK3576_ACLK_M_BIGCORE_DIV_MASK,=09
\
> > +			RK3576_ACLK_M_BIGCORE_DIV_SHIFT),		=09
\
> > +}
> > +
> > +#define RK3576_LITCORE_CLKSEL1(_amcore)			=09
		\
> > +{							=09
		\
> > +	.reg =3D RK3576_LITCORE_CLKSEL_CON(1),		=09
		\
> > +	.val =3D HIWORD_UPDATE(_amcore - 1, RK3576_ACLK_M_LITCORE_DIV_MASK,=09
\
> > +			RK3576_ACLK_M_LITCORE_DIV_SHIFT),	=09
	\
> > +}
> > +
> > +#define RK3576_LITCORE_CLKSEL2(_pclkdbg)			=09
	\
> > +{							=09
		\
> > +	.reg =3D RK3576_LITCORE_CLKSEL_CON(2),		=09
		\
> > +	.val =3D HIWORD_UPDATE(_pclkdbg - 1,=20
RK3576_PCLK_DBG_LITCORE_DIV_MASK,	\
> > +			RK3576_PCLK_DBG_LITCORE_DIV_SHIFT),=09
		\
> > +}
> > +
> > +#define RK3576_CCI_CLKSEL4(_ccisel, _div)			=09
	\
> > +{							=09
		\
> > +	.reg =3D RK3576_CCI_CLKSEL_CON(4),			=09
	\
> > +	.val =3D HIWORD_UPDATE(_ccisel, RK3576_ACLK_CCI_MUX_MASK,	=09
	\
> > +			RK3576_ACLK_CCI_MUX_SHIFT) |		=09
	\
> > +	       HIWORD_UPDATE(_div - 1, RK3576_ACLK_CCI_DIV_MASK,	=09
\
> > +			RK3576_ACLK_CCI_DIV_SHIFT),	=09
		\
> > +}
> > +
> > +#define RK3576_CPUBCLK_RATE(_prate, _amcore)		=09
		\
> > +{							=09
		\
> > +	.prate =3D _prate##U,				=09
		\
> > +	.divs =3D {					=09
		\
> > +		RK3576_BIGCORE_CLKSEL2(_amcore),		=09
	\
> > +	},					=09
			\
> > +}
> > +
> > +#define RK3576_CPULCLK_RATE(_prate, _amcore, _pclkdbg, _ccisel)	=09
	\
> > +{							=09
		\
> > +	.prate =3D _prate##U,				=09
...
> > +	.divs =3D {					=09
		\
> > +		RK3576_LITCORE_CLKSEL1(_amcore),		=09
	\
> > +		RK3576_LITCORE_CLKSEL2(_pclkdbg),		=09
	\
> > +	},					=09
			\
> > +	.pre_muxs =3D {				=09
			\
> > +		RK3576_CCI_CLKSEL4(2, 2),		=09
		\
> > +	},					=09
			\
> > +	.post_muxs =3D {				=09
			\
> > +		RK3576_CCI_CLKSEL4(_ccisel, 2),		=09
		\
> > +	},					=09
			\
> > +}
...
> > __initdata =3D { +	RK3576_CPUBCLK_RATE(2496000000, 2),
...
> > +};
> > +
> > +static const struct rockchip_cpuclk_reg_data rk3576_cpubclk_data =3D {
> > +	.core_reg[0] =3D RK3576_BIGCORE_CLKSEL_CON(1),
> > +	.div_core_shift[0] =3D 7,
> > +	.div_core_mask[0] =3D 0x1f,
> > +	.num_cores =3D 1,
> > +	.mux_core_alt =3D 1,
> > +	.mux_core_main =3D 0,
> > +	.mux_core_shift =3D 12,
> > +	.mux_core_mask =3D 0x3,
> > +};
> > +
> > +static struct rockchip_cpuclk_rate_table rk3576_cpulclk_rates[]
> > __initdata =3D { +	RK3576_CPULCLK_RATE(2400000000, 2, 6, 3),
...
> > +};
> > +
> > +static const struct rockchip_cpuclk_reg_data rk3576_cpulclk_data =3D {
> > +	.core_reg[0] =3D RK3576_LITCORE_CLKSEL_CON(0),
> > +	.div_core_shift[0] =3D 7,
> > +	.div_core_mask[0] =3D 0x1f,
> > +	.num_cores =3D 1,
> > +	.mux_core_alt =3D 1,
...
> > +
> > +PNAME(mux_pll_p)			=3D { "xin24m", "xin32k" };
> > +PNAME(mux_24m_32k_p)			=3D { "xin24m",=20
"xin_osc0_div" };
> > +PNAME(mux_armclkl_p)			=3D { "xin24m",=20
"pll_lpll", "lpll" };
> > +PNAME(mux_armclkb_p)			=3D { "xin24m",=20
"pll_bpll", "bpll" };
> > +PNAME(gpll_24m_p)			=3D { "gpll", "xin24m" };
> > +PNAME(cpll_24m_p)			=3D { "cpll", "xin24m" };
> > +PNAME(gpll_cpll_p)			=3D { "gpll", "cpll" };
> > +PNAME(gpll_spll_p)			=3D { "gpll", "spll" };
> > +PNAME(gpll_cpll_aupll_p)		=3D { "gpll", "cpll", "aupll" };
> > +PNAME(gpll_cpll_24m_p)			=3D { "gpll", "cpll",=20
"xin24m" };
> > +PNAME(gpll_cpll_24m_spll_p)		=3D { "gpll", "cpll", "xin24m",=20
"spll" };
> > +PNAME(gpll_cpll_aupll_24m_p)		=3D { "gpll", "cpll", "aupll",=20
"xin24m" };
> > +PNAME(gpll_cpll_aupll_spll_p)		=3D { "gpll", "cpll", "aupll",=20
"spll" };
> > +PNAME(gpll_cpll_aupll_spll_lpll_p)	=3D { "gpll", "cpll", "aupll", "spl=
l",
> > "lpll_dummy" }; +PNAME(gpll_cpll_spll_bpll_p)		=3D { "gpll",=20
"cpll",
> > "spll", "bpll_dummy" }; +PNAME(gpll_cpll_lpll_bpll_p)		=3D=20
{ "gpll",
> > "cpll", "lpll_dummy", "bpll_dummy" };
> > +PNAME(gpll_spll_cpll_bpll_lpll_p)	=3D { "gpll", "spll",  "cpll",
> > "bpll_dummy", "lpll_dummy" }; +PNAME(gpll_cpll_vpll_aupll_24m_p)	=3D {
> > "gpll", "cpll", "vpll", "aupll", "xin24m" };
> > +PNAME(gpll_cpll_spll_aupll_bpll_p)	=3D { "gpll", "cpll", "spll", "aupl=
l",
> > "bpll_dummy" }; +PNAME(gpll_cpll_spll_bpll_lpll_p)	=3D { "gpll",=20
"cpll",
> > "spll", "bpll_dummy", "lpll_dummy" };
> > +PNAME(gpll_cpll_spll_lpll_bpll_p)	=3D { "gpll", "cpll", "spll",
> > "lpll_dummy", "bpll_dummy" }; +PNAME(gpll_cpll_vpll_bpll_lpll_p)	=3D=20
{
> > "gpll", "cpll", "vpll", "bpll_dummy", "lpll_dummy" };
> > +PNAME(gpll_spll_aupll_bpll_lpll_p)	=3D { "gpll", "spll", "aupll",
> > "bpll_dummy", "lpll_dummy" }; +PNAME(gpll_spll_isppvtpll_bpll_lpll_p)=09
=3D {
> > "gpll", "spll", "isp_pvtpll", "bpll_dummy", "lpll_dummy" };
> > +PNAME(gpll_cpll_spll_aupll_lpll_24m_p)	=3D { "gpll", "cpll", "spll",
> > "aupll", "lpll_dummy", "xin24m" };
> > +PNAME(gpll_cpll_spll_vpll_bpll_lpll_p)	=3D { "gpll", "cpll",=20
"spll",
> > "vpll", "bpll_dummy", "lpll_dummy" }; +PNAME(cpll_vpll_lpll_bpll_p)	=09
=3D {
> > "cpll", "vpll", "lpll_dummy", "bpll_dummy" };
> > +PNAME(mux_24m_ccipvtpll_gpll_lpll_p)	=3D { "xin24m", "cci_pvtpll",=20
"gpll",
> > "lpll" }; +PNAME(mux_24m_spll_gpll_cpll_p)		=3D {"xin24m",=20
"spll", "gpll",
> > "cpll" }; +PNAME(audio_frac_int_p)			=3D { "xin24m",=20
"clk_audio_frac_0",
> > "clk_audio_frac_1", "clk_audio_frac_2", +			=09
	    "clk_audio_frac_3",
> > "clk_audio_int_0", "clk_audio_int_1", "clk_audio_int_2" };
> > +PNAME(audio_frac_p)			=3D { "clk_audio_frac_0",=20
"clk_audio_frac_1",
> > "clk_audio_frac_2", "clk_audio_frac_3" }; +PNAME(mux_100m_24m_p)	=09
	=3D {
> > "clk_cpll_div10", "xin24m" };
> > +PNAME(mux_100m_50m_24m_p)		=3D { "clk_cpll_div10",=20
"clk_cpll_div20",
> > "xin24m" }; +PNAME(mux_100m_24m_lclk0_p)		=3D {=20
"clk_cpll_div10", "xin24m",
> > "lclk_asrc_src_0" }; +PNAME(mux_100m_24m_lclk1_p)		=3D {=20
"clk_cpll_div10",
> > "xin24m", "lclk_asrc_src_1" }; +PNAME(mux_150m_100m_50m_24m_p)	=09
=3D {
> > "clk_gpll_div8", "clk_cpll_div10", "clk_cpll_div20", "xin24m" };
> > +PNAME(mux_200m_100m_50m_24m_p)		=3D { "clk_gpll_div6",=20
"clk_cpll_div10",
> > "clk_cpll_div20", "xin24m" }; +PNAME(mux_400m_200m_100m_24m_p)	=09
=3D {
> > "clk_gpll_div3", "clk_gpll_div6", "clk_cpll_div10", "xin24m" };
> > +PNAME(mux_500m_250m_100m_24m_p)		=3D { "clk_cpll_div2",=20
"clk_cpll_div4",
> > "clk_cpll_div10", "xin24m" }; +PNAME(mux_600m_400m_300m_24m_p)	=09
=3D {
> > "clk_gpll_div2", "clk_gpll_div3", "clk_gpll_div4", "xin24m" };
> > +PNAME(mux_350m_175m_116m_24m_p)		=3D { "clk_spll_div2",=20
"clk_spll_div4",
> > "clk_spll_div6", "xin24m" }; +PNAME(mux_175m_116m_58m_24m_p)	=09
=3D {
> > "clk_spll_div4", "clk_spll_div6", "clk_spll_div12", "xin24m" };
> > +PNAME(mux_116m_58m_24m_p)		=3D { "clk_spll_div6",=20
"clk_spll_div12",
> > "xin24m" }; +PNAME(mclk_sai0_8ch_p)			=3D {=20
"mclk_sai0_8ch_src",
> > "sai0_mclkin", "sai1_mclkin" }; +PNAME(mclk_sai1_8ch_p)		=09
=3D {
> > "mclk_sai1_8ch_src", "sai1_mclkin" }; +PNAME(mclk_sai2_2ch_p)	=09
	=3D {
> > "mclk_sai2_2ch_src", "sai2_mclkin", "sai1_mclkin" };
> > +PNAME(mclk_sai3_2ch_p)			=3D {=20
"mclk_sai3_2ch_src", "sai3_mclkin",
> > "sai1_mclkin" }; +PNAME(mclk_sai4_2ch_p)			=3D {=20
"mclk_sai4_2ch_src",
> > "sai4_mclkin", "sai1_mclkin" }; +PNAME(mclk_sai5_8ch_p)		=09
=3D {
> > "mclk_sai5_8ch_src", "sai1_mclkin" }; +PNAME(mclk_sai6_8ch_p)	=09
	=3D {
> > "mclk_sai6_8ch_src", "sai1_mclkin" }; +PNAME(mclk_sai7_8ch_p)	=09
	=3D {
> > "mclk_sai7_8ch_src", "sai1_mclkin" }; +PNAME(mclk_sai8_8ch_p)	=09
	=3D {
> > "mclk_sai8_8ch_src", "sai1_mclkin" }; +PNAME(mclk_sai9_8ch_p)	=09
	=3D {
> > "mclk_sai9_8ch_src", "sai1_mclkin" }; +PNAME(uart1_p)		=09
	=3D {
> > "clk_uart1_src_top", "xin24m" };
> > +PNAME(pdm0_p)				=3D { "clk_pdm0_src_top",=20
"xin24m" };
> > +PNAME(mclk_pdm0_p)			=3D {=20
"mclk_pdm0_src_top", "xin24m" };
> > +PNAME(clk_gmac1_ptp_ref_src_p)		=3D { "gpll", "cpll",=20
"gmac1_ptp_refclk_in"
> > }; +PNAME(clk_gmac0_ptp_ref_src_p)		=3D { "gpll", "cpll",
> > "gmac0_ptp_refclk_in" }; +PNAME(dclk_ebc_p)			=3D {=20
"gpll", "cpll", "vpll",
> > "aupll", "lpll_dummy", +				=09
    "dclk_ebc_frac", "xin24m" };
> > +PNAME(dclk_vp0_p)			=3D { "dclk_vp0_src",=20
"clk_hdmiphy_pixel0" };
> > +PNAME(dclk_vp1_p)			=3D { "dclk_vp1_src",=20
"clk_hdmiphy_pixel0" };
> > +PNAME(dclk_vp2_p)			=3D { "dclk_vp2_src",=20
"clk_hdmiphy_pixel0" };
> > +PNAME(clk_uart_p)			=3D { "gpll", "cpll", "aupll",=20
"xin24m",
> > "clk_uart_frac_0", +					   =20
"clk_uart_frac_1", "clk_uart_frac_2"};
> > +PNAME(clk_freq_pwm1_p)			=3D { "sai0_mclkin",=20
"sai1_mclkin", "sai2_mclkin",
> > +					    "sai3_mclkin",=20
"sai4_mclkin", "sai_sclkin_freq"};
> > +PNAME(clk_counter_pwm1_p)		=3D { "sai0_mclkin", "sai1_mclkin",
> > "sai2_mclkin", +					   =20
"sai3_mclkin", "sai4_mclkin",
> > "sai_sclkin_counter"};
> > +PNAME(sai_sclkin_freq_p)		=3D { "sai0_sclk_in",=20
"sai1_sclk_in",
> > "sai2_sclk_in", +					   =20
"sai3_sclk_in", "sai4_sclk_in"};
> > +PNAME(clk_ref_pcie0_phy_p)		=3D { "clk_pcie_100m_src",
> > "clk_pcie_100m_nduty_src", +				=09
    "xin24m"};
> > +PNAME(hclk_vi_root_p)			=3D { "clk_gpll_div6",=20
"clk_cpll_div10",
> > +					   =20
"aclk_vi_root_inter", "xin24m"};
> > +PNAME(clk_ref_osc_mphy_p)		=3D { "xin24m", "clk_gpio_mphy_i",
> > "clk_ref_mphy_26m"}; +PNAME(mux_pmu200m_pmu100m_pmu50m_24m_p)	=3D {
> > "clk_200m_pmu_src", "clk_100m_pmu_src", +			=09
	    "clk_50m_pmu_src",
> > "xin24m" };
> > +PNAME(mux_pmu100m_pmu50m_24m_p)		=3D { "clk_100m_pmu_src",
> > "clk_50m_pmu_src", "xin24m" }; +PNAME(mux_pmu100m_24m_32k_p)	=09
=3D {
> > "clk_100m_pmu_src", "xin24m", "xin_osc0_div" };
> > +PNAME(clk_phy_ref_src_p)		=3D { "xin24m",=20
"clk_pmuphy_ref_src" };
> > +PNAME(clk_usbphy_ref_src_p)		=3D { "usbphy0_24m",=20
"usbphy1_24m" };
> > +PNAME(clk_cpll_ref_src_p)		=3D { "xin24m",=20
"clk_usbphy_ref_src" };
> > +PNAME(clk_aupll_ref_src_p)		=3D { "xin24m",=20
"clk_aupll_ref_io" };
> > +
> > +static struct rockchip_pll_clock rk3576_pll_clks[] __initdata =3D {
> > +	[bpll] =3D PLL(pll_rk3588_core, PLL_BPLL, "bpll", mux_pll_p,
> > +		     0, RK3576_PLL_CON(0),
> > +		     RK3576_BPLL_MODE_CON0, 0, 15, 0,=20
rk3576_pll_rates),
> > +	[lpll] =3D PLL(pll_rk3588_core, PLL_LPLL, "lpll", mux_pll_p,
> > +		     0, RK3576_LPLL_CON(16),
> > +		     RK3576_LPLL_MODE_CON0, 0, 15, 0,=20
rk3576_pll_rates),
> > +	[vpll] =3D PLL(pll_rk3588, PLL_VPLL, "vpll", mux_pll_p,
> > +		     0, RK3576_PLL_CON(88),
> > +		     RK3576_MODE_CON0, 4, 15, 0, rk3576_pll_rates),
> > +	[aupll] =3D PLL(pll_rk3588, PLL_AUPLL, "aupll", mux_pll_p,
> > +		     0, RK3576_PLL_CON(96),
> > +		     RK3576_MODE_CON0, 6, 15, 0, rk3576_pll_rates),
> > +	[cpll] =3D PLL(pll_rk3588, PLL_CPLL, "cpll", mux_pll_p,
> > +		     CLK_IGNORE_UNUSED, RK3576_PLL_CON(104),
> > +		     RK3576_MODE_CON0, 8, 15, 0, rk3576_pll_rates),
> > +	[gpll] =3D PLL(pll_rk3588, PLL_GPLL, "gpll", mux_pll_p,
> > +		     CLK_IGNORE_UNUSED, RK3576_PLL_CON(112),
> > +		     RK3576_MODE_CON0, 2, 15, 0, rk3576_pll_rates),
> > +	[ppll] =3D PLL(pll_rk3588_core, PLL_PPLL, "ppll", mux_pll_p,
> > +		     CLK_IGNORE_UNUSED, RK3576_PMU_PLL_CON(128),
> > +		     RK3576_MODE_CON0, 10, 15, 0, rk3576_ppll_rates),
> > +};
> > +
> > +static struct rockchip_clk_branch rk3576_clk_branches[] __initdata =3D=
 {
> > +	/*
...
> > +
> > +	COMPOSITE_FRAC(XIN_OSC0_DIV, "xin_osc0_div", "xin24m",=20
CLK_IS_CRITICAL,
...
> > CLK_IS_CRITICAL,
> > +			RK3576_CLKSEL_CON(0), 5, 1, MFLAGS, 0, 5,=20
DFLAGS,
> > +			RK3576_CLKGATE_CON(0), 0, GFLAGS),
> > +	COMPOSITE(CLK_CPLL_DIV10, "clk_cpll_div10", gpll_cpll_p,
> > CLK_IS_CRITICAL,
> > +			RK3576_CLKSEL_CON(0), 11, 1, MFLAGS, 6, 5,=20
DFLAGS,
> > +			RK3576_CLKGATE_CON(0), 1, GFLAGS),
> > +	COMPOSITE(CLK_GPLL_DIV8, "clk_gpll_div8", gpll_cpll_p,=20
CLK_IS_CRITICAL,
> > +			RK3576_CLKSEL_CON(1), 5, 1, MFLAGS, 0, 5,=20
DFLAGS,
> > +			RK3576_CLKGATE_CON(0), 2, GFLAGS),
> > +	COMPOSITE(CLK_GPLL_DIV6, "clk_gpll_div6", gpll_cpll_p,=20
CLK_IS_CRITICAL,
> > +			RK3576_CLKSEL_CON(1), 11, 1, MFLAGS, 6, 5,=20
DFLAGS,
> > +			RK3576_CLKGATE_CON(0), 3, GFLAGS),
> > +	COMPOSITE(CLK_CPLL_DIV4, "clk_cpll_div4", gpll_cpll_p,=20
CLK_IS_CRITICAL,
> > +			RK3576_CLKSEL_CON(2), 5, 1, MFLAGS, 0, 5,=20
DFLAGS,
> > +			RK3576_CLKGATE_CON(0), 4, GFLAGS),
> > +	COMPOSITE(CLK_GPLL_DIV4, "clk_gpll_div4", gpll_cpll_p,=20
CLK_IS_CRITICAL,
> > +			RK3576_CLKSEL_CON(2), 11, 1, MFLAGS, 6, 5,=20
DFLAGS,
> > +			RK3576_CLKGATE_CON(0), 5, GFLAGS),
> > +	COMPOSITE(CLK_SPLL_DIV2, "clk_spll_div2", gpll_cpll_spll_bpll_p,
> > CLK_IS_CRITICAL, +			RK3576_CLKSEL_CON(3), 5, 2,=20
MFLAGS, 0, 5, DFLAGS,
> > +			RK3576_CLKGATE_CON(0), 6, GFLAGS),
> > +	COMPOSITE(CLK_GPLL_DIV3, "clk_gpll_div3", gpll_cpll_p,=20
CLK_IS_CRITICAL,
> > +			RK3576_CLKSEL_CON(3), 12, 1, MFLAGS, 7, 5,=20
DFLAGS,
> > +			RK3576_CLKGATE_CON(0), 7, GFLAGS),
> > +	COMPOSITE(CLK_CPLL_DIV2, "clk_cpll_div2", gpll_cpll_p,=20
CLK_IS_CRITICAL,
> > +			RK3576_CLKSEL_CON(4), 11, 1, MFLAGS, 6, 5,=20
DFLAGS,
> > +			RK3576_CLKGATE_CON(0), 9, GFLAGS),
> > +	COMPOSITE(CLK_GPLL_DIV2, "clk_gpll_div2", gpll_cpll_p,=20
CLK_IS_CRITICAL,
> > +			RK3576_CLKSEL_CON(5), 5, 1, MFLAGS, 0, 5,=20
DFLAGS,
> > +			RK3576_CLKGATE_CON(0), 10, GFLAGS),
> > +	COMPOSITE(CLK_SPLL_DIV1, "clk_spll_div1",=20
gpll_cpll_spll_bpll_lpll_p,
> > CLK_IS_CRITICAL, +			RK3576_CLKSEL_CON(6), 5, 3,=20
MFLAGS, 0, 5, DFLAGS,
> > +			RK3576_CLKGATE_CON(0), 12, GFLAGS),
> > +	COMPOSITE_NODIV(PCLK_TOP_ROOT, "pclk_top_root",=20
mux_100m_50m_24m_p,
> > CLK_IS_CRITICAL, +			RK3576_CLKSEL_CON(8), 7, 2,=20
MFLAGS,
> > +			RK3576_CLKGATE_CON(1), 1, GFLAGS),
> > +	COMPOSITE(ACLK_TOP, "aclk_top", gpll_cpll_aupll_p,=20
CLK_IS_CRITICAL,
> > +			RK3576_CLKSEL_CON(9), 5, 2, MFLAGS, 0, 5,=20
DFLAGS,
> > +			RK3576_CLKGATE_CON(1), 3, GFLAGS),
> > +	COMPOSITE(ACLK_TOP_MID, "aclk_top_mid", gpll_cpll_p,=20
CLK_IS_CRITICAL,
> > +			RK3576_CLKSEL_CON(10), 5, 1, MFLAGS, 0, 5,=20
DFLAGS,
> > +			RK3576_CLKGATE_CON(1), 6, GFLAGS),
> > +	COMPOSITE(ACLK_SECURE_HIGH, "aclk_secure_high",
> > gpll_spll_aupll_bpll_lpll_p, CLK_IS_CRITICAL, +		=09
...
> > +	COMPOSITE(REFCLKO25M_GMAC0_OUT, "refclko25m_gmac0_out",=20
gpll_cpll_p, 0,
> > +			RK3576_CLKSEL_CON(36), 7, 1, MFLAGS, 0, 7,=20
DFLAGS,
> > +			RK3576_CLKGATE_CON(5), 10, GFLAGS),
> > +	COMPOSITE(REFCLKO25M_GMAC1_OUT, "refclko25m_gmac1_out",=20
gpll_cpll_p, 0,
> > +			RK3576_CLKSEL_CON(36), 15, 1, MFLAGS, 8, 7,=20
DFLAGS,
> > +			RK3576_CLKGATE_CON(5), 11, GFLAGS),
> > +	COMPOSITE(CLK_CIFOUT_OUT, "clk_cifout_out", gpll_cpll_24m_spll_p,=20
0,
> > +			RK3576_CLKSEL_CON(37), 8, 2, MFLAGS, 0, 8,=20
DFLAGS,
> > +			RK3576_CLKGATE_CON(5), 12, GFLAGS),
> > +	GATE(CLK_GMAC0_RMII_CRU, "clk_gmac0_rmii_cru", "clk_cpll_div20",=20
0,
> > +			RK3576_CLKGATE_CON(5), 13, GFLAGS),
> > +	GATE(CLK_GMAC1_RMII_CRU, "clk_gmac1_rmii_cru", "clk_cpll_div20",=20
0,
...
> > +	COMPOSITE(MCLK_PDM0_SRC_TOP, "mclk_pdm0_src_top",=20
audio_frac_int_p, 0,
> > +			RK3576_CLKSEL_CON(41), 7, 3, MFLAGS, 2, 5,=20
DFLAGS,
> > +			RK3576_CLKGATE_CON(6), 8, GFLAGS),
> > +
> > +	/* bus */
> > +	COMPOSITE_NODIV(HCLK_BUS_ROOT, "hclk_bus_root",=20
mux_200m_100m_50m_24m_p,
> > CLK_IS_CRITICAL, +			RK3576_CLKSEL_CON(55), 0, 2,=20
MFLAGS,
> > +			RK3576_CLKGATE_CON(11), 0, GFLAGS),
> > +	COMPOSITE_NODIV(PCLK_BUS_ROOT, "pclk_bus_root",=20
mux_100m_50m_24m_p,
> > CLK_IS_CRITICAL, +			RK3576_CLKSEL_CON(55), 2, 2,=20
MFLAGS,
> > +			RK3576_CLKGATE_CON(11), 1, GFLAGS),
> > +	COMPOSITE(ACLK_BUS_ROOT, "aclk_bus_root", gpll_cpll_p,=20
CLK_IS_CRITICAL,
> > +			RK3576_CLKSEL_CON(55), 9, 1, MFLAGS, 4, 5,=20
DFLAGS,
...
> > +			RK3576_CLKSEL_CON(56), 5, 2, MFLAGS, 0, 5,=20
DFLAGS,
...
> > +			RK3576_CLKSEL_CON(56), 12, 2, MFLAGS, 7, 5,=20
DFLAGS,
...
> > +			RK3576_CLKSEL_CON(58), 12, 1, MFLAGS, 4, 8,=20
DFLAGS,
...
> > +	COMPOSITE_NODIV(CLK_TIMER0_ROOT, "clk_timer0_root",=20
mux_100m_24m_p, 0,
...
> > +			RK3576_CLKSEL_CON(72), 5, 1, MFLAGS, 0, 5,=20
DFLAGS,
> > +			RK3576_CLKGATE_CON(18), 9, GFLAGS),
> > +	COMPOSITE_NODIV(CLK_TIMER1_ROOT, "clk_timer1_root",=20
mux_100m_24m_p, 0,
...
> > +
> > +	/* cci */
> > +	COMPOSITE(PCLK_CCI_ROOT, "pclk_cci_root",=20
mux_24m_ccipvtpll_gpll_lpll_p,
> > CLK_IS_CRITICAL, +			RK3576_CCI_CLKSEL_CON(4), 5, 2,=20
MFLAGS, 0, 5,
> > DFLAGS,
> > +			RK3576_CCI_CLKGATE_CON(1), 10, GFLAGS),
> > +	COMPOSITE(ACLK_CCI_ROOT, "aclk_cci_root",=20
mux_24m_ccipvtpll_gpll_lpll_p,
> > CLK_IS_CRITICAL, +			RK3576_CCI_CLKSEL_CON(4), 12,=20
2, MFLAGS, 7, 5,
> > DFLAGS,
...
> > gpll_cpll_spll_aupll_bpll_p, CLK_IS_CRITICAL, +		=09
...
> > mux_500m_250m_100m_24m_p, CLK_IS_CRITICAL, +		=09
...
> > +	GATE(ACLK_DDR_SHAREMEM, "aclk_ddr_sharemem",=20
"aclk_center_low_root",
> > CLK_IGNORE_UNUSED, +			RK3576_CLKGATE_CON(72),=20
6, GFLAGS),
...
> > +	COMPOSITE_NODIV(PCLK_GPU_ROOT, "pclk_gpu_root",=20
...
> > mux_200m_100m_50m_24m_p, 0, +			RK3576_CLKSEL_CON(86),=20
0, 2, MFLAGS,
> > +			RK3576_CLKGATE_CON(31), 4, GFLAGS),
> > +	COMPOSITE(CLK_RKNN_DSU0, "clk_rknn_dsu0", gpll_cpll_aupll_spll_p,=20
0,
> > +			RK3576_CLKSEL_CON(86), 7, 2, MFLAGS, 2, 5,=20
DFLAGS,
...
> > +	GATE(FCLK_NPU_CM0_CORE, "fclk_npu_cm0_core", "hclk_npu_cm0_root",=20
0,
> > +			RK3576_CLKGATE_CON(32), 7, GFLAGS),
> > +	COMPOSITE(CLK_NPU_CM0_RTC, "clk_npu_cm0_rtc", mux_24m_32k_p, 0,
> > +			RK3576_CLKSEL_CON(87), 10, 1, MFLAGS, 5, 5,=20
DFLAGS,
...
> > +
> > +	/* nvm */
> > +	COMPOSITE_NODIV(HCLK_NVM_ROOT, "hclk_nvm_root",=20
mux_200m_100m_50m_24m_p,
> > CLK_IS_CRITICAL, +			RK3576_CLKSEL_CON(88), 0, 2,=20
MFLAGS,
> > +			RK3576_CLKGATE_CON(33), 0, GFLAGS),
> > +	COMPOSITE(ACLK_NVM_ROOT, "aclk_nvm_root", gpll_cpll_p,=20
CLK_IS_CRITICAL,
> > +			RK3576_CLKSEL_CON(88), 7, 1, MFLAGS, 2, 5,=20
DFLAGS,
> > +			RK3576_CLKGATE_CON(33), 1, GFLAGS),
> > +	COMPOSITE(SCLK_FSPI_X2, "sclk_fspi_x2", gpll_cpll_24m_p, 0,
> > +			RK3576_CLKSEL_CON(89), 6, 2, MFLAGS, 0, 6,=20
DFLAGS,
...
> > +			RK3576_CLKSEL_CON(89), 14, 2, MFLAGS, 8, 6,=20
DFLAGS,
...
> > +	COMPOSITE_NODIV(BCLK_EMMC, "bclk_emmc", mux_200m_100m_50m_24m_p,=20
0,
...
> > +			RK3576_CLKSEL_CON(115), 5, 1, MFLAGS, 0, 5,=20
DFLAGS,
> > +			RK3576_CLKGATE_CON(47), 0, GFLAGS),
> > +	COMPOSITE(ACLK_USB_ROOT, "aclk_usb_root", gpll_cpll_p,=20
CLK_IS_CRITICAL,
> > +			RK3576_CLKSEL_CON(115), 11, 1, MFLAGS, 6, 5,=20
DFLAGS,
> > +			RK3576_CLKGATE_CON(47), 1, GFLAGS),
> > +	COMPOSITE_NODIV(PCLK_USB_ROOT, "pclk_usb_root",=20
mux_100m_50m_24m_p,
> > CLK_IS_CRITICAL, +			RK3576_CLKSEL_CON(115), 12, 2,=20
MFLAGS,
...
> > mux_200m_100m_50m_24m_p, 0, +			RK3576_CLKSEL_CON(110),=20
0, 2, MFLAGS,
> > +			RK3576_CLKGATE_CON(45), 0, GFLAGS),
> > +	COMPOSITE(ACLK_RKVDEC_ROOT, "aclk_rkvdec_root",=20
gpll_cpll_aupll_spll_p,
> > 0, +			RK3576_CLKSEL_CON(110), 7, 2, MFLAGS, 2, 5,=20
DFLAGS,
> > +			RK3576_CLKGATE_CON(45), 1, GFLAGS),
> > +	COMPOSITE(ACLK_RKVDEC_ROOT_BAK, "aclk_rkvdec_root_bak",
> > cpll_vpll_lpll_bpll_p, 0, +		=09
...
> > mux_200m_100m_50m_24m_p, 0, +			RK3576_CLKSEL_CON(124),=20
0, 2, MFLAGS,
> > +			RK3576_CLKGATE_CON(51), 0, GFLAGS),
> > +	COMPOSITE(ACLK_VEPU0_ROOT, "aclk_vepu0_root", gpll_cpll_p, 0,
> > +			RK3576_CLKSEL_CON(124), 7, 1, MFLAGS, 2, 5,=20
DFLAGS,
> > +			RK3576_CLKGATE_CON(51), 1, GFLAGS),
> > +	COMPOSITE(CLK_VEPU0_CORE, "clk_vepu0_core",=20
gpll_cpll_spll_lpll_bpll_p,
> > 0, +			RK3576_CLKSEL_CON(124), 13, 3, MFLAGS, 8,=20
5, DFLAGS,
...
> > +	COMPOSITE(CLK_ISP_CORE, "clk_isp_core",=20
gpll_spll_isppvtpll_bpll_lpll_p,
> > 0, +			RK3576_CLKSEL_CON(129), 11, 3, MFLAGS, 6,=20
5, DFLAGS,
> > +			RK3576_CLKGATE_CON(53), 9, GFLAGS),
> > +	GATE(CLK_ISP_CORE_MARVIN, "clk_isp_core_marvin", "clk_isp_core",=20
0,
...
> > +	COMPOSITE(ACLK_VOP_ROOT, "aclk_vop_root",=20
gpll_cpll_aupll_spll_lpll_p,
> > CLK_IS_CRITICAL, +			RK3576_CLKSEL_CON(144), 5, 3,=20
MFLAGS, 0, 5, DFLAGS,
> > +			RK3576_CLKGATE_CON(61), 0, GFLAGS),
> > +	COMPOSITE_NODIV(HCLK_VOP_ROOT, "hclk_vop_root",=20
mux_200m_100m_50m_24m_p,
> > CLK_IS_CRITICAL, +			RK3576_CLKSEL_CON(144), 10, 2,=20
MFLAGS,
> > +			RK3576_CLKGATE_CON(61), 2, GFLAGS),
> > +	COMPOSITE_NODIV(PCLK_VOP_ROOT, "pclk_vop_root",=20
mux_100m_50m_24m_p, 0,
...
> > +
> > +	/* vo0 */
> > +	COMPOSITE(ACLK_VO0_ROOT, "aclk_vo0_root", gpll_cpll_lpll_bpll_p,=20
0,
> > +			RK3576_CLKSEL_CON(149), 5, 2, MFLAGS, 0, 5,=20
DFLAGS,
> > +			RK3576_CLKGATE_CON(63), 0, GFLAGS),
> > +	COMPOSITE_NODIV(HCLK_VO0_ROOT, "hclk_vo0_root",=20
mux_200m_100m_50m_24m_p,
> > CLK_IS_CRITICAL, +			RK3576_CLKSEL_CON(149), 7, 2,=20
MFLAGS,
> > +			RK3576_CLKGATE_CON(63), 1, GFLAGS),
> > +	COMPOSITE_NODIV(PCLK_VO0_ROOT, "pclk_vo0_root",=20
...
> > +	COMPOSITE(CLK_DSIHOST0, "clk_dsihost0",=20
gpll_cpll_spll_vpll_bpll_lpll_p,
> > 0, +			RK3576_CLKSEL_CON(151), 7, 3, MFLAGS, 0, 7,=20
DFLAGS,
...
> > +			RK3576_CLKSEL_CON(151), 15, 1, MFLAGS, 10,=20
5, DFLAGS,
...
> > +	COMPOSITE_NODIV(CLK_EDP0_200M, "clk_edp0_200m",=20
mux_200m_100m_50m_24m_p,
> > 0, +			RK3576_CLKSEL_CON(152), 1, 2, MFLAGS,
> > +			RK3576_CLKGATE_CON(64), 15, GFLAGS),
> > +	COMPOSITE(MCLK_SAI5_8CH_SRC, "mclk_sai5_8ch_src",=20
audio_frac_int_p, 0,
> > +			RK3576_CLKSEL_CON(154), 10, 3, MFLAGS, 2, 8,=20
DFLAGS,
> > +			RK3576_CLKGATE_CON(65), 3, GFLAGS),
> > +	COMPOSITE_NODIV(MCLK_SAI5_8CH, "mclk_sai5_8ch", mclk_sai5_8ch_p,
> > CLK_SET_RATE_PARENT, +		=09
...
> > +	COMPOSITE(MCLK_SAI6_8CH_SRC, "mclk_sai6_8ch_src",=20
audio_frac_int_p, 0,
> > +			RK3576_CLKSEL_CON(155), 8, 3, MFLAGS, 0, 8,=20
DFLAGS,
...
> > +			RK3576_CLKSEL_CON(156), 5, 3, MFLAGS, 0, 5,=20
DFLAGS,
...
> > +			RK3576_CLKSEL_CON(156), 13, 2, MFLAGS, 8, 5,=20
DFLAGS,
> > +			RK3576_CLKGATE_CON(65), 15, GFLAGS),
> > +
> > +	/* vo1 */
> > +	COMPOSITE(ACLK_VO1_ROOT, "aclk_vo1_root", gpll_cpll_lpll_bpll_p,=20
0,
> > +			RK3576_CLKSEL_CON(158), 5, 2, MFLAGS, 0, 5,=20
DFLAGS,
> > +			RK3576_CLKGATE_CON(67), 1, GFLAGS),
> > +	COMPOSITE_NODIV(HCLK_VO1_ROOT, "hclk_vo1_root",=20
mux_200m_100m_50m_24m_p,
> > CLK_IS_CRITICAL, +			RK3576_CLKSEL_CON(158), 7, 2,=20
MFLAGS,
> > +			RK3576_CLKGATE_CON(67), 2, GFLAGS),
> > +	COMPOSITE_NODIV(PCLK_VO1_ROOT, "pclk_vo1_root",=20
mux_100m_50m_24m_p, 0,
> > +			RK3576_CLKSEL_CON(158), 9, 2, MFLAGS,
> > +			RK3576_CLKGATE_CON(67), 3, GFLAGS),
> > +	COMPOSITE(MCLK_SAI8_8CH_SRC, "mclk_sai8_8ch_src",=20
audio_frac_int_p, 0,
> > +			RK3576_CLKSEL_CON(157), 8, 3, MFLAGS, 0, 8,=20
DFLAGS,
...
> > +	COMPOSITE(MCLK_SAI7_8CH_SRC, "mclk_sai7_8ch_src",=20
audio_frac_int_p, 0,
> > +			RK3576_CLKSEL_CON(159), 8, 3, MFLAGS, 0, 8,=20
DFLAGS,
...
> > +			RK3576_CLKSEL_CON(160), 8, 3, MFLAGS, 0, 8,=20
DFLAGS,
...
> > +	COMPOSITE(MCLK_SAI9_8CH_SRC, "mclk_sai9_8ch_src",=20
audio_frac_int_p, 0,
> > +			RK3576_CLKSEL_CON(162), 8, 3, MFLAGS, 0, 8,=20
DFLAGS,
...
> > gpll_spll_cpll_bpll_lpll_p, 0, +		=09
...
> > +			RK3576_CLKSEL_CON(120), 13, 1, MFLAGS, 8, 5,=20
DFLAGS,
...
> > +	COMPOSITE(DCLK_EBC, "dclk_ebc", dclk_ebc_p,=20
CLK_SET_RATE_NO_REPARENT,
> > +			RK3576_CLKSEL_CON(123), 12, 3, MFLAGS, 3, 9,=20
DFLAGS,
> > +			RK3576_CLKGATE_CON(50), 12, GFLAGS),
> > +
> > +	/* vepu */
> > +	COMPOSITE_NODIV(HCLK_VEPU1_ROOT, "hclk_vepu1_root",
> > mux_200m_100m_50m_24m_p, 0, +			RK3576_CLKSEL_CON(178),=20
0, 2, MFLAGS,
> > +			RK3576_CLKGATE_CON(78), 0, GFLAGS),
> > +	COMPOSITE(ACLK_VEPU1_ROOT, "aclk_vepu1_root", gpll_cpll_p, 0,
> > +			RK3576_CLKSEL_CON(180), 5, 1, MFLAGS, 0, 5,=20
DFLAGS,
...
> > +	COMPOSITE(CLK_VEPU1_CORE, "clk_vepu1_core",=20
gpll_cpll_spll_lpll_bpll_p,
> > 0, +			RK3576_CLKSEL_CON(180), 11, 3, MFLAGS, 6,=20
5, DFLAGS,
> > +			RK3576_CLKGATE_CON(79), 5, GFLAGS),
> > +
> > +	/* php */
> > +	COMPOSITE_NODIV(PCLK_PHP_ROOT, "pclk_php_root",=20
mux_100m_50m_24m_p, 0,
> > +			RK3576_CLKSEL_CON(92), 0, 2, MFLAGS,
> > +			RK3576_CLKGATE_CON(34), 0, GFLAGS),
> > +	COMPOSITE(ACLK_PHP_ROOT, "aclk_php_root", gpll_cpll_p, 0,
> > +			RK3576_CLKSEL_CON(92), 9, 1, MFLAGS, 4, 5,=20
DFLAGS,
...
> > +			RK3576_CLKSEL_CON(93), 7, 1, MFLAGS, 0, 7,=20
DFLAGS,
> > +			RK3576_CLKGATE_CON(37), 0, GFLAGS),
> > +	COMPOSITE(CLK_RXOOB1, "clk_rxoob1", gpll_cpll_p, 0,
> > +			RK3576_CLKSEL_CON(93), 15, 1, MFLAGS, 8, 7,=20
DFLAGS,
...
> > mux_200m_100m_50m_24m_p, 0, +			RK3576_CLKSEL_CON(42),=20
0, 2, MFLAGS,
...
> > +			RK3576_CLKSEL_CON(45), 5, 2, MFLAGS, 0, 5,=20
DFLAGS,
...
> > +			RK3576_CLKSEL_CON(45), 12, 2, MFLAGS, 7, 5,=20
DFLAGS,
> > +			RK3576_CLKGATE_CON(8), 1, GFLAGS),
> > +	COMPOSITE(MCLK_SAI1_8CH_SRC, "mclk_sai1_8ch_src",=20
audio_frac_int_p, 0,
> > +			RK3576_CLKSEL_CON(46), 8, 3, MFLAGS, 0, 8,=20
DFLAGS,
...
> > +	COMPOSITE(MCLK_SAI2_2CH_SRC, "mclk_sai2_2ch_src",=20
audio_frac_int_p, 0,
> > +			RK3576_CLKSEL_CON(47), 8, 3, MFLAGS, 0, 8,=20
DFLAGS,
...
> > +	COMPOSITE(MCLK_SAI3_2CH_SRC, "mclk_sai3_2ch_src",=20
audio_frac_int_p, 0,
> > +			RK3576_CLKSEL_CON(48), 8, 3, MFLAGS, 0, 8,=20
DFLAGS,
...
> > +	COMPOSITE(MCLK_SAI4_2CH_SRC, "mclk_sai4_2ch_src",=20
audio_frac_int_p, 0,
> > +			RK3576_CLKSEL_CON(49), 8, 3, MFLAGS, 0, 8,=20
DFLAGS,
...
> > +			RK3576_CLKSEL_CON(50), 9, 3, MFLAGS, 0, 9,=20
DFLAGS,
...
> > +			RK3576_CLKSEL_CON(51), 5, 3, MFLAGS, 0, 5,=20
DFLAGS,
...
> > +			RK3576_CLKSEL_CON(52), 8, 3, MFLAGS, 0, 8,=20
DFLAGS,
...
> > +			RK3576_CLKSEL_CON(53), 8, 3, MFLAGS, 0, 8,=20
DFLAGS,
...
> > +			RK3576_CLKSEL_CON(104), 6, 2, MFLAGS, 0, 6,=20
DFLAGS,
...
> > +			RK3576_CLKSEL_CON(106), 6, 2, MFLAGS, 0, 6,=20
DFLAGS,
...
> > CLK_IS_CRITICAL,
> > +			RK3576_CLKSEL_CON(106), 13, 1, MFLAGS, 8, 5,=20
DFLAGS,
...
> > +			RK3576_CLKSEL_CON(107), 5, 1, MFLAGS, 0, 5,=20
DFLAGS,
...
> > CLK_IS_CRITICAL, +			RK3576_PHP_CLKGATE_CON(0), 2,=20
GFLAGS),
> > +	GATE(PCLK_PCIE2_COMBOPHY0, "pclk_pcie2_combophy0",=20
"pclk_phpphy_root",
> > 0,
> > +			RK3576_PHP_CLKGATE_CON(0), 5, GFLAGS),
> > +	GATE(PCLK_PCIE2_COMBOPHY1, "pclk_pcie2_combophy1",=20
"pclk_phpphy_root",
> > 0,
...
> > CLK_IS_CRITICAL, +			RK3576_PHP_CLKSEL_CON(1), 0, 8,=20
DFLAGS,
...
> > +	FACTOR_GATE(CLK_50M_PMU_SRC, "clk_50m_pmu_src",=20
"clk_100m_pmu_src", 0,
...
> > CLK_IS_CRITICAL, +			RK3576_PMU_CLKGATE_CON(5), 0,=20
GFLAGS),
...
> > +	COMPOSITE_NOMUX(CLK_PMUPHY_REF_SRC, "clk_pmuphy_ref_src", "cpll",=20
0,
...
> > "xin24m", 0, +			RK3576_PMU_CLKGATE_CON(0), 15,=20
GFLAGS),
...
> > +	GATE(CLK_REF_UFS_CLKOUT, "clk_ref_ufs_clkout", "clk_ref_osc_mphy",=20
0,
> > +			RK3576_PMU_CLKGATE_CON(2), 5, GFLAGS),
> > +	GATE(FCLK_PMU_CM0_CORE, "fclk_pmu_cm0_core", "hclk_pmu_cm0_root",=20
0,
> > +			RK3576_PMU_CLKGATE_CON(3), 12, GFLAGS),
> > +	COMPOSITE(CLK_PMU_CM0_RTC, "clk_pmu_cm0_rtc", mux_24m_32k_p, 0,
> > +			RK3576_PMU_CLKSEL_CON(4), 14, 1, MFLAGS, 9,=20
5, DFLAGS,
...
> > +	COMPOSITE_NODIV(CLK_PMU1PWM, "clk_pmu1pwm",=20
...
> > +	COMPOSITE_NODIV(CLK_I2C0, "clk_i2c0",=20
...
> > CLK_IS_CRITICAL, +			RK3576_PMU_CLKSEL_CON(11), 6,=20
1, MFLAGS, 1, 5,
> > DFLAGS,
...
> > +	MUXGRF(CLK_USBPHY_REF_SRC, "clk_usbphy_ref_src",=20
clk_usbphy_ref_src_p,=20
> > 0, +			RK3576_PMU0_GRF_OSC_CON6, 2, 1, MFLAGS),
> > +	MUXGRF(CLK_CPLL_REF_SRC, "clk_cpll_ref_src", clk_cpll_ref_src_p, =20
0,
> > +			RK3576_PMU0_GRF_OSC_CON6, 1, 1, MFLAGS),
> > +	MUXGRF(CLK_AUPLL_REF_SRC, "clk_aupll_ref_src",=20
...
> > +			RK3576_SECURE_NS_CLKSEL_CON(0), 0, 2,=20
MFLAGS,
...
> > +			RK3576_SECURE_NS_CLKSEL_CON(0), 2, 2,=20
MFLAGS,
> > +			RK3576_SECURE_NS_CLKGATE_CON(0), 1, GFLAGS),
> > +	COMPOSITE_NODIV(PCLK_SECURE_NS, "pclk_secure_ns",=20
mux_116m_58m_24m_p,
> > CLK_IS_CRITICAL, +			RK3576_SECURE_NS_CLKSEL_CON(0),=20
4, 2, MFLAGS,
...
> > +	GATE(CLK_PKA_CRYPTO_NS, "clk_pka_crypto_ns", "clk_pka_crypto_s",=20
0,
> > +			RK3576_NON_SECURE_GATING_CON00, 1, GFLAGS),
> > +
> > +	/* io */
> > +	GATE(CLK_VICAP_I0CLK, "clk_vicap_i0clk", "clk_csihost0_clkdata_i",=20
0,
> > +			RK3576_CLKGATE_CON(59), 1, GFLAGS),
> > +	GATE(CLK_VICAP_I1CLK, "clk_vicap_i1clk", "clk_csihost1_clkdata_i",=20
0,
> > +			RK3576_CLKGATE_CON(59), 2, GFLAGS),
> > +	GATE(CLK_VICAP_I2CLK, "clk_vicap_i2clk", "clk_csihost2_clkdata_i",=20
0,
> > +			RK3576_CLKGATE_CON(59), 3, GFLAGS),
> > +	GATE(CLK_VICAP_I3CLK, "clk_vicap_i3clk", "clk_csihost3_clkdata_i",=20
0,
> > +			RK3576_CLKGATE_CON(59), 4, GFLAGS),
> > +	GATE(CLK_VICAP_I4CLK, "clk_vicap_i4clk", "clk_csihost4_clkdata_i",=20
0,
...
> > +
> > +	clk_nr_clks =3D rockchip_clk_find_max_clk_id(rk3576_clk_branches,
> > +				=09
...
> > +};
> > +
> > +static const struct clk_rk3576_inits clk_rk3576_cru_init =3D {
> > +	.inits =3D rk3576_clk_init,
> > +};
> > +
> > +static const struct of_device_id clk_rk3576_match_table[] =3D {
> > +	{
> > +		.compatible =3D "rockchip,rk3576-cru",
> > +		.data =3D &clk_rk3576_cru_init,
> > +	},
> > +	{ }
> > +};
...
> > +
> > +	match =3D of_match_device(clk_rk3576_match_table, &pdev->dev);
> > +	if (!match || !match->data)
> > +		return -EINVAL;
> > +
...
> > +}
> > +
> > +static struct platform_driver clk_rk3576_driver =3D {
> > +	.probe		=3D clk_rk3576_probe,
> > +	.driver		=3D {
> > +		.name	=3D "clk-rk3576",
> > +		.of_match_table =3D clk_rk3576_match_table,
...
> > +#define RK3576_BPLL_MODE_CON0		(RK3576_BIGCORE_CRU_BASE=20
+ 0x280)
> > +#define RK3576_LPLL_MODE_CON0		(RK3576_LITCORE_CRU_BASE=20
+ 0x280)
> > +#define RK3576_PPLL_MODE_CON0		(RK3576_PHP_CRU_BASE +=20
0x280)
...
> > +
> > +#define RK3576_PHP_CLKSEL_CON(x)	((x) * 0x4 + RK3576_PHP_CRU_BASE=20
+
> > 0x300)
...
> > RK3576_SECURE_NS_CLKGATE_CON(x)	((x) * 0x4 +=20
RK3576_SECURE_NS_CRU_BASE +
> > 0x800) +#define RK3576_SECURE_NS_SOFTRST_CON(x)	((x) * 0x4 +
> > RK3576_SECURE_NS_CRU_BASE + 0xa00) +
> > +#define RK3576_CCI_CLKSEL_CON(x)	((x) * 0x4 + RK3576_CCI_CRU_BASE=20
+
> > 0x300)
> > +#define RK3576_CCI_CLKGATE_CON(x)	((x) * 0x4 + RK3576_CCI_CRU_BASE=20
+
> > 0x800) +#define RK3576_CCI_SOFTRST_CON(x)	((x) * 0x4 +
> > RK3576_CCI_CRU_BASE + 0xa00) +
> > +#define RK3576_BPLL_CON(x)		((x) * 0x4 +=20
RK3576_BIGCORE_CRU_BASE)
> > +#define RK3576_BIGCORE_CLKSEL_CON(x)	((x) * 0x4 +=20
RK3576_BIGCORE_CRU_BASE
...
> > 0xa00) +#define RK3576_LPLL_CON(x)		((x) * 0x4 +=20
RK3576_CCI_CRU_BASE)
> > +#define RK3576_LITCORE_CLKSEL_CON(x)	((x) * 0x4 +=20
...
> >=20
> > @@ -1025,6 +1077,7 @@ static inline void rockchip_register_softrst(stru=
ct
> > device_node *np,>=20
> >   	return rockchip_register_softrst_lut(np, NULL, num_regs, base,=20
flags);
> >  =20
> >   }
> >=20
...
> > +
> > +/* 0x27200000 + 0x0A00 */
> > +#define RK3576_CRU_RESET_OFFSET(id, reg, bit) [id] =3D (0 + reg * 16 +=
 bit)
> > +
> > +/* mapping table for reset ID to register offset */
> > +static const int rk3576_register_offset[] =3D {
> > +	/* SOFTRST_CON01 */
