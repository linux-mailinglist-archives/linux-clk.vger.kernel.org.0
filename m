...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id B29C177980F
	for <lists+linux-clk@lfdr.de>; Fri, 11 Aug 2023 22:04:05 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234845AbjHKUEF (ORCPT <rfc822;lists+linux-clk@lfdr.de>);
        Fri, 11 Aug 2023 16:04:05 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:42580 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233523AbjHKUEE (ORCPT
        <rfc822;linux-clk@vger.kernel.org>); Fri, 11 Aug 2023 16:04:04 -0400
Received: from out-98.mta1.migadu.com (out-98.mta1.migadu.com [95.215.58.98])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 766B830E8
        for <linux-clk@vger.kernel.org>; Fri, 11 Aug 2023 13:03:59 -0700 (PDT)
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linux.dev; s=key1;
        ...
        bh=pDbhZVIiUHawx3wWagLipylwX59GPH/PMt/u9VxD9Fg=;
        b=qP9s4NHjojkpcrEBNFD7lOw2xGfF/9XPUPjGpGCi3LPS2kzh83QhCjSiGPiC/Hm+YzJqlk
        oJaPwK5D06ZOrGKBfaVgXn7kFlELrYMJHyvuqfJMwhQkvQPvxvHjT636sF70zYNf1q0C2k
        Ma6s8jLhblaBMQXCDIQcMsBxgfinqh8=
...
Subject: [PATCH net-next v4 7/9] ice: implement dpll interface to control cgu
Date:   Fri, 11 Aug 2023 21:03:38 +0100
Message-Id: <20230811200340.577359-8-vadim.fedorenko@linux.dev>
...
index 5ecca47c9512..ca8c0d8edcd4 100644
...
index 000000000000..5e4ce6afef55
--- /dev/null
...
index 0f04347eda39..c746da366a7b 100644
--- a/drivers/net/ethernet/intel/ice/ice_main.c
+++ b/drivers/net/ethernet/intel/ice/ice_main.c
@@ -4664,6 +4664,10 @@ static void ice_init_features(struct ice_pf *pf)
