Return-Path: <linux-clk+bounces-32018-lists+linux-clk=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-clk@lfdr.de
Delivered-To: lists+linux-clk@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id 2F1ABCDE9CE
	for <lists+linux-clk@lfdr.de>; Fri, 26 Dec 2025 12:05:25 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id CC001300A1F4
	for <lists+linux-clk@lfdr.de>; Fri, 26 Dec 2025 11:03:31 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 00969317712;
	Fri, 26 Dec 2025 11:03:31 +0000 (UTC)
X-Original-To: linux-clk@vger.kernel.org
Received: from smtp.gentoo.org (woodpecker.gentoo.org [140.211.166.183])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id AA7DE2874E6;
	Fri, 26 Dec 2025 11:03:25 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=140.211.166.183
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1766747010; cv=none; b=eof4QaBUoMhDi48xEBLXC7SqdB5GQMqzcSwDhYUQeClvYyyD+bqasPF8p8o44FZWGPJdoMGVrPf0lTrTRVbyTsryiPXla4EQn1SNqDu75NDCKmfXr1HyZyK2uyCSXMkNfx4QLixGtV8SnHHXSIAGRuU18MdE+8QTL8weis3ifKA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1766747010; c=relaxed/simple;
	bh=d8TdwPytsJZLkx/34RQK9MYaSaJSyTf0NMZybA+gDNs=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=BCDRcwU6esUwHGUzMp5PvwRjz3z/pUrorMROEP/hHtGT1+vf2v8StxoAwufmp4IZFO7dagGhR6hso3PSPamzXK2aBnOMsrA9tlFNohXUNoamXWawjjSVes9qWl9B5pexq7BNaMGTs+p4rNmEykzvRLEpCLReOMntJoo1LXXmg30=
...
Received: from [127.0.0.1] (unknown [116.232.18.222])
	...
	by smtp.gentoo.org (Postfix) with ESMTPSA id A6D22341F5F;
	Fri, 26 Dec 2025 11:03:17 +0000 (UTC)
From: Yixun Lan <dlan@gentoo.org>
Date: Fri, 26 Dec 2025 19:01:20 +0800
Subject: [PATCH v3 5/5] clk: spacemit: k3: add the clock tree
Precedence: bulk
...
Message-Id: <20251226-k3-clk-v3-5-602ce93bb6c3@gentoo.org>
...
X-Mailer: b4 0.14.3
X-Developer-Signature: v=1; a=openpgp-sha256; l=72560; i=dlan@gentoo.org;
 h=from:subject:message-id; bh=d8TdwPytsJZLkx/34RQK9MYaSaJSyTf0NMZybA+gDNs=;
 b=
...
index 000000000000..380447c69b64
--- /dev/null
