Return-Path: <linux-clk+bounces-11350-lists+linux-clk=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-clk@lfdr.de
Delivered-To: lists+linux-clk@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 5B30F962CAA
	for <lists+linux-clk@lfdr.de>; Wed, 28 Aug 2024 17:43:41 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 6346D1C20DC3
	for <lists+linux-clk@lfdr.de>; Wed, 28 Aug 2024 15:43:40 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id EC6CE1A4B73;
	Wed, 28 Aug 2024 15:43:02 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=collabora.com header.i=@collabora.com header.b="ackZ21Xh";
	dkim=pass (1024-bit key) header.d=amazonses.com header.i=@amazonses.com header.b="NQ2fgko0"
...
Received: from a7-48.smtp-out.eu-west-1.amazonses.com (a7-48.smtp-out.eu-west-1.amazonses.com [54.240.7.48])
	...
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A60C01A38F3;
	Wed, 28 Aug 2024 15:42:56 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=54.240.7.48
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1724859782; cv=none; b=l4A/BcPjGVmShCBpeKbLE17SyAGdHAe48fWb6Lq8jYcZqWsIr13ZbklCZP0L9qCLk88yvHN9gsMRnFc5oLc9+o5QJtYvxR75H9vYuK2fVFl8SPcNU2iNjdYhV7a+eabS9f0e7waWUn1CR9vbo4IsyJ7vmull5XtMAOeslNpJFAc=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1724859782; c=relaxed/simple;
	bh=CTt+rzA9Mxs0SMKng9vyWYo8DC3LLCEvNVtdhLwNbX8=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=pnGuYezh2SRqyh/vLOybcITnuA6JaZFs7U7x+h/mdQL6SUL4gtzt7TtssTpdO2N0hZXiL1Xi62b1zYg6vtXUgwkzt9HLyFAP/c5Aq+jsGv/bgaYXUswfY6X96xeYOktYDgVU61Y/zgTS6y79cw4l/wet+msbP8JgWn9sATnMRio=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=collabora.com; spf=pass smtp.mailfrom=amazonses.collabora.com; dkim=pass (2048-bit key) header.d=collabora.com header.i=@collabora.com header.b=ackZ21Xh; dkim=pass (1024-bit key) header.d=amazonses.com header.i=@amazonses.com header.b=NQ2fgko0; arc=none smtp.client-ip=54.240.7.48
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=collabora.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=amazonses.collabora.com
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/simple;
	s=4232tfv5ebdrjdwkr5zzm7kytdkokgug; d=collabora.com; t=1724859775;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:MIME-Version:Content-Transfer-Encoding;
	bh=CTt+rzA9Mxs0SMKng9vyWYo8DC3LLCEvNVtdhLwNbX8=;
	b=
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/simple;
	s=uku4taia5b5tsbglxyj6zym32efj7xqv; d=amazonses.com; t=1724859775;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:MIME-Version:Content-Transfer-Encoding:Feedback-ID;
	bh=CTt+rzA9Mxs0SMKng9vyWYo8DC3LLCEvNVtdhLwNbX8=;
	b=NQ2fgko0FJcoQUuaiwa3j2xGZ0KYiPJpwt20Ehal8HGpzBTXAFBoTghw8igfr4wH
	cJ+UsWxrAhqJv7vNgQ/Fjn7ZcmpcbIAEZS2eIGAF0EH4xC4e+Kz2o0OPU17JTV1cPGB
	o5dNx8naGs8wHLeagMvcZUfCmKTxMZAO3/n8yJNg=
...
Subject: [PATCH v7 3/3] clk: rockchip: Add clock controller for the RK3576
Date: Wed, 28 Aug 2024 15:42:55 +0000
Message-ID: <0102019199a7781a-888440f0-a3f7-4a7d-a831-491260cbdfe7-000000@eu-west-1.amazonses.com>
...
index 000000000000..460908edaeda
--- /dev/null
...
new file mode 100644
index 000000000000..91c48ffd5675
--- /dev/null
