...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 47AF14392DD
	for <lists+linux-clk@lfdr.de>; Mon, 25 Oct 2021 11:43:25 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232852AbhJYJpU (ORCPT <rfc822;lists+linux-clk@lfdr.de>);
        Mon, 25 Oct 2021 05:45:20 -0400
Received: from us-smtp-delivery-124.mimecast.com ([216.205.24.124]:59530 "EHLO
        us-smtp-delivery-124.mimecast.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S232911AbhJYJov (ORCPT
        <rfc822;linux-clk@vger.kernel.org>); Mon, 25 Oct 2021 05:44:51 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1635154949;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=y7lo8F/cKcpcF6HeeS7xHuXEu0IHOZoSKuFyDyjNHxs=;
        b=A2D/Ar8HuwJSaPXn0JKSHD0m88JzdoRqEvKrYfqjUSq/wdgzV6gyvW+w9MyKmyUSNmYXEn
        ARwYvc0ij9T19QTAj55w80C1Ur2i4/gyIZV5okiwRjSQpZsDexH+0GFf9UOl/AKYG7J3lV
        B7wOTaBhz8W0XIntC1m/BQcZGdeuGSM=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-453-0myt9NJkOhuWH0QX6Uma1w-1; Mon, 25 Oct 2021 05:42:25 -0400
X-MC-Unique: 0myt9NJkOhuWH0QX6Uma1w-1
Received: from smtp.corp.redhat.com (int-mx02.intmail.prod.int.phx2.redhat.com [10.5.11.12])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id 333D9657;
        Mon, 25 Oct 2021 09:42:23 +0000 (UTC)
Received: from x1.localdomain (unknown [10.39.195.129])
        by smtp.corp.redhat.com (Postfix) with ESMTP id 292E360BF4;
...
Subject: [PATCH v4 10/11] platform/x86: int3472: Pass tps68470_regulator_platform_data to the tps68470-regulator MFD-cell
Date:   Mon, 25 Oct 2021 11:41:18 +0200
Message-Id: <20211025094119.82967-11-hdegoede@redhat.com>
...
index 9c683faefb2e..5b881d6f5943 100644
...
+
 		...
 		if (!cells)
 			return -ENOMEM;
@@ -142,11 +150,19 @@ static int skl_int3472_tps68470_probe(struct i2c_client *client)
...
@@ -161,6 +177,17 @@ static int skl_int3472_tps68470_probe(struct i2c_client *client)
 	return ret;
 }
...
+
 static const struct acpi_device_id int3472_device_id[] = {
 	{ "INT3472", 0 },
 	{ }
@@ -173,6 +200,7 @@ static struct i2c_driver int3472_tps68470 = {
