Return-Path: <linux-clk+bounces-10598-lists+linux-clk=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-clk@lfdr.de
Delivered-To: lists+linux-clk@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 7D12E94CF9A
	for <lists+linux-clk@lfdr.de>; Fri,  9 Aug 2024 13:55:32 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id A01621C2192F
	for <lists+linux-clk@lfdr.de>; Fri,  9 Aug 2024 11:55:31 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B7FE5194149;
...
Received: from mailout1.samsung.com (mailout1.samsung.com [203.254.224.24])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 648CB194088
	for <linux-clk@vger.kernel.org>; Fri,  9 Aug 2024 11:55:10 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=203.254.224.24
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1723204512; cv=none; b=i6GMa1Fig/ySwrZ6RTczQJOQkVt97tirEZQZaGDOBPdNDhlZBjPHsLkKIOFHdm5FpLLLG1TUCwmYx2ssQedgoLDTgDsv69RWZTKIlFxWwtPdVFGrG5JA6+Jiwa8GDxhNuZI//pNwTq5SSn4y1tUfNftwEg3bvOW/ePjKpuwfmo8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1723204512; c=relaxed/simple;
	bh=HuB7+0+lduSH9n1aXvH8QNrnF1qWMCAkwysWDaRzhD0=;
	h=From:Date:Subject:MIME-Version:Message-Id:In-Reply-To:To:Cc:
	 Content-Type:References; b=UoH/DZqksYk8umEGcJpxAOjqdYvjsstGrk/irRfFZXxVpmRgmPzEY3S9HC+aIoo9ZvDZXS43ijAEe0sbg3E5dEzYgB7FgUGip0w9GC6j3AVq989E2/nj2iWbcubJU4ndusY3UQ2AeLfjaGKphMdOd/ZUfldGYFMsXotxaJ8mmhQ=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=samsung.com; spf=pass smtp.mailfrom=samsung.com; dkim=pass (1024-bit key) header.d=samsung.com header.i=@samsung.com header.b=ICbuff3e; arc=none smtp.client-ip=203.254.224.24
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=samsung.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=samsung.com
Received: from epcas1p1.samsung.com (unknown [182.195.41.45])
	by mailout1.samsung.com (KnoxPortal) with ESMTP id 20240809115503epoutp015f9d492e26ac0f2ce6a14a558c94ec35~qDV2btr6A0936709367epoutp01C
	for <linux-clk@vger.kernel.org>; Fri,  9 Aug 2024 11:55:03 +0000 (GMT)
DKIM-Filter: OpenDKIM Filter v2.11.0 mailout1.samsung.com 20240809115503epoutp015f9d492e26ac0f2ce6a14a558c94ec35~qDV2btr6A0936709367epoutp01C
