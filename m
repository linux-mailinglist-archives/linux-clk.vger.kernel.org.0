...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id EC5D7513A3E
	for <lists+linux-clk@lfdr.de>; Thu, 28 Apr 2022 18:45:09 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1350318AbiD1Qrt (ORCPT <rfc822;lists+linux-clk@lfdr.de>);
        Thu, 28 Apr 2022 12:47:49 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:32830 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1350301AbiD1Qrq (ORCPT
        <rfc822;linux-clk@vger.kernel.org>); Thu, 28 Apr 2022 12:47:46 -0400
Received: from out5-smtp.messagingengine.com (out5-smtp.messagingengine.com [66.111.4.29])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C67A8B2467
        for <linux-clk@vger.kernel.org>; Thu, 28 Apr 2022 09:44:29 -0700 (PDT)
Received: from compute5.internal (compute5.nyi.internal [10.202.2.45])
        by mailout.nyi.internal (Postfix) with ESMTP id 370645C0115;
        Thu, 28 Apr 2022 12:44:29 -0400 (EDT)
Received: from mailfrontend2 ([10.202.2.163])
  by compute5.internal (MEProxy); Thu, 28 Apr 2022 12:44:29 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=cerno.tech; h=cc
        :cc:content-transfer-encoding:date:date:from:from:in-reply-to
        :in-reply-to:message-id:mime-version:references:reply-to:sender
        :subject:subject:to:to; s=fm3; t=1651164269; x=1651250669; bh=N/
        /YaD54C4COtQz9mI0e3wW8DGWDsFnEy4O9ZWcvznY=; b=ZDz+XA/cSuwaTeSeqN
        
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=
        ...
        1651164269; x=1651250669; bh=N//YaD54C4COtQz9mI0e3wW8DGWDsFnEy4O
        9ZWcvznY=; b=MUnDJRVcYjn7tF+XYdrlC7S8zn+1aKeTVzqLUUlaIYqzY1AfzsS
        
X-ME-Sender: <xms:bcRqYrhzhmZZxJ45khPftNwo2j7U2AK433vXBTVb7_9cpBP7VhP-9Q>
    <xme:bcRqYoCxzPhctLvreycYtfQSS7PeseGp1w8SMRoC64WBFwaZFC_MqdHS-kWAI9OJR
    XvZaTm65Izv1Onb4lA>
X-ME-Received: <xmr:bcRqYrHrAHAqCND6HQCwYxBHNuCrnRFO_A7el_aZ8gyRzjWF2siM1IfIemh7RD-3spVnH5OO8cS7FMjF6If3KXv0RKCiKKAaStLoVec>
...
X-ME-Proxy: <xmx:bcRqYoTMNI6x0r2wVNNPPOTg2B7Q_KpUb5Ob_1la0DYclLFtt4tZpw>
    <xmx:bcRqYoxwLTrVi0BdQbdRfOfPJkoOIR9yRCedYyNXevvDneWHxVwOgg>
    <xmx:bcRqYu5PbUIFq33L1Ulwa0qFi5zgEkhbn_jfkwSDZSvBdmCZLbM5xQ>
    <xmx:bcRqYto9QTCUIA09B54yRwkYw95Hn_KCKrXUigmEADF0k45vsQkLmw>
Received: by mail.messagingengine.com (Postfix) with ESMTPA; Thu,
 28 Apr 2022 12:44:28 -0400 (EDT)
...
Subject: [PATCH v2 22/28] clk: Stop forwarding clk_rate_requests to the parent
Date:   Thu, 28 Apr 2022 18:43:32 +0200
Message-Id: <20220428164338.717443-23-maxime@cerno.tech>
...
index 9af592cb3618..d5f90896e088 100644
--- a/drivers/clk/clk.c
+++ b/drivers/clk/clk.c
